...
/#
    ...
    function function_81f84c9c(str_objective, var_74cd64bc) {
        ...
        namespace_63b4601c::function_b87f9c13(str_objective, var_74cd64bc);
        namespace_63b4601c::function_66773296("CP_MI_SING_VENGEANCE_INTRO_LINE_3_FULL", str_objective);
        level.var_2fd26037 ai::set_ignoreall(1);
        level.var_2fd26037 ai::set_ignoreme(1);
        level.var_2fd26037.goalradius = 32;
        level.var_2fd26037 battlechatter::function_d9f49fba(0);
        level flag::wait_till("apartment_entrance_door_open");
        objectives::set("apt_door_l_clip", struct::get("cin_ven_01_intro_3rd_sh040"));
        level flag::set("hendricks_takedown_rooftop_node");
    ...
    function function_616e9ab6(str_objective, var_74cd64bc) {
        ...
        objectives::set("apt_door_l_clip", struct::get("cin_ven_01_intro_3rd_sh040"));
        level flag::set("hendricks_takedown_rooftop_node");
        setdvar("syncshot_lookat_failsafe", "plyr_once_we_find_her_n_0");
        wait(1);
        if (level.activeplayers.size == 1) {
            setdvar("syncshot_lookat_failsafe", "ffim2_tell_her_goodbye_0");
        }
        wait(1);
        level thread takedown_main();
        level waittill(#"hash_ee2ef2f3");
    ...
    function function_6fa5f384() {
        ...
        foreach (player in level.var_7cd6979b) {
            if (isdefined(player.pers) && isdefined(player.pers["ffim3_i_want_a_piece_of_he_0"]) && player.pers["ffim3_i_want_a_piece_of_he_0"] == 1) {
        ...
        if (level.activeplayers.size >= 2) {
            if (getdvarstring("fciv_crying_hysterically_1") === "door_exit") {
                foreach (player in level.var_7cd6979b) {
                    if (isdefined(player.pers) && (!isdefined(player.pers) || player.pers["ffim3_i_want_a_piece_of_he_0"] == undefined)) {
        ...
        if (level.activeplayers.size >= 3) {
            if (getdvarstring("fciv_crying_hysterically_1") === "plyr_this_is_what_happens_0") {
                foreach (player in level.var_7cd6979b) {
                    if (isdefined(player.pers) && (!isdefined(player.pers) || player.pers["ffim3_i_want_a_piece_of_he_0"] == undefined)) {
        ...
        if (level.activeplayers.size == 4) {
            if (getdvarstring("fciv_crying_hysterically_1") === "takedown_gate_left_clip") {
                foreach (player in level.var_7cd6979b) {
                    if (isdefined(player.pers) && (!isdefined(player.pers) || player.pers["ffim3_i_want_a_piece_of_he_0"] == undefined)) {
