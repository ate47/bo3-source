...
function function_258afdfc() {
    ...
    assert(isdefined(var_482d5204), "raven_ambush_ai");
    foreach (s_cover in var_482d5204) {
        assert(isdefined(s_cover.model), "flag_singapore_root_monologue_04");
        assert(isdefined(s_cover.target), "sing_falling_destructible");
