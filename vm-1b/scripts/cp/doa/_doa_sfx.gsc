...
// Namespace namespace_1a381543
// Params 0, eflags: 0x0
// Checksum 0x79ef8f1d, Offset: 0xa10
// Size: 0xab2
function init() {
...
// Namespace namespace_1a381543
// Params 2, eflags: 0x0
// Checksum 0xc95a414e, Offset: 0x14d0
// Size: 0x6b
...
// Namespace namespace_1a381543
// Params 1, eflags: 0x0
// Checksum 0xb02567db, Offset: 0x1548
// Size: 0x42
...
// Namespace namespace_1a381543
// Params 3, eflags: 0x0
// Checksum 0x9ed5b97, Offset: 0x1598
// Size: 0x172
function function_9ab759da(&queue, flag, var_a6cc22d4) {
    ...
    if (queue.size >= 64) {
        foreach (item in queue) {
            namespace_49107f3a::debugmsg("SFX QUEUE:" + item);
        }
        assert(0, "<dev string:x60>" + queue[63]);
    }
    if (queue.size == 0) {
...
// Namespace namespace_1a381543
// Params 1, eflags: 0x0
// Checksum 0x54176f72, Offset: 0x1718
// Size: 0x7b
...
// Namespace namespace_1a381543
// Params 1, eflags: 0x0
// Checksum 0x735703f0, Offset: 0x17a0
// Size: 0x6a
