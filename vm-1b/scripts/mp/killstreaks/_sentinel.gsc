...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0x8caba26b, Offset: 0x8c0
// Size: 0x1ea
function init() {
    killstreaks::register("sentinel", "sentinel", "killstreak_" + "sentinel", "sentinel" + "_used", &function_95a79a4a, 1);
    killstreaks::function_f79fd1e9("sentinel", %KILLSTREAK_SENTINEL_EARNED, %KILLSTREAK_SENTINEL_NOT_AVAILABLE, %KILLSTREAK_SENTINEL_INBOUND, undefined, %KILLSTREAK_SENTINEL_HACKED);
    ...
    remote_weapons::registerremoteweapon("sentinel", %KILLSTREAK_SENTINEL_USE_REMOTE, &function_56b12a24, &function_c3f9c5bd, 0);
    level.killstreaks["sentinel"].threatonkill = 1;
    vehicle::add_main_callback("veh_sentinel_mp", &function_eb0ba513);
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0xe89a7c7, Offset: 0xab8
// Size: 0x3aa
function function_eb0ba513() {
    ...
    self.overridevehicledamage = &function_f20212e;
    self.selfdestruct = 0;
    ...
    self vehicle_ai::get_state_callbacks("driving").enter_func = &function_65f548d5;
    wasp::init_guard_points();
    self vehicle_ai::add_state("guard", &wasp::state_guard_enter, &wasp::state_guard_update, undefined);
...
// Namespace sentinel
// Params 1, eflags: 0x0
// Checksum 0x723a0cbd, Offset: 0xe70
// Size: 0x3e
...
// Namespace sentinel
// Params 4, eflags: 0x0
// Checksum 0x770512ee, Offset: 0xeb8
// Size: 0x1aa
...
// Namespace sentinel
// Params 7, eflags: 0x0
// Checksum 0xa6414966, Offset: 0x1070
// Size: 0x102
...
// Checksum 0xf12b45ba, Offset: 0x1180
// Size: 0x164
...
// Namespace sentinel
// Params 2, eflags: 0x0
// Checksum 0x2440b99a, Offset: 0x12f0
// Size: 0x4a
...
// Namespace sentinel
// Params 2, eflags: 0x0
// Checksum 0x32df6e07, Offset: 0x1348
// Size: 0x4a
...
// Namespace sentinel
// Params 2, eflags: 0x0
// Checksum 0xf49580a0, Offset: 0x13a0
// Size: 0x257
function calcspawnorigin(origin, angles) {
    heightoffset = rcbomb::function_c8500421();
    mins = (-5, -5, 0);
    maxs = (5, 5, 10);
    startpoints = [];
    testangles = [];
...
// Namespace sentinel
// Params 1, eflags: 0x0
// Checksum 0xeb6add47, Offset: 0x1600
// Size: 0x41c
function function_95a79a4a(killstreaktype) {
    ...
    sentinel = spawnvehicle("veh_sentinel_mp", spawnpos.origin + (0, 0, 25), spawnpos.angles, "dynamic_spawn_ai");
    ...
    sentinel thread function_c3616f87();
...
// Namespace sentinel
// Params 1, eflags: 0x0
// Checksum 0x93bd7292, Offset: 0x1a28
// Size: 0xb2
function hackedcallbackpre(hacker) {
    ...
    function_c3f9c5bd(sentinel, 1);
}

// Namespace sentinel
// Params 1, eflags: 0x0
// Checksum 0xcaa7280d, Offset: 0x1ae8
// Size: 0x5a
...
// Namespace sentinel
// Params 2, eflags: 0x0
// Checksum 0x90ce1fa2, Offset: 0x1b50
// Size: 0x32
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0xacd17359, Offset: 0x1b90
// Size: 0x44
...
// Namespace sentinel
// Params 1, eflags: 0x0
// Checksum 0x447e8c1f, Offset: 0x1be0
// Size: 0x182
function function_56b12a24(sentinel) {
    ...
    sentinel.distance_shutdown_override = &function_5ed8df92;
...
// Namespace sentinel
// Params 2, eflags: 0x0
// Checksum 0x60679119, Offset: 0x1d70
// Size: 0xfa
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0xa8befbed, Offset: 0x1e78
// Size: 0xe4
function ontimeout() {
    sentinel = self;
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0x1edfb5e4, Offset: 0x1f68
// Size: 0x79
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0xb6a2b2b1, Offset: 0x1ff0
// Size: 0x18
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0x3d46e7fc, Offset: 0x2010
// Size: 0xd2
function watchdeath() {
    sentinel = self;
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0x2c01bef0, Offset: 0x20f0
// Size: 0x6c
function watchteamchange() {
    self notify(#"hash_ec539174");
    self endon(#"hash_ec539174");
    sentinel = self;
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0x38c288cd, Offset: 0x2168
// Size: 0xa0
function watchwater() {
    sentinel = self;
    sentinel endon(#"sentinel_shutdown");
...
// Namespace sentinel
// Params 0, eflags: 0x0
// Checksum 0xad0dfd93, Offset: 0x2210
// Size: 0x112
