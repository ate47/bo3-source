...
function function_72dd3113() {
    ...
    /#
        if (!isdefined(var_385ae3a2.s_unitrigger)) {
            var_385ae3a2 zm_unitrigger::create_unitrigger("<dev string:x6f>");
        }
    #/
    var_78d02c88 = getent("ee_map_shelf", "targetname");
...
function function_de888a13() {
    ...
    self sentinel_drone::function_a2874766(1);
...
function function_a9a92838() {
    ...
    b_moving = 0;
    while (true) {
        var_6de069e0 = self zm_stalingrad_util::function_1af75b1b(-56);
...
function function_18375f27(a_str_locations) {
    ...
    /#
        if (!isdefined(level.var_f0d11538)) {
            var_385ae3a2 = struct::get("<dev string:xaf>", "<dev string:xc4>");
            level.var_f0d11538 = spawn("<dev string:xcf>", var_385ae3a2.origin);
        }
    #/
    level.var_f0d11538 playsound("zmb_scenarios_map_scenario_select");
    for (i = 0; i < 4; i++) {
    ...
    foreach (var_c2d73a21 in var_7953b28) {
        ...
        foreach (e_player in level.activeplayers) {
            if (isalive(e_player) && !(isdefined(e_player.var_4a416e6a) && e_player.var_4a416e6a)) {
                if (zm_stalingrad_util::function_86b1188c(500, var_c2d73a21, e_player)) {
...
function function_978eeda3() {
    ...
    for (var_80d8d5fa = 0; var_80d8d5fa < 2; var_80d8d5fa++) {
        wait 30;
        level thread zm_stalingrad_vo::function_e4acaa37("vox_soph_data_take_disk_" + var_80d8d5fa + "_0");
    }
}
...
// Size: 0x2ec
function ee_outro(n_wait, var_d15ef3dd) {
    if (!isdefined(n_wait)) {
        n_wait = 0;
    }
...
function function_d9d36a17(str_model, str_hint, v_angles, var_c991b769) {
    ...
    while (!level.var_a090a655 zm_stalingrad_util::function_1af75b1b(-6)) {
        wait 0.5;
    }
...
/#
    ...
    function function_22557cc3(n_value) {
        ...
        level thread zm_stalingrad_vo::function_ea234d37();
        level waittill(#"hash_34e4b03f");
        level.var_a090a655 scene::play("<dev string:x913>");
    }
    ...
    function function_3de60ba3(n_value) {
        var_7953b28 = getentarray("<dev string:x942>", "<dev string:x94b>");
        foreach (var_c2d73a21 in var_7953b28) {
    ...
    function function_4f92d875(n_value) {
        ...
        var_663b2442 sentinel_drone::function_a2874766(1);
    ...
    function function_a1f6ef06(var_2fa24527, str_dvar, n_value, func, var_f0ee45c9) {
        ...
        var_2fa24527 = "<dev string:xa04>" + var_2fa24527;
        adddebugcommand("<dev string:xa16>" + var_2fa24527 + "<dev string:xa23>" + str_dvar + "<dev string:xa27>" + n_value + "<dev string:xa29>");
        while (true) {
