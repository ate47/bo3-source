...
function function_6163650d() {
    ...
    zm_weap_quantum_bomb::function_f2df781b("be2", undefined, 100, &function_ba1a1d8a);
    level.var_d39257a8 = level.var_8894208b.origin;
    level waittill(#"hash_ba1a1d8a");
    zm_weap_quantum_bomb::function_f94f76f0("be2");
...
function function_1e3d1509(grenade, model, info) {
    if (isdefined(level.var_9c483a19) && grenade istouching(level.var_9c483a19)) {
        ...
        level thread teleport_target(grenade, level.var_8894208b);
        return true;
    }
    return false;
}
...
function function_6ccabece() {
    ...
    for (start = 0; !start; start = 1) {
        var_476a0c04 waittill(#"damage", amount, attacker, direction, point, var_e5f012d6, modelname, tagname);
        ...
        if (isdefined(node.script_string)) {
            ...
            while (!var_15afc6ad) {
                if (isdefined(node.script_string) && node.script_string == "zap") {
                    zm_weap_microwavegun::function_d4224082(var_476a0c04);
                    var_476a0c04 waittill(#"hash_d26ed760", var_75916bdb);
                    zm_weap_microwavegun::function_1ef3ad2b(var_476a0c04);
                    var_15afc6ad = 1;
                } else {
                    var_476a0c04 waittill(#"damage", amount, attacker, direction, point, var_e5f012d6, modelname, tagname);
