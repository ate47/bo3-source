...
// namespace_239f5449<file_0>::function_8a5375f3
// Checksum 0xc534ac31, Offset: 0x288
// Size: 0x5c
function main_start() {
    level.var_639d8432 = 2;
...
// Namespace namespace_239f5449
// Params 0, eflags: 0x1 linked
// namespace_239f5449<file_0>::function_ead4e420
...
function main_end() {
    ...
    spawncollision("collision_player_cylinder_32x256", "collider", (-89, 404, 442), (0, 0, 0));
    ...
    spawncollision("collision_player_wedge_32x256", "collider", (2196.91, -634.245, -32), (0, 289.698, 0));
    level.var_144b78ee = spawncollision("collision_player_wedge_32x256", "collider", (-2148.74, 571, 237.5), (0, 7.6, 0));
    var_dbcadb22 = spawn("trigger_box", (54.5, -372.5, 130.5), 0, 350, 100, -6);
    var_dbcadb22.angles = (0, 0, 0);
    var_dbcadb22.script_noteworthy = "kill_brush";
    var_b5c860b9 = spawn("trigger_box", (83, 387, 130.5), 0, 300, 100, -6);
    var_b5c860b9.angles = (0, 0, 0);
    var_b5c860b9.script_noteworthy = "kill_brush";
}

// Namespace namespace_239f5449
// Params 0, eflags: 0x1 linked
// namespace_239f5449<file_0>::function_3fd88dcb
...
// Namespace namespace_239f5449
// Params 0, eflags: 0x1 linked
// namespace_239f5449<file_0>::function_b620b1d6
...
// namespace_239f5449<file_0>::function_acf1c4da
...
// Namespace namespace_239f5449
// Params 0, eflags: 0x1 linked
// namespace_239f5449<file_0>::function_af29034
