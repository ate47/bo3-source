...
function function_a19db598(name) {
    ...
    while (true) {
        ...
        case "Waiting for Players":
            var_15a6c4a3 = zm_moon_wasteland::function_fcb42941(teleporter);
            if (var_15a6c4a3 == 0) {
        ...
        case "Teleport Countdown":
            ...
            if (var_15a6c4a3 < num_players) {
                ...
                if (var_850a7fc <= current_time) {
                    ...
                    if (zm_moon_wasteland::function_fcb42941(teleporter) != function_5a9a4cac()) {
                        continue;
                    }
                    ...
                    level thread zm_moon_wasteland::function_eaa8b4ed();
    ...
    if (!var_e7383480) {
        ...
        if (isdefined(var_51fda60f.script_noteworthy)) {
            if (var_51fda60f.script_noteworthy == "enter_no_mans_land") {
                ...
                level thread zm_moon::function_1829268e();
                level thread zm_moon_wasteland::function_5bde87b7();
                level thread zm_moon_utility::function_a4d74581();
                ...
                level thread zm_moon_wasteland::function_36db1e4f();
                zm_moon_wasteland::function_1b79fc40();
                return;
            }
            if (var_51fda60f.script_noteworthy == "exit_no_mans_land") {
                ...
                zm_moon_wasteland::function_d694caf4(level.round_number);
                level thread zm_moon::function_28fc6cb();
...
function function_d4d1fff() {
    for (i = 0; i < level.var_2b53d7f.size; i++) {
        zm_moon_utility::zapper_light_red(level.var_2b53d7f[i], "targetname");
    }
}
...
function function_c500da1b() {
    for (i = 0; i < level.var_2b53d7f.size; i++) {
        zm_moon_utility::zapper_light_green(level.var_2b53d7f[i], "targetname");
    }
}
...
function function_2b222584() {
    ...
    while (time < var_c3b353a0) {
        ...
        case 0:
            if (time >= time0) {
                zm_moon_utility::zapper_light_green(level.var_2b53d7f[0], "targetname");
                var_ec354f84++;
            }
            break;
        case 1:
            if (time >= time1) {
                zm_moon_utility::zapper_light_green(level.var_2b53d7f[1], "targetname");
                var_ec354f84++;
            }
            break;
        case 2:
            if (time >= time2) {
                zm_moon_utility::zapper_light_green(level.var_2b53d7f[2], "targetname");
                var_ec354f84++;
            }
            break;
        case 3:
            if (time >= var_ad9805b5) {
                zm_moon_utility::zapper_light_green(level.var_2b53d7f[3], "targetname");
                var_ec354f84++;
                function_af9ff3f5(1);
            }
            break;
