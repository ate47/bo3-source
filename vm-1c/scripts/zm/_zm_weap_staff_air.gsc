...
function function_218c2881() {
    self endon(#"disconnect");
    while (true) {
        self waittill(#"projectile_impact", w_weapon, var_836ef144, n_radius, projectile);
...
function function_a1828a0e(var_177e8ec4, w_weapon) {
    ...
    var_5c96fe71 thread zm_tomb_utility::function_5de0d079("X", (255, 255, 0));
    ...
    var_5c96fe71 thread zm_tomb_utility::function_8b1b140c("whirlwind_active");
...
function function_94d27f4f(var_5c96fe71, w_weapon) {
    ...
    if (isdefined(self) && isdefined(var_5c96fe71) && level flag::get("whirlwind_active")) {
        ...
        self zm_tomb_utility::function_2f31684b(player, self.health, w_weapon, "MOD_IMPACT");
...
function function_5bc03d0(player) {
    ...
    self zm_tomb_utility::function_2f31684b(player, self.health, level.var_7830b075, "MOD_IMPACT");
    level thread function_4bec2567(self);
}
...
function function_46fb33db(e_attacker, w_weapon) {
    self zm_tomb_utility::function_2f31684b(e_attacker, self.health, w_weapon, "MOD_IMPACT");
...
function function_4bec2567(ai_zombie) {
    if (math::cointoss()) {
        ai_zombie thread zm_tomb_utility::function_8a97fd20();
    }
    ...
    foreach (target in a_targets) {
        if (isai(target)) {
            if (util::within_fov(fire_origin, fire_angles, target gettagorigin("j_spine4"), cos(var_199c7fe5))) {
                ...
                target zm_tomb_utility::function_2f31684b(self, n_damage, w_weapon, "MOD_IMPACT");
            }
        }
    }
}
