...
function function_7747c56() {
    /#
        ...
        if (getplayers().size == 1) {
            ...
            namespace_6e97c459::function_2f3ced1f("<dev string:x74>", "<dev string:x77>");
            return;
        }
    #/
}
...
/#
    ...
    function function_cc0fce1() {
        ...
        if (!isdefined(level.var_7d341977)) {
            ...
            level.var_74774b9a.alignx = "<dev string:x7c>";
            level.var_74774b9a.aligny = "<dev string:x81>";
            ...
            level.var_2fb9871c.alignx = "<dev string:x88>";
            level.var_2fb9871c.aligny = "<dev string:x81>";
            ...
            level.var_2fb9871c settext("<dev string:x9e>");
        }
        while (true) {
...
function function_9873f186() {
    wait 0.5;
    level thread zm_temple_sq_skits::function_acc79afb("tt1");
}
...
function function_cc3f3f6a(success) {
    ...
    if (success) {
        ...
        level thread zm_temple_sq_skits::function_b6268f3d(1);
    }
