...
function init() {
    ...
    globallogic_audio::function_9c3f9daf("item_destroyed", 1);
    globallogic_audio::function_9c3f9daf("introboost", 1);
    globallogic_audio::function_9c3f9daf("status", 1);
    level.var_ff266e7 = 1;
...
// Namespace globallogic
// Params 0, eflags: 0x0
// namespace_2282eece<file_0>::function_51f86b78
...
function setupcallbacks() {
    ...
    level.var_efea8a44 = &hud_message::function_de9a72bf;
    level.var_b60ac87b = &hud_message::function_d5235f38;
...
// Namespace globallogic
// Params 0, eflags: 0x1 linked
// namespace_2282eece<file_0>::function_e2715b8c
...
// Namespace globallogic
// Params 0, eflags: 0x1 linked
// namespace_2282eece<file_0>::function_3f8c892
...
// Namespace globallogic
// Params 0, eflags: 0x1 linked
// namespace_2282eece<file_0>::function_389381c0
...
function displayroundend(winner, endreasontext) {
    ...
    thread globallogic_audio::function_a6efdbf5(winner, level.roundenddelay / 4);
...
function displayroundswitch(winner, endreasontext) {
    ...
    leaderdialog = globallogic_audio::function_e008b8f9(switchtype);
...
function displaygameend(winner, endreasontext) {
    ...
    for (index = 0; index < players.size; index++) {
        ...
        if (level.wagermatch) {
            if (level.teambased) {
                player thread [[ level.var_efea8a44 ]](winner, 0, endreasontext);
            } else {
                player thread [[ level.var_b60ac87b ]](winner, endreasontext);
            }
        } else if (level.teambased) {
    ...
    if (level.teambased) {
        thread globallogic_audio::function_19c083(winner, level.postroundtime / 2);
        players = level.players;
        for (index = 0; index < players.size; index++) {
            player = players[index];
...
// Namespace globallogic
// Params 0, eflags: 0x1 linked
// namespace_2282eece<file_0>::function_e20f20d1
...
// Namespace globallogic
// Params 1, eflags: 0x1 linked
// namespace_2282eece<file_0>::function_69948487
// Checksum 0x98a5a066, Offset: 0x47f0
// Size: 0x6e
function function_69948487(winner) {
    players = level.players;
    for (index = 0; index < players.size; index++) {
        globallogic_player::function_e20b6fc7(players[index], winner);
    }
}
...
function endgame(winner, endreasontext) {
    ...
    globallogic_audio::function_d99d939d();
    ...
    for (index = 0; index < players.size; index++) {
        ...
        player weapons::function_9f41ef9b(newtime);
...
// Namespace globallogic
// Params 0, eflags: 0x1 linked
// namespace_2282eece<file_0>::function_a78c417d
...
function startgame() {
    ...
    thread bb::function_543e7299("zmbreadcrumb");
    recordmatchbegin();
}
