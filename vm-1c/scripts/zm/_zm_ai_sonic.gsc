...
function __main__() {
    ...
    println("<dev string:x28>" + level.var_c56da471);
}
...
function private sonicCanAttack(entity) {
    ...
    var_20e7a8bd = !(isdefined(entity.shrinked) && entity.shrinked);
...
// Size: 0xb4
function function_5b90e4d6(sonic_zombie) {
    self endon(#"death");
    self endon(#"hash_6e9cda15");
    sonic_zombie endon(#"death");
    self.var_b35d9855 = 0;
    while (true) {
        if (self function_4b9c09a7(sonic_zombie)) {
            break;
        }
        wait 0.1;
    }
    self thread function_93ae31f9(sonic_zombie);
...
// Size: 0x148
function function_4b9c09a7(sonic_zombie) {
    ...
    var_1f4b1834 = anglestoforward(sonic_zombie.angles);
...
function function_93ae31f9(zombie) {
    ...
    if (!self.var_b35d9855) {
        var_ec7bd060 = isdefined(zombie.shrinked) && isdefined(zombie) && zombie.shrinked;
        self.var_b35d9855 = 1;
        if (var_ec7bd060) {
