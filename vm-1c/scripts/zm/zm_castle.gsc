...
function main() {
    ...
    level.var_fc2bdb4a = &zm_castle_vo::function_43b44df3;
    ...
    zm_craftables::init();
    zm_castle_craftables::function_cdc13aec();
