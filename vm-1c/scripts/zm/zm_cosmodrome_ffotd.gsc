...
// namespace_79efb23f<file_0>::function_8a5375f3
...
// Namespace namespace_79efb23f
// Params 0, eflags: 0x1 linked
// namespace_79efb23f<file_0>::function_ead4e420
...
function main_end() {
    ...
    spawncollision("collision_player_wedge_32x256", "collider", (-1541, 1648, -100), (0, 180, 0));
    ...
    spawncollision("collision_player_wall_512x512x10", "collider", (-98, 2172, 5), (0, 0, 0));
    spawncollision("collision_player_ramp_256x24", "collider", (-105, 1768, -40), (270, 82.546, 97.454));
    spawncollision("collision_player_ramp_256x24", "collider", (-105, 1738, -40), (270, 82.546, 97.454));
    ...
    var_be1f149f = spawncollision("collision_clip_wall_128x128x10", "collider", (-72, 1136, -421.5), (0, 270, 0));
    var_be1f149f disconnectpaths();
