    ...
    while (!level flag::get("ee_safe_open")) {
        ...
        foreach (s_slot in var_91d3caa4) {
            ...
            for (i = 1; i <= 4; i++) {
                ...
                var_e349e3f zm_castle_util::create_unitrigger(undefined, 16);
...
/#
    ...
    function function_d6026710() {
        ...
        level thread zm_castle_util::function_72260d3a("<dev string:x85>", "<dev string:xa4>", 1, &function_690690ef);
        level thread zm_castle_util::function_72260d3a("<dev string:xb9>", "<dev string:xd0>", 1, &function_b1c42655);
        level thread zm_castle_util::function_72260d3a("<dev string:xdd>", "<dev string:xf8>", 1, &function_dc5045eb);
        level thread zm_castle_util::function_72260d3a("<dev string:x109>", "<dev string:x121>", 1, &function_c197b24a);
        level thread zm_castle_util::function_72260d3a("<dev string:x12f>", "<dev string:x14d>", 1, &function_3c8db42b);
        level thread zm_castle_util::function_72260d3a("<dev string:x160>", "<dev string:x17b>", 1, &function_64783c5e);
        level thread zm_castle_util::function_72260d3a("<dev string:x18c>", "<dev string:x1a9>", 1, &function_a1ac1452);
        level thread zm_castle_util::function_72260d3a("<dev string:x1c1>", "<dev string:x1d4>", 1, &function_bbf6c2d0);
        level thread zm_castle_util::function_72260d3a("<dev string:x1dd>", "<dev string:x200>", 1, &function_a9a41cbd);
        ...
        level thread function_72260d3a("<dev string:x44e>", "<dev string:x46d>", 1, &function_71b77de5);
        level thread function_72260d3a("<dev string:x47f>", "<dev string:x4ac>", 1, &function_d6a136ff);
        level thread function_72260d3a("<dev string:x4cf>", "<dev string:x4f2>", 1, &function_f62f3c89);
    ...
    function function_b38b0751() {
        while (true) {
            if (getdvarint("<dev string:x76>") == 1) {
                setdvar("<dev string:x76>", 0);
                var_747532f4 = getent("<dev string:x663>", "<dev string:x674>");
                var_747532f4 notify(#"keeper_charge");
                var_747532f4 notify(#"hash_72e982f4");
                str_exploder = function_ac7d9299();
                exploder::kill_exploder(str_exploder);
    ...
    function function_72260d3a(var_2fa24527, str_dvar, n_value, func, var_f0ee45c9) {
        ...
        adddebugcommand("<dev string:x6fb>" + var_2fa24527 + "<dev string:x708>" + str_dvar + "<dev string:x70c>" + n_value + "<dev string:x70e>");
        while (true) {
