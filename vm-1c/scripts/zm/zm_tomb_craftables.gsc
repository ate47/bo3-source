...
// namespace_f7a613cf<file_0>::function_cdc13aec
...
function function_95743e9f() {
    ...
    namespace_f37770c8::function_8421d708("equip_dieseldrone", %ZM_TOMB_CRQ, %ZM_TOMB_CRQ, %ZM_TOMB_TQ, &function_e2076525, 1);
    namespace_f37770c8::function_b2caef35("equip_dieseldrone", "build_dd");
    namespace_f37770c8::function_c86d092("equip_dieseldrone", "veh_t7_dlc_zm_quadrotor", (0, 0, 0), (0, -4, 10));
    namespace_f37770c8::function_8421d708("elemental_staff_fire", %ZM_TOMB_CRF, %ZM_TOMB_INS, %ZM_TOMB_BOF, &function_6a4fbed6, 1);
    namespace_f37770c8::function_b2caef35("elemental_staff_fire", "fire_staff");
    namespace_f37770c8::function_8421d708("elemental_staff_air", %ZM_TOMB_CRA, %ZM_TOMB_INS, %ZM_TOMB_BOA, &function_c67d74ce, 1);
    namespace_f37770c8::function_b2caef35("elemental_staff_air", "air_staff");
    namespace_f37770c8::function_8421d708("elemental_staff_lightning", %ZM_TOMB_CRL, %ZM_TOMB_INS, %ZM_TOMB_BOL, &function_8feb5840, 1);
    namespace_f37770c8::function_b2caef35("elemental_staff_lightning", "light_staff");
    namespace_f37770c8::function_8421d708("elemental_staff_water", %ZM_TOMB_CRW, %ZM_TOMB_INS, %ZM_TOMB_BOW, &function_11d70761, 1);
    namespace_f37770c8::function_b2caef35("elemental_staff_water", "ice_staff");
    namespace_f37770c8::function_8421d708("gramophone", %ZM_TOMB_CRAFT_GRAMOPHONE, %ZM_TOMB_CRAFT_GRAMOPHONE, %ZM_TOMB_BOUGHT_GRAMOPHONE, undefined, 0);
    namespace_f37770c8::function_b2caef35("gramophone", "gramophone");
...
// namespace_f7a613cf<file_0>::function_6442c1bd
    ...
    /#
        ...
        foreach (var_b1028d0b in craftable.var_7a5f63bc) {
            ...
            if (isdefined(var_b1028d0b.var_c05b32e7)) {
                ...
                var_9cd24e96 = "quadrotor_cooling_down";
                var_33246a9d = var_b1028d0b.var_dcc30f2f;
            } else {
                continue;
            }
            tokens = strtok(var_9cd24e96, "quadrotor_cooling_down");
            var_bbbb8e53 = "quadrotor_cooling_down";
            foreach (token in tokens) {
                if (token != "quadrotor_cooling_down" && token != "quadrotor_cooling_down" && token != "quadrotor_cooling_down") {
                    var_bbbb8e53 = var_bbbb8e53 + "quadrotor_cooling_down" + token;
                }
            }
            level.var_b68fa2a8["quadrotor_cooling_down" + var_33246a9d] = var_b1028d0b;
            adddebugcommand("quadrotor_cooling_down" + craftable.name + "quadrotor_cooling_down" + var_bbbb8e53 + "quadrotor_cooling_down" + var_33246a9d + "quadrotor_cooling_down");
            var_b1028d0b.var_7080cd19 = "quadrotor_cooling_down";
        }
        wait(0.05);
        level flag::wait_till("quadrotor_cooling_down");
        wait(0.05);
        foreach (var_b1028d0b in craftable.var_7a5f63bc) {
            var_b1028d0b function_c3207981();
            var_b1028d0b.var_5b55e566.model thread namespace_d7c0ce12::function_5de0d079("quadrotor_cooling_down", (0, 255, 0), undefined, "quadrotor_cooling_down");
        }
    #/
}
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_10f00da4
// Checksum 0x810fa213, Offset: 0x1d00
// Size: 0x2c6
function function_10f00da4() {
    setdvar("autocraft_staffs", "off");
    /#
        adddebugcommand("quadrotor_cooling_down");
    #/
    ...
    foreach (key in keys) {
        if (issubstr(key, "staff") || issubstr(key, "record")) {
            ...
            if (isdefined(var_b1028d0b.var_5b55e566)) {
                a_players[0] namespace_f37770c8::function_d1aff147(var_b1028d0b.var_5b55e566);
            }
        }
    }
    for (i = 1; i <= 4; i++) {
        ...
        if (isdefined(var_6e606195)) {
            if (isdefined(a_players[i - 1])) {
                a_players[i - 1] namespace_f37770c8::function_d1aff147(var_6e606195);
                util::wait_network_frame();
            }
        }
        util::wait_network_frame();
...
/#
    ...
    // Namespace namespace_f7a613cf
    // Params 0, eflags: 0x0
    // namespace_f7a613cf<file_0>::function_bd335247
    // Checksum 0x2dd7e159, Offset: 0x1fd0
    // Size: 0x110
    function function_bd335247() {
        level thread function_10f00da4();
        setdvar("quadrotor_cooling_down", "quadrotor_cooling_down");
        while (true) {
            var_6d9966ef = getdvarstring("quadrotor_cooling_down");
            if (var_6d9966ef != "quadrotor_cooling_down") {
                var_6e606195 = level.var_b68fa2a8[var_6d9966ef].var_5b55e566;
                if (isdefined(var_6e606195)) {
                    players = getplayers();
                    players[0] namespace_f37770c8::function_d1aff147(var_6e606195);
                }
                setdvar("quadrotor_cooling_down", "quadrotor_cooling_down");
            }
            wait(0.05);
...
function function_3ebec56b() {
    ...
    var_b0e1f6b = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "body", 32, 64, 0, undefined, &function_66a9cb86, &function_31edd14b, undefined, undefined, undefined, undefined, "piece_quadrotor_zm_body", 1, "build_dd", 0);
    var_35fab2b5 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "brain", 32, 64, 0, undefined, &function_66a9cb86, &function_31edd14b, undefined, undefined, undefined, undefined, "piece_quadrotor_zm_brain", 1, "build_dd_brain", 0);
    var_d015c5a5 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "engine", 32, 64, 0, undefined, &function_66a9cb86, &function_31edd14b, undefined, undefined, undefined, undefined, "piece_quadrotor_zm_engine", 1, "build_dd", 0);
    ...
    var_28c00c94 namespace_f37770c8::function_b0deb4e6(var_b0e1f6b);
    var_28c00c94 namespace_f37770c8::function_b0deb4e6(var_35fab2b5);
    var_28c00c94 namespace_f37770c8::function_b0deb4e6(var_d015c5a5);
    var_28c00c94.var_41f0f8cd = &function_69ac47ee;
    namespace_f37770c8::function_ac4e44a7(var_28c00c94);
    ...
    level thread namespace_ad52727b::function_68eb779("vox_sam_1st_record_found_0", "first_record_found");
    level thread namespace_ad52727b::function_68eb779("vox_sam_gramophone_found_0", "gramophone_found");
    level thread namespace_ad52727b::function_68eb779("vox_sam_master_found_0", "master_found");
    var_ed1d61e5 = spawnstruct();
    var_ed1d61e5.name = var_9967ff1;
    var_ed1d61e5 namespace_f37770c8::function_b0deb4e6(var_c057ef82);
    var_ed1d61e5 namespace_f37770c8::function_b0deb4e6(var_51b81757);
    var_ed1d61e5 namespace_f37770c8::function_b0deb4e6(var_82e2c59b);
    var_ed1d61e5 namespace_f37770c8::function_b0deb4e6(var_156bde2e);
    var_ed1d61e5 namespace_f37770c8::function_b0deb4e6(var_6c9c14c9);
    var_ed1d61e5 namespace_f37770c8::function_b0deb4e6(var_1654caa2);
    var_ed1d61e5.var_41f0f8cd = &function_84d14ecd;
    namespace_f37770c8::function_ac4e44a7(var_ed1d61e5);
    level thread function_6442c1bd(var_ed1d61e5);
    var_9967ff1 = "elemental_staff_air";
    var_ce6bcac4 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "gem", 48, 64, 0, undefined, &function_a0621a83, &function_5c80788a, undefined, undefined, undefined, undefined, 2, 0, "crystal", 1);
    var_6a48ae22 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "upper_staff", 32, 64, 0, undefined, &function_f35af043, &function_31edd14b, undefined, undefined, undefined, undefined, "air_staff.piece_zm_ustaff", 1, "staff_part");
    var_187b2973 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "middle_staff", 32, 64, 0, undefined, &function_f35af043, &function_31edd14b, undefined, undefined, undefined, undefined, "air_staff.piece_zm_mstaff", 1, "staff_part");
    var_437c8f91 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "lower_staff", 32, 64, 0, undefined, &function_f35af043, &function_31edd14b, undefined, undefined, undefined, undefined, "air_staff.piece_zm_lstaff", 1, "staff_part");
    var_d16491f1 = spawnstruct();
    var_d16491f1.name = var_9967ff1;
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_ce6bcac4);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_6a48ae22);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_187b2973);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_437c8f91);
    var_d16491f1.var_41f0f8cd = &function_a6c22658;
    var_d16491f1.var_855e2ef2 = &function_db7cb849;
    namespace_f37770c8::function_ac4e44a7(var_d16491f1);
    level thread function_6442c1bd(var_d16491f1);
    function_6c0a645(array(var_6a48ae22, var_187b2973, var_437c8f91));
    var_9967ff1 = "elemental_staff_fire";
    var_ea18101c = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "gem", 48, 64, 0, undefined, &function_15f35ef1, &function_8eba867a, undefined, undefined, undefined, undefined, 1, 0, "crystal", 1);
    var_2b72ecda = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "upper_staff", 32, 64, 0, undefined, &function_4d932a71, &function_31edd14b, undefined, undefined, undefined, undefined, "fire_staff.piece_zm_ustaff", 1, "staff_part");
    var_ff1e128b = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "middle_staff", 32, 64, 0, undefined, &function_4d932a71, &function_31edd14b, undefined, undefined, undefined, undefined, "fire_staff.piece_zm_mstaff", 1, "staff_part");
    var_dad0d129 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "lower_staff", 64, -128, 0, undefined, &function_4d932a71, &function_31edd14b, undefined, undefined, undefined, undefined, "fire_staff.piece_zm_lstaff", 1, "staff_part");
    level thread namespace_73b257ea::function_4e6893a1(var_dad0d129);
    level thread namespace_73b257ea::function_bf15ae49(array(var_ff1e128b));
    level thread namespace_73b257ea::function_ba3cc7f(var_2b72ecda);
    var_d16491f1 = spawnstruct();
    var_d16491f1.name = var_9967ff1;
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_ea18101c);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_2b72ecda);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_ff1e128b);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_dad0d129);
    var_d16491f1.var_41f0f8cd = &function_2b5ac210;
    var_d16491f1.var_855e2ef2 = &function_db7cb849;
    namespace_f37770c8::function_ac4e44a7(var_d16491f1);
    level thread function_6442c1bd(var_d16491f1);
    function_6c0a645(array(var_2b72ecda, var_ff1e128b, var_dad0d129));
    var_9967ff1 = "elemental_staff_lightning";
    var_a7744dee = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "gem", 48, 64, 0, undefined, &function_f138eba9, &function_2e9c07f4, undefined, undefined, undefined, undefined, 3, 0, "crystal", 1);
    var_1af5cbd4 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "upper_staff", 32, 64, 0, undefined, &function_47c3d969, &function_31edd14b, undefined, undefined, undefined, undefined, "lightning_staff.piece_zm_ustaff", 1, "staff_part");
    var_1ca5615 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "middle_staff", 32, 64, 0, undefined, &function_47c3d969, &function_31edd14b, undefined, undefined, undefined, undefined, "lightning_staff.piece_zm_mstaff", 1, "staff_part");
    var_8a2c31b3 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "lower_staff", 32, 64, 0, undefined, &function_47c3d969, &function_31edd14b, undefined, undefined, undefined, undefined, "lightning_staff.piece_zm_lstaff", 1, "staff_part");
    var_d16491f1 = spawnstruct();
    var_d16491f1.name = var_9967ff1;
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_a7744dee);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_1af5cbd4);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_1ca5615);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_8a2c31b3);
    var_d16491f1.var_41f0f8cd = &function_c2ade9a2;
    var_d16491f1.var_855e2ef2 = &function_db7cb849;
    namespace_f37770c8::function_ac4e44a7(var_d16491f1);
    level thread function_6442c1bd(var_d16491f1);
    function_6c0a645(array(var_1af5cbd4, var_1ca5615, var_8a2c31b3));
    var_9967ff1 = "elemental_staff_water";
    var_8bc6e0d9 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "gem", 48, 64, 0, undefined, &function_4d965f64, &function_543ed0c1, undefined, undefined, undefined, undefined, 4, 0, "crystal", 1);
    var_729020bb = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "upper_staff", 32, 64, 0, undefined, &function_6c091d36, &function_31edd14b, undefined, undefined, undefined, undefined, "water_staff.piece_zm_ustaff", 1, "staff_part");
    var_d5151e38 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "middle_staff", 32, 64, 0, undefined, &function_6c091d36, &function_31edd14b, undefined, undefined, undefined, undefined, "water_staff.piece_zm_mstaff", 1, "staff_part");
    var_4fd16468 = namespace_f37770c8::function_5cf75ff1(var_9967ff1, "lower_staff", 32, 64, 0, undefined, &function_6c091d36, &function_31edd14b, undefined, undefined, undefined, undefined, "water_staff.piece_zm_lstaff", 1, "staff_part");
    var_9013fd72 = array(var_4fd16468, var_d5151e38, var_729020bb);
    level thread namespace_73b257ea::function_ca57c87a(var_9013fd72);
    var_d16491f1 = spawnstruct();
    var_d16491f1.name = var_9967ff1;
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_8bc6e0d9);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_729020bb);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_d5151e38);
    var_d16491f1 namespace_f37770c8::function_b0deb4e6(var_4fd16468);
    var_d16491f1.var_41f0f8cd = &function_cac3b361;
    var_d16491f1.var_855e2ef2 = &function_db7cb849;
    namespace_f37770c8::function_ac4e44a7(var_d16491f1);
    level thread function_6442c1bd(var_d16491f1);
    ...
    var_ea18101c thread namespace_73b257ea::function_b15d5ee0(1);
    var_ce6bcac4 thread namespace_73b257ea::function_b15d5ee0(2);
    var_a7744dee thread namespace_73b257ea::function_b15d5ee0(3);
    var_8bc6e0d9 thread namespace_73b257ea::function_b15d5ee0(4);
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_1bf61c98
...
function function_1bf61c98() {
    ...
    foreach (var_3111271f in level.var_b09bbe80) {
        ...
        if (issubstr(var_3111271f.name, "fire")) {
            ...
            /#
                iprintlnbold("quadrotor_cooling_down" + var_3111271f.name);
            #/
            return;
        }
...
// namespace_f7a613cf<file_0>::function_8cf5108b
...
// namespace_f7a613cf<file_0>::function_db7cb849
...
function function_db7cb849(player, var_818b04f5, trigger) {
    ...
    if (isdefined(player)) {
        ...
        if (!self.craftablespawn namespace_f37770c8::function_b008df77(player.var_1666fe57[0])) {
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_f89bb811
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_e1832857
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_69ac47ee
// Checksum 0x48a6173f, Offset: 0x4388
// Size: 0x4c
function function_69ac47ee() {
    function_e1832857();
    namespace_f37770c8::function_4f91b11d("quadrotor_zm_craftable_trigger", "equip_dieseldrone", "equip_dieseldrone", %ZM_TOMB_TQ, 1, 1);
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_a6c22658
// Checksum 0x1c31d231, Offset: 0x43e0
// Size: 0x4c
function function_a6c22658() {
    function_e1832857();
    namespace_f37770c8::function_4f91b11d("staff_air_craftable_trigger", "elemental_staff_air", "staff_air", %ZM_TOMB_PUAS, 1, 1);
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_2b5ac210
// Checksum 0x1d8610bd, Offset: 0x4438
// Size: 0x4c
function function_2b5ac210() {
    function_e1832857();
    namespace_f37770c8::function_4f91b11d("staff_fire_craftable_trigger", "elemental_staff_fire", "staff_fire", %ZM_TOMB_PUFS, 1, 1);
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_c2ade9a2
// Checksum 0xdcc289de, Offset: 0x4490
// Size: 0x4c
function function_c2ade9a2() {
    function_e1832857();
    namespace_f37770c8::function_4f91b11d("staff_lightning_craftable_trigger", "elemental_staff_lightning", "staff_lightning", %ZM_TOMB_PULS, 1, 1);
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_cac3b361
// Checksum 0x247f7b66, Offset: 0x44e8
// Size: 0x4c
function function_cac3b361() {
    function_e1832857();
    namespace_f37770c8::function_4f91b11d("staff_water_craftable_trigger", "elemental_staff_water", "staff_water", %ZM_TOMB_PUIS, 1, 1);
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_84d14ecd
// Checksum 0xd07735ef, Offset: 0x4540
// Size: 0x4c
function function_84d14ecd() {
    function_e1832857();
    namespace_f37770c8::function_4f91b11d("gramophone_craftable_trigger", "gramophone", "gramophone", %ZOMBIE_GRAB_GRAMOPHONE, 1, 1);
}

// Namespace namespace_f7a613cf
// Params 3, eflags: 0x0
// namespace_f7a613cf<file_0>::function_ba68e20
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_31edd14b
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_318b7336
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_8eba867a
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_5c80788a
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_2e9c07f4
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_543ed0c1
...
// Namespace namespace_f7a613cf
// Params 2, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_9d221ddb
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_a4b5301e
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_66a9cb86
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_1f8b4ee
...
function function_1f8b4ee() {
    ...
    if (!(isdefined(level.var_ec22d724) && level.var_ec22d724)) {
        ...
        namespace_ad52727b::function_10d15bb5("vox_sam_1st_staff_found_1_0", self, 1);
        namespace_ad52727b::function_10d15bb5("vox_sam_1st_staff_found_2_0", self);
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_4d932a71
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_f35af043
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_47c3d969
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_6c091d36
...
// Namespace namespace_f7a613cf
// Params 2, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_a58e2875
...
function function_a58e2875(player, elementname) {
    ...
    foreach (e_player in level.players) {
        e_player thread namespace_f37770c8::function_97be99b3(undefined, "zmInventory." + elementname + "_staff.visible", 0);
    }
...
// Namespace namespace_f7a613cf
// Params 3, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_d69dc795
...
function function_d69dc795(player, elementname, var_36e3cbd4) {
    ...
    player thread namespace_f37770c8::function_97be99b3(undefined, "zmInventory.show_musical_parts_widget", 0);
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_15f35ef1
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_a0621a83
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_f138eba9
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_4d965f64
...
// namespace_f7a613cf<file_0>::function_f130c3de
...
function function_f130c3de(var_7d7d7875, var_eb7058d5, str_model_name, var_aebb2010, var_69361faf, var_9d2951e8, var_e46422e8) {
    var_f36883de = 1;
    craftable = namespace_f37770c8::function_5cf75ff1(var_7d7d7875, var_eb7058d5, 32, 64, 0, undefined, &function_66a9cb86, &function_31edd14b, undefined, undefined, undefined, undefined, var_aebb2010, 1, var_9d2951e8, var_f36883de, undefined, 0);
...
// Namespace namespace_f7a613cf
// Params 3, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_eebc4ca9
...
function function_eebc4ca9(var_69361faf, n_clientfield_val, var_e46422e8) {
    ...
    if (isdefined(var_e46422e8)) {
        foreach (e_player in level.players) {
            e_player thread namespace_f37770c8::function_97be99b3(undefined, var_e46422e8, 0);
        }
    }
}
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_6c0a645
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_c3207981
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_e7dc448c
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_e2076525
// Checksum 0x5b866dfa, Offset: 0x5710
// Size: 0x10e
function function_e2076525(player) {
    level.var_3c3bf0e1.crafted = 1;
    namespace_f37770c8::function_21cc3865("equip_dieseldrone", 1);
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_52fbdde1
...
// Namespace namespace_f7a613cf
// Params 2, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_407ad7f1
...
function function_407ad7f1(modelname, var_36e3cbd4) {
    ...
    if (!isdefined(var_2f5ce50b.var_bf1b6093)) {
        ...
        foreach (e_player in level.players) {
            e_player thread namespace_f37770c8::function_97be99b3(undefined, "zmInventory." + var_abcf76c0.element + "_staff.visible", 1);
        }
    }
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_6a4fbed6
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_c67d74ce
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_8feb5840
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_11d70761
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_2a34116f
...
function function_2a34116f(type) {
    ...
    if (!isinarray(level.var_acb362cc, type)) {
        ...
        level thread namespace_54a425fe::function_5f9c184e("staff_" + type);
    }
}

// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_ece63a79
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_408befde
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_ae140b95
...
function function_ae140b95() {
    ...
    while (true) {
        ...
        if (self actionslotfourbuttonpressed() && self hasweapon(var_703e6a13)) {
            ...
            var_a3ffacc8 thread namespace_ad52727b::function_a808bc8e();
            return;
        }
        wait(0.05);
    }
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x0
// namespace_f7a613cf<file_0>::function_c5069b29
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_8e1e797
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_2aa9031e
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_8dbb407d
...
function function_8dbb407d() {
    ...
    if (isdefined(self)) {
        /#
            iprintln("quadrotor_cooling_down");
        #/
        self.var_73545c79 = 1;
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x0
// namespace_f7a613cf<file_0>::function_b0768a15
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_58326159
...
function function_58326159() {
    ...
    self notify(#"hash_f04900f3");
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_b0d2a612
...
function function_b0d2a612() {
    ...
    self thread namespace_ad52727b::function_7dc74a72(var_d072a269, self);
    wait(10);
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_969deae1
...
function function_969deae1() {
    ...
    thread namespace_ad52727b::function_7dc74a72(var_d072a269, level.var_3c3bf0e1.pickup_trig.model);
    wait(60);
    ...
    namespace_ad52727b::function_7dc74a72(var_d072a269, level.var_3c3bf0e1.pickup_trig.model);
}

// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_d37fcc8e
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_e8aad972
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x0
// namespace_f7a613cf<file_0>::function_77842f20
// Checksum 0xd1056bd5, Offset: 0x6b60
// Size: 0x44
function function_77842f20() {
    level.var_972f2ae2 = namespace_f37770c8::function_4f91b11d("sq_common_craftable_trigger", "sq_common", "sq_common", "", 1, 0);
}

// Namespace namespace_f7a613cf
// Params 1, eflags: 0x0
// namespace_f7a613cf<file_0>::function_be206d34
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x0
// namespace_f7a613cf<file_0>::function_832dcda8
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_d00832ac
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_e5ad4beb
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_568dc89e
...
function function_568dc89e(player) {
    ...
    if (!player namespace_73b257ea::function_d19c6953()) {
        return false;
    }
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_db3359f1
...
function function_db3359f1(player) {
    if (self.stub.equipname == "equip_dieseldrone") {
        ...
        if (self function_2b1a7826(self.stub.weaponname) && !(isdefined(level.var_b79a2c38[self.stub.equipname]) && level.var_b79a2c38[self.stub.equipname])) {
            ...
            player namespace_f37770c8::track_craftables_pickedup(self.stub.craftablespawn);
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_fcebb932
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_2b1a7826
...
// Namespace namespace_f7a613cf
// Params 2, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_9b485a9
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_9cc411fa
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_2c9b5fc
...
// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_53ad8621
            ...
            foreach (weapon in weapons) {
                ...
                if (has_weapon && !(isdefined(player.var_5fc3c5c7) && player.var_5fc3c5c7) && var_a904111d != 0 && !player hasperk("specialty_widowswine")) {
                    ...
                    if (isdefined(player.var_27eb897c) && var_c2577628 != weapon && player.var_27eb897c) {
                        player namespace_d7c0ce12::function_84442246(0);
                        continue;
                    }
                    if (var_c2577628 == weapon && !(isdefined(player.var_27eb897c) && player.var_27eb897c)) {
                        player namespace_d7c0ce12::function_84442246(var_a904111d);
                    }
                }
            }
        }
...
// Namespace namespace_f7a613cf
// Params 2, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_476c0e12
...
function function_476c0e12(var_5ec0aa73, e_player) {
    ...
    e_player namespace_d7c0ce12::function_84442246(s_staff.enum);
    /#
        iprintlnbold("quadrotor_cooling_down" + n_player + "quadrotor_cooling_down" + s_staff.enum);
    #/
}

// Namespace namespace_f7a613cf
// Params 1, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_fca8537d
...
// Namespace namespace_f7a613cf
// Params 2, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_abd72df3
...
function function_abd72df3(w_check, e_owner) {
    ...
    if (isdefined(e_owner)) {
        if (level clientfield::get(s_staff.element + "_staff.holder") == e_owner.characterindex + 1) {
            ...
            level clientfield::set(s_staff.element + "_staff.holder", 0);
            e_owner namespace_d7c0ce12::function_84442246(0);
        }
    }
    /#
        iprintlnbold("quadrotor_cooling_down" + s_staff.enum);
    #/
...
// Namespace namespace_f7a613cf
// Params 0, eflags: 0x1 linked
// namespace_f7a613cf<file_0>::function_80834820
