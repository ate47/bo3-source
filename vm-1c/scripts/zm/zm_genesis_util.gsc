...
function function_c8040935(var_216e90fd) {
    ...
    if (!isdefined(level.var_bd64e31e) || var_1ca69a28 < level.var_bd64e31e) {
        if (!(isdefined(ai_zombie.var_6c653628) && ai_zombie.var_6c653628)) {
            ...
            ai_zombie thread zm_elemental_zombie::function_e94aef80();
...
/#
    ...
    function devgui() {
        ...
        level thread function_72260d3a("<dev string:xaec>", "<dev string:xb0b>", 1, &zm_genesis_minor_ee::function_e1963311);
    ...
    function function_dbc092aa(cmd) {
        var_98be8724 = strtok(cmd, "<dev string:xb16>");
        ...
        case "<dev string:xc95>":
            foreach (e_player in level.activeplayers) {
                level thread _zm_weap_octobomb::function_e53a7954(e_player);
            }
            break;
        default:
            break;
