...
// namespace_265ae7e9<file_0>::function_d290ebfa
...
// Namespace namespace_265ae7e9
// Params 0, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_f45953c
...
// Namespace namespace_265ae7e9
// Params 0, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_e6258024
...
// namespace_265ae7e9<file_0>::function_9b0b8f8e
...
// namespace_265ae7e9<file_0>::function_68c9b7de
...
// Namespace namespace_265ae7e9
// Params 2, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_30e2d0b9
...
// Namespace namespace_265ae7e9
// Params 0, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_d0afe567
// Checksum 0x2051bed1, Offset: 0x2568
// Size: 0x374
function function_d0afe567() {
    var_3c94eadd = struct::get("struct_theater_projector_beam", "targetname");
    var_1295db7a = var_3c94eadd.angles;
    var_e86aaf25 = anglestoup(var_1295db7a);
    var_c849c25 = anglestoforward(var_1295db7a);
    var_846b23bf = struct::get("struct_theater_screen", "targetname");
    var_b2c4fc94 = var_846b23bf.angles;
    var_8780ae3b = anglestoup(var_b2c4fc94);
    var_9f108edb = anglestoforward(var_b2c4fc94);
    var_3c94eadd.var_c2914b49 = [];
    var_3c94eadd.var_eccab862 = [];
    ...
    players = getlocalplayers();
    for (i = 0; i < players.size; i++) {
        var_3c94eadd.var_c2914b49[i] = util::spawn_model(i, "tag_origin", var_3c94eadd.origin, var_3c94eadd.angles);
        playfxontag(i, level._effect["theater_projector_beam"], var_3c94eadd.var_c2914b49[i], "tag_origin");
    }
    level.var_3cb13a71 = [];
    level.var_bcdc3660 = [];
    for (i = 0; i < players.size; i++) {
        var_3c94eadd.var_eccab862[i] = util::spawn_model(i, "tag_origin", var_846b23bf.origin, var_846b23bf.angles);
        var_b4808d98 = playfxontag(i, level._effect["projector_screen_0"], var_3c94eadd.var_eccab862[i], "tag_origin");
...
// namespace_265ae7e9<file_0>::function_4c75814e
// Checksum 0x4fef4caa, Offset: 0x28e8
// Size: 0x6c
function function_4c75814e(var_37708867) {
    level thread function_66aca41c(var_37708867, "ps1");
    level thread function_66aca41c(var_37708867, "ps2");
    level thread function_66aca41c(var_37708867, "ps3");
}

// Namespace namespace_265ae7e9
// Params 2, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_66aca41c
// Checksum 0x9be687e2, Offset: 0x2960
// Size: 0x118
function function_66aca41c(var_72515d6d, var_47653dff) {
    level waittill(var_47653dff);
    players = getlocalplayers();
    for (i = 0; i < players.size; i++) {
        if (isdefined(var_72515d6d.var_eccab862[i])) {
            stopfx(i, level.var_3cb13a71[i]);
            if (!level.var_2c3bd034[i]) {
                level.var_3cb13a71[i] = playfxontag(i, level._effect[var_47653dff], var_72515d6d.var_eccab862[i], "tag_origin");
            }
            level.var_bcdc3660[i] = var_47653dff;
        }
    }
}
...
// namespace_265ae7e9<file_0>::function_e4b3e1ca
...
// Namespace namespace_265ae7e9
// Params 0, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_54ae2c5f
...
// Namespace namespace_265ae7e9
// Params 0, eflags: 0x1 linked
// namespace_265ae7e9<file_0>::function_9c6ed203
