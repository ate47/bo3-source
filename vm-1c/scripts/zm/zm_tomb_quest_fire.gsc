...
function main() {
    ...
    function_badc3cb5();
    function_4c0b94bc();
    zm_tomb_vo::function_446b06b3(1, "vox_sam_fire_puz_solve_0");
    zm_tomb_vo::function_446b06b3(1, "vox_sam_fire_puz_solve_1");
    zm_tomb_vo::function_446b06b3(1, "vox_sam_fire_puz_solve_2");
    level thread zm_tomb_vo::function_d22bb7("puzzle", "try_puzzle", "vo_try_puzzle_fire1");
    level thread zm_tomb_vo::function_d22bb7("puzzle", "try_puzzle", "vo_try_puzzle_fire2");
...
function function_8487a3a2() {
    ...
    e_player thread zm_tomb_vo::function_2af394fb(1);
...
function function_5b72f9c5() {
    ...
    foreach (var_27b8ef56 in var_9c6204c6) {
        ...
        var_8ccc3a0d thread zm_tomb_utility::function_5de0d079();
    }
}
...
function function_6fe3d250() {
    ...
    if (function_601c220c() && !level flag::get("fire_puzzle_2_complete")) {
        self.e_fx thread zm_tomb_vo::function_2af394fb(1);
