...
/#
    ...
    function function_7a5b2191() {
        level thread zm_genesis_util::function_72260d3a("<dev string:x35>", "<dev string:x5c>", 0, &function_92d90d50);
        level thread zm_genesis_util::function_72260d3a("<dev string:x6e>", "<dev string:x5c>", 2, &function_92d90d50);
    }
