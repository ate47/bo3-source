...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_a70ab4c3
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_c87827a3
// Checksum 0x1e9f69bf, Offset: 0x9d0
// Size: 0x154
function function_c87827a3() {
    level notify(#"hash_c2b1dec7");
    level.var_b7572a82 = 1;
    level.var_22060a89 = [];
    level thread namespace_c149ef1::function_c74d1a57();
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_8e64e16a
...
function function_8e64e16a() {
    ...
    while (true) {
        foreach (str_index, str_archetype in level.var_22060a89) {
            if (level.var_22060a89[str_index] > 0) {
                level.var_c4336559[str_index] = level.var_c4336559[str_index] + level.var_22060a89[str_index];
                level.var_22060a89[str_index] = 0;
            }
        }
...
// namespace_484ba32a<file_0>::function_66a5ce12
// Checksum 0xa9d75099, Offset: 0xd60
// Size: 0x10c
function function_66a5ce12(var_4379152, e_attacker) {
    if (isdefined(level.var_716fc13e)) {
        [[ level.var_716fc13e ]](var_4379152, level.var_6a6f912a);
        return;
    }
...
// namespace_484ba32a<file_0>::function_630f7ed5
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_5a772555
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_3586b759
// Checksum 0x24e5f0c4, Offset: 0xfc8
// Size: 0x10c
function function_3586b759() {
    namespace_3425d4b9::function_2daf7170();
    wait(0.5);
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_a61de87c
// Checksum 0x32d77ef7, Offset: 0x10e0
// Size: 0x222
function function_a61de87c() {
    var_4379152, e_attacker = level waittill(#"hash_ddc0a71d");
    level thread function_4a9010ae();
    level thread function_66a5ce12(e_attacker);
    namespace_4c9147::function_5003c1cd(0, 0);
    while (true) {
    ...
    level notify(#"hash_b66ef55c");
}

// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_4a9010ae
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_1bfefd4f
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_aa92a46b
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_3cf05b99
...
function function_3cf05b99() {
    ...
    case 9:
        ...
        level notify(#"hash_6557c51a");
        break;
    case 10:
        ai_zombie = function_f55d851b();
        level notify(#"hash_86b02ea3");
        break;
    case 8:
    default:
        if (namespace_3425d4b9::function_5bf63224()) {
            namespace_3425d4b9::function_b820d8(1, 1);
            level notify(#"hash_f49dcaee");
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_1fe60e52
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_6647fb88
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x0
// namespace_484ba32a<file_0>::function_1089db10
// Checksum 0x686df979, Offset: 0x1928
// Size: 0x5e
function function_1089db10() {
    var_cecd0670 = zombie_utility::get_current_zombie_count();
    var_cecd0670 -= namespace_cb655c88::function_adcc0e33();
    var_cecd0670 -= namespace_cb655c88::function_e3e6bdba();
    return var_cecd0670;
}

// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_f55d851b
...
function function_f55d851b() {
    ...
    if (isdefined(queryresult) && queryresult.data.size > 0) {
        ...
        for (i = 0; i < a_spots.size; i++) {
            ...
            v_angles = namespace_cb655c88::get_lookat_angles(v_origin, e_player.origin);
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_77d3a18d
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_21bbe70d
    ...
    if (isdefined(queryresult) && queryresult.data.size > 0) {
        ...
        for (i = 0; i < a_spots.size; i++) {
            ...
            if (isdefined(str_zone) && level.zones[str_zone].is_active) {
                ...
                var_ecb2c615 = namespace_c21dfba4::function_21bbe70d(v_origin, v_angles, 0);
...
// Namespace namespace_484ba32a
// Params 1, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_1f0a0b52
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_e7ec74b4
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_25a4a7d4
...
// Namespace namespace_484ba32a
// Params 1, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_6cc52664
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x0
// namespace_484ba32a<file_0>::function_d974570f
...
function spawn_zombie() {
    ...
    if (n_random < 3) {
        ...
        ai_zombie namespace_cb655c88::function_c8040935(1);
    }
    if (n_random < 9) {
        ai_zombie namespace_df1a4a92::function_1b2b62b();
    } else if (n_random < 12) {
        ai_zombie namespace_6727c59c::function_a35db70f();
    } else if (n_random < 35) {
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x0
// namespace_484ba32a<file_0>::function_b3e803ec
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_fd8b24f5
...
// Namespace namespace_484ba32a
// Params 0, eflags: 0x1 linked
// namespace_484ba32a<file_0>::function_47b2f1f4
// Checksum 0xcc6950ce, Offset: 0x2788
// Size: 0x16c
function function_47b2f1f4() {
    if (level.var_22060a89.size) {
        b_valid = 0;
        foreach (str_index, n_val in level.var_22060a89) {
            if (n_val > 0) {
                switch (str_index) {
                case 31:
...
/#
    ...
    // Namespace namespace_484ba32a
    // Params 0, eflags: 0x1 linked
    // namespace_484ba32a<file_0>::function_28e53883
    // Checksum 0x17cd62f1, Offset: 0x2900
    // Size: 0x44
    function function_28e53883() {
        level thread namespace_cb655c88::function_72260d3a("parasite", "parasite", 1, &function_b6f47996);
    }

    // Namespace namespace_484ba32a
    // Params 1, eflags: 0x1 linked
    // namespace_484ba32a<file_0>::function_b6f47996
    // Checksum 0x5c539fda, Offset: 0x2950
    // Size: 0x74
    function function_b6f47996(n_val) {
        zm_utility::zombie_goto_round(level.var_783db6ab - 1);
        level notify(#"kill_round");
        iprintlnbold("parasite");
        namespace_4c9147::function_5003c1cd(0, 1);
    }
