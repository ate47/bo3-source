...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x2
// namespace_3e86c990<file_0>::function_2dc19561
...
// namespace_3e86c990<file_0>::function_8c87d8eb
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x0
// namespace_3e86c990<file_0>::function_3f4e5049
...
// namespace_3e86c990<file_0>::function_bfe01277
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_5b6b9132
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_aeaa2ee6
...
function function_aeaa2ee6() {
    ...
    while (true) {
        e_player = s_trigger waittill(#"trigger_activated");
...
// namespace_3e86c990<file_0>::function_4b8fea3
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_d4781758
// Checksum 0x846402, Offset: 0x10f0
// Size: 0x244
function function_d4781758(e_player) {
    self flag::set("turret_active");
    if (math::cointoss()) {
        self thread namespace_c149ef1::function_bc8dac38(e_player, "turret");
    } else {
...
// namespace_3e86c990<file_0>::function_c31e47a5
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_ff090b49
...
// namespace_3e86c990<file_0>::function_bc4ca4fb
...
// Namespace namespace_3e86c990
// Params 3, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_cd048702
...
// Namespace namespace_3e86c990
// Params 2, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_f8f61ccb
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_f2c7fc31
        ...
        if (isdefined(a_trace["entity"])) {
            ...
            if (e_last_target.archetype === "zombie" || e_last_target.archetype === "parasite" || e_last_target.archetype === "keeper" || e_last_target.archetype === "apothicon_fury") {
                ...
                if (e_last_target.archetype == "margwa") {
                    ...
                    if (e_last_target namespace_4ef1a8d3::function_2a03f05f()) {
                        e_last_target.var_9e59b56e = 1;
                    }
                } else if (e_last_target.archetype == "mechz") {
                    if (e_last_target namespace_ef567265::function_58655f2a()) {
...
// Namespace namespace_3e86c990
// Params 2, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_b859045
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_b759bcc1
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_838f52ad
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_eed68f1e
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_677988
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_67c99c8d
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_e4ac9f57
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_3d36386
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_d54746f0
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_7fd518ea
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_13eaa39c
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_c4a9de44
// Checksum 0x23c7f963, Offset: 0x26d8
// Size: 0x178
function function_c4a9de44() {
    /#
        if (level flag::get("skull_turret_shock_eye_fx")) {
            return;
        }
    ...
    while (true) {
        w_weapon, e_player = self waittill(#"beam_damage");
        if (isdefined(w_weapon) && isdefined(e_player)) {
            ...
            if (n_total_time >= 0.15) {
                self function_8bc99b56(w_weapon, e_player);
            }
        }
    }
}
...
/#
    ...
    // Namespace namespace_3e86c990
    // Params 0, eflags: 0x1 linked
    // namespace_3e86c990<file_0>::function_b52693fa
    // Checksum 0x3e9982d1, Offset: 0x2858
    // Size: 0x84
    function function_b52693fa() {
        level endon(#"hash_d54a17c1");
        level waittill(#"hash_8bc99b56");
        if (!(isdefined(self.var_827db0f2) && self.var_827db0f2)) {
            a_vehicles = getvehiclearray(self.script_string, "skull_turret_shock_eye_fx");
            self thread function_8bc99b56(a_vehicles[0], level.players[0]);
        }
    }
...
// Namespace namespace_3e86c990
// Params 2, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_8bc99b56
// Checksum 0x13d4a846, Offset: 0x28e8
// Size: 0x1a2
function function_8bc99b56(w_weapon, e_player) {
    /#
        if (level flag::get("skull_turret_shock_eye_fx")) {
            return;
        }
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_13705ce6
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_1d6baeec
...
// Namespace namespace_3e86c990
// Params 1, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_67cc41d
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_218cc1b
...
// Namespace namespace_3e86c990
// Params 0, eflags: 0x1 linked
// namespace_3e86c990<file_0>::function_41ecbdf9
...
/#
    ...
    // Namespace namespace_3e86c990
    // Params 1, eflags: 0x1 linked
    // namespace_3e86c990<file_0>::function_881d11a1
    ...
    function function_881d11a1(var_53acb497) {
        ...
        level thread namespace_cb655c88::function_72260d3a("skull_turret_shock_eye_fx", "skull_turret_shock_eye_fx", 1, &function_aa0448ec);
        level thread namespace_cb655c88::function_72260d3a("skull_turret_shock_eye_fx", "skull_turret_shock_eye_fx", 1, &function_1f8c58a1);
    }

    // Namespace namespace_3e86c990
    // Params 1, eflags: 0x1 linked
    // namespace_3e86c990<file_0>::function_aa0448ec
    // Checksum 0x4b905de4, Offset: 0x30d0
    // Size: 0x1e
    function function_aa0448ec(n_val) {
        level notify(#"hash_aa0448ec");
    }

    // Namespace namespace_3e86c990
    // Params 1, eflags: 0x1 linked
    // namespace_3e86c990<file_0>::function_1f8c58a1
