...
function function_fb5e0a7e() {
    /#
        for (i = 0; i < 4; i++) {
            level thread function_72260d3a("<dev string:x49>" + i, "<dev string:x61>", i, &function_3dec91b9);
        }
        for (i = 0; i < 16; i++) {
            level thread function_72260d3a("<dev string:x78>" + i, "<dev string:x97>", i, &function_49720b6e);
        }
        for (i = 1; i <= 4; i++) {
            level thread function_72260d3a("<dev string:xaf>" + i, "<dev string:xde>", i, &function_124286f7);
        }
    #/
}
