...
function function_be75904(sound_to_play, waittime, category, type, override) {
    ...
    if (isdefined(self.var_98905394) && self.var_98905394 && !self zm_equip_gasmask::function_7dd87435()) {
        return;
    }
...
// Size: 0x108
function function_5e318772(alias, digger) {
    if (!isdefined(alias)) {
        return;
    }
...
function function_e757be94() {
    level waittill(#"hash_f7683da1", who);
...
function function_fbc53914() {
    ...
    while (true) {
        ...
        if (isdefined(self.var_98905394 && self hasweapon(level.var_f486078e) && !self zm_equip_gasmask::function_7dd87435()) && self.var_98905394 && self hasweapon(level.var_f486078e) && !self zm_equip_gasmask::function_7dd87435()) {
            self stopsounds();
            wait 0.05;
            self playsoundtoplayer("vox_mcomp_suit_reminder", self);
            while (self.var_98905394) {
                if (self zm_equip_gasmask::function_7dd87435()) {
                    break;
                }
                wait 0.1;
            }
