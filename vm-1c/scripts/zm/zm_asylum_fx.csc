...
// namespace_bf71ff59<file_0>::function_d290ebfa
...
function main() {
    ...
    level thread function_6b84da80("revive_on", "revive_electric_wire");
    level thread function_6b84da80("middle_door_open", "electric_middle_door");
    level thread function_6b84da80("fast_reload_on", "electric_fast_reload");
    level thread function_6b84da80("doubletap_on", "electric_double_tap");
    level thread function_6b84da80("jugger_on", "electric_juggernog");
}

// Namespace namespace_bf71ff59
// Params 2, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_dc095355
...
function function_dc095355(ent, localclientnum) {
    ...
    if (isdefined(var_519c4c0b.loopfx)) {
        var_519c4c0b.loopfx delete();
        var_81af7cd1.loopfx delete();
    }
    var_519c4c0b.loopfx = spawnfx(localclientnum, level._effect["zapper_wall"], var_519c4c0b.origin, 0, var_ec2aa6a7, var_28414727);
    triggerfx(var_519c4c0b.loopfx);
    var_81af7cd1.loopfx = spawnfx(localclientnum, level._effect["zapper_fx"], var_81af7cd1.origin, 0, var_6acb4c1, var_93aca931);
    triggerfx(var_81af7cd1.loopfx);
}

// Namespace namespace_bf71ff59
// Params 1, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_1c1a68e1
...
// Namespace namespace_bf71ff59
// Params 2, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_6b84da80
// Checksum 0xcc4957f, Offset: 0x1550
// Size: 0x128
function function_6b84da80(var_7ff7f902, var_1dc3abd8) {
    level waittill(var_7ff7f902);
    for (targ = struct::get(var_1dc3abd8, "targetname"); isdefined(targ); targ = undefined) {
...
// namespace_bf71ff59<file_0>::function_93f91575
...
// Namespace namespace_bf71ff59
// Params 7, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_4c17ba1b
...
// Namespace namespace_bf71ff59
// Params 2, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_46f37b91
...
function function_46f37b91(str_side, localclientnum) {
    ...
    while (isdefined(ent.fx)) {
        for (targ = struct::get(ent.target, "targetname"); isdefined(targ); targ = undefined) {
            if (randomint(100) > 50) {
...
// Namespace namespace_bf71ff59
// Params 1, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_576a2cdd
...
// Namespace namespace_bf71ff59
// Params 0, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_f45953c
...
// Namespace namespace_bf71ff59
// Params 0, eflags: 0x1 linked
// namespace_bf71ff59<file_0>::function_e6258024
