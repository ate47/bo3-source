...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_7d27aacb
...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_d1c51308
...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_f61f49b0
...
// namespace_44f858d8<file_0>::function_719d3043
...
// Namespace namespace_44f858d8
// Params 2, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_26ed5998
...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_3bcaa1c
...
// namespace_44f858d8<file_0>::function_836f0458
...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_bce246fa
...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_b177eb62
...
// Namespace namespace_44f858d8
// Params 1, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_cf810f3f
...
// Namespace namespace_44f858d8
// Params 1, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_584171ff
    ...
    if (isdefined(self)) {
        if (b_on && !(isdefined(self.s_unitrigger.b_on) && self.s_unitrigger.b_on) && level.var_8c92b387["fun_facts"][self.script_int].size > 0) {
            ...
            if (isdefined(e_player)) {
                e_player thread function_2c251c80(1);
            }
            self.s_unitrigger.b_on = 1;
        ...
        if (!b_on) {
            e_player = zm_utility::function_a157d632(self.script_int);
            if (isdefined(e_player)) {
                e_player thread function_2c251c80(0);
            }
            self.s_unitrigger.b_on = 0;
            self notify(#"hash_d8f13b7d");
        }
...
// Namespace namespace_44f858d8
// Params 0, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_198aed06
...
// Namespace namespace_44f858d8
// Params 1, eflags: 0x1 linked
// namespace_44f858d8<file_0>::function_caef395a
...
/#
    ...
    // Namespace namespace_44f858d8
    // Params 0, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_a9d6e3ef
    ...
    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x0
    // namespace_44f858d8<file_0>::function_68f439f5
    // Checksum 0xd65b0eb, Offset: 0x1e18
    // Size: 0x4c
    function function_68f439f5(n_val) {
        player = level.activeplayers[n_val];
        if (isdefined(player)) {
            player function_2c251c80(1);
        }
    }

    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x0
    // namespace_44f858d8<file_0>::function_12821101
    // Checksum 0x9e6993a2, Offset: 0x1e70
    // Size: 0x4c
    function function_12821101(n_val) {
        player = level.activeplayers[n_val];
        if (isdefined(player)) {
            player function_2c251c80(0);
        }
    }

    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_910a409b
    ...
    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_d4b54e53
    ...
    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x0
    // namespace_44f858d8<file_0>::function_96632750
    // Checksum 0x492cca6c, Offset: 0x20d0
    // Size: 0x3c
    function function_96632750(n_val) {
        namespace_c149ef1::function_bbeae714(level.activeplayers[n_val].characterindex);
    }

    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_920920c8
    // Checksum 0x6ea05532, Offset: 0x2118
    // Size: 0x24
    function function_920920c8(n_val) {
        namespace_c149ef1::function_bbeae714(n_val);
    }

    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_4701ab9e
    ...
    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_76a93e50
    ...
    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_eaebf31c
    // Checksum 0xce84eef1, Offset: 0x2208
    // Size: 0x66
    function function_eaebf31c(n_val) {
        if (n_val == 1) {
            level notify(#"hash_81478370");
            return;
        }
        if (n_val == 2) {
            level notify(#"hash_fc31e77e");
            return;
        }
        if (n_val == 0) {
    ...
    // Namespace namespace_44f858d8
    // Params 1, eflags: 0x1 linked
    // namespace_44f858d8<file_0>::function_371c89ce
