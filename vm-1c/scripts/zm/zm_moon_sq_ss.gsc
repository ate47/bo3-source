...
function function_358664bb() {
    /#
        ...
        if (!isdefined(level.var_f4f9b4b2)) {
            ...
            level.var_1d3f9fdf.alignx = "<dev string:x28>";
            level.var_1d3f9fdf.aligny = "<dev string:x2d>";
            ...
            level.var_ac554d7.alignx = "<dev string:x34>";
            level.var_ac554d7.aligny = "<dev string:x2d>";
            ...
            level.var_ac554d7 settext("<dev string:x3a>");
            level.var_92bff4b = newdebughudelem();
            level.var_92bff4b.location = 0;
            level.var_92bff4b.alignx = "<dev string:x28>";
            level.var_92bff4b.aligny = "<dev string:x2d>";
            ...
            level.var_5dca570b.alignx = "<dev string:x34>";
            level.var_5dca570b.aligny = "<dev string:x2d>";
            ...
            level.var_5dca570b settext("<dev string:x41>");
        }
        while (true) {
            if (isdefined(level.var_58f48a6c)) {
                ...
                level.var_92bff4b settext("<dev string:x4d>");
            }
            wait 0.1;
        }
    #/
...
function function_7747c56() {
    ...
    if (isdefined(level.var_7a69970d)) {
        for (i = 0; i < level.var_7a69970d.size; i++) {
            zm_equip_hacker::function_fcbe2f17(level.var_7a69970d[i]);
        }
    }
...
function function_4a167f8(stage) {
    ...
    if (stage == 1) {
        ...
        if (isdefined(player)) {
            ...
            var_843607b8 waittill(#"mcomp_done0");
            if (isdefined(player)) {
...
function function_3dab436(stage) {
    ...
    if (stage == 1) {
        ...
        if (isdefined(player)) {
            ...
            var_843607b8 waittill(#"mcomp_done2");
            if (isdefined(player)) {
...
function function_ca3d5a09(stage) {
    ...
    if (stage == 1) {
        ...
        if (isdefined(player)) {
            ...
            var_843607b8 waittill(#"mcomp_done3");
            if (isdefined(player)) {
    ...
    case 2:
        ...
        var_843607b8 waittill(#"mcomp_done6");
