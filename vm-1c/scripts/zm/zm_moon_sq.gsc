...
function init() {
    ...
    zm_moon_sq_ss::function_923ff8b();
    ...
    zm_moon_sq_ctt::function_923ff8b();
...
function launch() {
    ...
    level.var_cde53b4c++;
    println("<dev string:x35>" + level.var_cde53b4c + "<dev string:x3d>");
    ...
    println("<dev string:x35>" + level.var_cde53b4c + "<dev string:x49>");
}
...
function function_2f7d3521() {
    ...
    foreach (s_start in a_start) {
        ...
        zm_weap_microwavegun::function_d4224082(var_2ad32714);
...
function function_4ee03f50() {
    ...
    zm_equip_hacker::function_66764564(var_8c15cb32, &function_9391498d);
}
