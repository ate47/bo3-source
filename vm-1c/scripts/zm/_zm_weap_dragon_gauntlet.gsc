...
// Checksum 0xbe46462e, Offset: 0x708
// Size: 0x34
...
function __init__() {
    ...
    zm_hero_weapon::function_3d766bf2(level.var_207d01be, &function_fa885ef2);
    zm_hero_weapon::function_3d766bf2(level.var_ae0fff53, &function_fa885ef2);
    callback::on_connect(&function_44774881);
    callback::on_player_killed(&function_421902c5);
    zm_hero_weapon::function_d29010f8("dragon_gauntlet_flamethrower");
    zm_hero_weapon::function_e295a0c2("dragon_gauntlet_flamethrower", &function_712b36f9, &function_b90c6ba);
    zm_hero_weapon::function_abe86c3f("dragon_gauntlet_flamethrower", &function_cd7dbd9d, &function_2f36d185);
    zm_hero_weapon::function_d29010f8("dragon_gauntlet");
    zm_hero_weapon::function_e295a0c2("dragon_gauntlet", &function_f79afde0, &function_d638417f);
    zm_hero_weapon::function_abe86c3f("dragon_gauntlet", &function_cd7dbd9d, &function_2f36d185);
...
// namespace_2ef08cd1<file_0>::function_44774881
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x0
// namespace_2ef08cd1<file_0>::function_19d7ac29
// Checksum 0x3078337, Offset: 0xba0
// Size: 0x4c
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_421902c5
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_99a68dd
...
function function_99a68dd() {
    ...
    player zm_hero_weapon::function_eca1a7bb(self.var_207d01be, 2);
...
// namespace_2ef08cd1<file_0>::function_36f6c07f
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_712b36f9
...
function function_712b36f9(var_40c4a571) {
    ...
    self zm_hero_weapon::function_44ede878(var_40c4a571);
    ...
    self thread zm_hero_weapon::function_bde51ee1(self.var_207d01be);
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_b90c6ba
...
function function_b90c6ba(var_40c4a571) {
    ...
    self.var_8afc8427 = self gadgetpowerget(0);
    self.hero_power = self gadgetpowerget(0);
    self zm_hero_weapon::function_d1e94a2f(var_40c4a571);
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_f79afde0
// Checksum 0x7fc9f7d3, Offset: 0x10b0
// Size: 0x1dc
function function_f79afde0(var_dabe8ae8) {
    self zm_hero_weapon::function_44ede878(var_dabe8ae8);
    self function_36f6c07f(3);
    ...
    self.hero_power = self gadgetpowerget(0);
    self notify(#"hash_8851ed94");
    self thread zm_hero_weapon::function_bde51ee1(self.var_ae0fff53);
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_d638417f
...
function function_d638417f(var_dabe8ae8) {
    ...
    self.var_8afc8427 = self gadgetpowerget(0);
    self.hero_power = self gadgetpowerget(0);
    self zm_hero_weapon::function_d1e94a2f(var_dabe8ae8);
    self function_36f6c07f(1);
    self enableoffhandweapons();
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_2c008e7d
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_22a08c51
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_c0093887
...
function function_c0093887() {
    ...
    while (!(isdefined(self.var_cc844f4c) && self.var_cc844f4c)) {
        ...
        if (!isdefined(level.var_163a43e4) || self adsbuttonpressed() && self getcurrentweapon() === self.var_207d01be && !(isdefined(self.var_a0a9409e) && self.var_a0a9409e) && !is_in_array(self, level.var_163a43e4)) {
...
// namespace_2ef08cd1<file_0>::function_61f97d13
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_d7a4275d
...
function function_d7a4275d() {
    ...
    while (self adsbuttonpressed()) {
        if (isdefined(level.var_163a43e4) && (isdefined(self.var_a0a9409e) && self.var_a0a9409e || is_in_array(self, level.var_163a43e4))) {
            continue;
        }
        wait(0.05);
    }
    while (true) {
        ...
        if (isdefined(level.var_163a43e4) && (isdefined(self.var_a0a9409e) && (self adsbuttonpressed() && self getcurrentweapon() === self.var_ae0fff53 || self.var_a0a9409e) || is_in_array(self, level.var_163a43e4)) || !isalive(self.var_4bd1ce6b)) {
            self disableweaponcycling();
            self function_22d7caeb();
            self.var_8afc8427 = self gadgetpowerget(0);
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_62d6a233
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_8e2014a0
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_e7fe168a
...
// Namespace namespace_2ef08cd1
// Params 2, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_345e492a
// Checksum 0x3b1fc9f3, Offset: 0x20a8
// Size: 0x32a
function function_345e492a(damage_point, radius) {
    player = self;
    var_279f4421 = array::get_all_closest(damage_point, getaiteamarray(level.zombie_team), undefined, undefined, radius);
    if (!isdefined(var_279f4421) || var_279f4421.size <= 0) {
        return;
    }
    foreach (enemy in var_279f4421) {
...
// Namespace namespace_2ef08cd1
// Params 2, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_fa885ef2
...
function function_fa885ef2(e_player, ai_enemy) {
    ...
    if (isdefined(e_player) && isdefined(e_player.var_8afc8427)) {
        if (isdefined(ai_enemy.heroweapon_kill_power)) {
            ...
            e_player.var_8afc8427 += var_adc6861a * ai_enemy.heroweapon_kill_power;
            e_player.var_8afc8427 = math::clamp(e_player.var_8afc8427, 0, 100);
            if (e_player.var_8afc8427 >= e_player.var_2ff8e129) {
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_2f36d185
...
// Namespace namespace_2ef08cd1
// Params 1, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_cd7dbd9d
...
function function_cd7dbd9d(weapon) {
    ...
    self zm_hero_weapon::function_eca1a7bb(weapon, 2);
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_f5802b55
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_44ecb9cb
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_1692b405
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_22d7caeb
...
// Namespace namespace_2ef08cd1
// Params 0, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_b80d5548
...
// namespace_2ef08cd1<file_0>::function_cb315e40
    ...
    if (isdefined(attacker) && isplayer(attacker)) {
        if (isdefined(weapon) && weapon === level.var_207d01be) {
            if (meansofdeath === "MOD_BURNED") {
                ...
                if (isdefined(level.zombie_vars[attacker.team]["zombie_insta_kill"]) && isdefined(level.zombie_vars[attacker.team]) && (self.archetype === "zombie" || level.zombie_vars[attacker.team]["zombie_insta_kill"])) {
...
// namespace_2ef08cd1<file_0>::function_d775fe77
...
// Namespace namespace_2ef08cd1
// Params 8, eflags: 0x1 linked
// namespace_2ef08cd1<file_0>::function_cb6fb97
...
/#
    ...
    // Namespace namespace_2ef08cd1
    // Params 0, eflags: 0x1 linked
    // namespace_2ef08cd1<file_0>::function_a23fb854
    ...
    function function_a23fb854() {
        ...
        str_cmd = "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT" + equipment_id + "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT";
        ...
        str_cmd = "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT" + equipment_id + "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT";
        adddebugcommand(str_cmd);
        str_cmd = "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT";
        adddebugcommand(str_cmd);
        str_cmd = "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT";
        adddebugcommand(str_cmd);
        while (true) {
            equipment_id = getdvarstring("DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT");
            if (equipment_id != "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT") {
                foreach (player in getplayers()) {
                    if (equipment_id == var_40c4a571.name) {
                        player function_99a68dd();
                    }
                }
                setdvar("DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT", "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT");
            }
            equipment_id = getdvarstring("DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT");
            if (equipment_id != "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT") {
                foreach (player in getplayers()) {
            ...
            string = getdvarstring("DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT");
            if (string === "DLC3_WEAP_DRAGON_GAUNTLET_MELEE_HINT") {
                foreach (player in getplayers()) {
    ...
    // Namespace namespace_2ef08cd1
    // Params 0, eflags: 0x1 linked
    // namespace_2ef08cd1<file_0>::function_82f11e44
    ...
    // Namespace namespace_2ef08cd1
    // Params 0, eflags: 0x1 linked
    // namespace_2ef08cd1<file_0>::function_c2e5ffc1
