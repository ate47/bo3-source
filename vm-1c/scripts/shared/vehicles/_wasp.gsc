...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_32100861
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_b272dd98
...
// namespace_7a91f98<file_0>::function_c18559a5
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_8a8b75b0
...
function state_emped_update(params) {
    ...
    roll_vel = math::randomsign() * randomfloatrange(-56, -6);
...
// namespace_7a91f98<file_0>::function_f84bd14b
...
function fall_and_bounce(killonimpact_speed, killonimpact_time) {
    ...
    while (bouncedtime < maxbouncetime && lengthsquared(self.velocity) > 10 * 10) {
        impact_vel, normal = self waittill(#"veh_collision");
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_806b99e9
...
function init_guard_points() {
    ...
    self._guard_points[self._guard_points.size] = (-106, -110, 110);
    if (!isdefined(self._guard_points)) {
        self._guard_points = [];
    } else if (!isarray(self._guard_points)) {
        self._guard_points = array(self._guard_points);
    ...
    self._guard_points[self._guard_points.size] = (-76, 0, -116);
}
...
/#
    ...
    // Namespace wasp
    // Params 0, eflags: 0x0
    // namespace_7a91f98<file_0>::function_59361e32
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_8a2bbc69
...
function get_guard_points(owner) {
    ...
    if (points_array.size < 1) {
        queryresult = positionquery_source_navigation(owner.origin + (0, 0, 50), 25, -56, 100, 1.2 * self.radius, self);
...
// namespace_7a91f98<file_0>::function_896b6512
...
function state_guard_can_enter(from_state, to_state, connection) {
    ...
    if (!isdefined(self.enemy) || !self function_6d424c6f(self.enemy, 3)) {
        return true;
    }
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_4001377d
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_309d298c
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_ab509a91
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_b237324d
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_48db4874
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_d8665ae
    ...
    while (true) {
        ...
        if (!onnavvolume) {
            ...
            if (!isdefined(getbackpoint)) {
                queryresult = positionquery_source_navigation(self.origin, 0, 1500, -56, 80, self);
        ...
        if (onnavvolume) {
            ...
            if (owner.main_guard === self) {
                ...
                if (isalive(main_guard) && isdefined(main_guard.current_pathto_pos)) {
                    ...
                    queryresult = positionquery_source_navigation(query_position, 20, -116, 100, 20, self, 15);
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_d4988dfc
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_d4aac9b4
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_4891e8b4
...
function path_update_interrupt() {
    ...
    while (true) {
        ...
        if (isdefined(self.enemy)) {
            if (self.noshoot !== 1 && self function_4246bc05(self.enemy)) {
            ...
            if (self function_4246bc05(self.enemy) && distance2dsquared(self.origin, self.enemy.origin) < -6 * -6) {
                self notify(#"near_goal");
            }
        }
        wait(0.2);
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_69cb35f
...
function wait_till_something_happens(timeout) {
    ...
    while (time > 0) {
        ...
        if (isdefined(self.enemy)) {
            ...
            if (distance2dsquared(self.origin, self.enemy.origin) < -6 * -6) {
                break;
            }
        ...
        if (isdefined(self.leader) && isdefined(self.leader.current_pathto_pos)) {
            if (distancesquared(self.origin, self.leader.current_pathto_pos) > -91 * -91) {
                break;
            }
        }
        wait(0.3);
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_7369fc52
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_dc9eee7a
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_11ececc8
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_c637f0c1
...
function state_combat_update(params) {
    ...
    for (;;) {
        ...
        if (!onnavvolume) {
            ...
            if (!isdefined(getbackpoint)) {
                queryresult = positionquery_source_navigation(self.origin, 0, -56, 100, 2 * self.radius, self);
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_3b254302
// Checksum 0x115be87e, Offset: 0x42c0
// Size: 0x296
function getnextmoveposition_wander() {
    querymultiplier = 1;
    queryresult = positionquery_source_navigation(self.origin, 80, 500 * querymultiplier, -126, 3 * self.radius * querymultiplier, self, self.radius * querymultiplier);
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_93d07f7e
...
function getnextmoveposition_tactical() {
    ...
    if (isalive(self.leader) && isdefined(self.leader.current_pathto_pos)) {
        ...
        queryresult = positionquery_source_navigation(query_position, 0, -116, 100, 35, self, 25);
        ...
        if (isdefined(ownerorigin)) {
            queryresult = positionquery_source_navigation(ownerorigin, 0, 500 * min(querymultiplier, 1.5), -126, 3 * self.radius, self);
        ...
        queryresult = positionquery_source_navigation(self.origin, 0, 500 * min(querymultiplier, 2), -126, 3 * self.radius * querymultiplier, self, 2.2 * self.radius * querymultiplier);
        team_mates = getaiteamarray(self.team);
        avoid_radius = -116;
        foreach (guy in team_mates) {
            if (isdefined(guy.archetype) && guy.archetype == "wasp") {
...
// namespace_7a91f98<file_0>::function_160652f3
...
// namespace_7a91f98<file_0>::function_8e4e433d
...
// Namespace wasp
// Params 1, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_60687790
...
// Namespace wasp
// Params 0, eflags: 0x1 linked
// namespace_7a91f98<file_0>::function_2be24711
