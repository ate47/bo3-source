...
function weapon_fired() {
    ...
    while (true) {
        ...
        for (i = 0; i < players.size; i++) {
            var_9f0ad974 = distancesquared(self.origin, players[i].origin);
            if (var_9f0ad974 < 250000) {
                if (isdefined(self.var_eb24e525) && self.var_eb24e525 != "") {
                    playrumbleonposition(i, self.var_eb24e525, self.origin + (0, 0, 32));
                }
            }
            if (var_9f0ad974 < 160000) {
                fraction = var_9f0ad974 / 160000;
                time = 4 - 3 * fraction;
...
function toggle_fx_bundle(localclientnum, name, turnon) {
    ...
    if (turnon) {
        for (i = 1; ; i++) {
            fx = function_e8ef6cb0(self.settings, name + "_fx_" + i);
            if (!isdefined(fx)) {
                return;
            }
            tag = function_e8ef6cb0(self.settings, name + "_tag_" + i);
            delay = function_e8ef6cb0(self.settings, name + "_delay_" + i);
...
function field_death_spawn_dynents(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
    ...
    if (localclientnum == 0) {
        ...
        for (i = 0; i < numdynents; i++) {
            model = function_e8ef6cb0(settings, "death_dynmodel" + i);
            if (!isdefined(model)) {
                continue;
            }
            gibpart = function_e8ef6cb0(settings, "death_dynent_gib" + i);
            if (self.gibbed === 1 && gibpart === 1) {
                continue;
            }
            pitch = isdefined(function_e8ef6cb0(settings, "death_dynent_force_pitch" + i)) ? function_e8ef6cb0(settings, "death_dynent_force_pitch" + i) : 0;
            yaw = isdefined(function_e8ef6cb0(settings, "death_dynent_force_yaw" + i)) ? function_e8ef6cb0(settings, "death_dynent_force_yaw" + i) : 0;
            ...
            minscale = isdefined(function_e8ef6cb0(settings, "death_dynent_force_minscale" + i)) ? function_e8ef6cb0(settings, "death_dynent_force_minscale" + i) : 0;
            maxscale = isdefined(function_e8ef6cb0(settings, "death_dynent_force_maxscale" + i)) ? function_e8ef6cb0(settings, "death_dynent_force_maxscale" + i) : 0;
            force = direction * randomfloatrange(minscale, maxscale);
            offset = (isdefined(function_e8ef6cb0(settings, "death_dynent_offsetX" + i)) ? function_e8ef6cb0(settings, "death_dynent_offsetX" + i) : 0, isdefined(function_e8ef6cb0(settings, "death_dynent_offsetY" + i)) ? function_e8ef6cb0(settings, "death_dynent_offsetY" + i) : 0, isdefined(function_e8ef6cb0(settings, "death_dynent_offsetZ" + i)) ? function_e8ef6cb0(settings, "death_dynent_offsetZ" + i) : 0);
            switch (newval) {
            case 0:
                break;
            case 1:
                fx = function_e8ef6cb0(settings, "death_dynent_fx" + i);
                break;
            case 2:
                fx = function_e8ef6cb0(settings, "death_dynent_elec_fx" + i);
                break;
            case 3:
                fx = function_e8ef6cb0(settings, "death_dynent_fire_fx" + i);
                break;
            }
...
function field_gib_spawn_dynents(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
    ...
    if (localclientnum == 0) {
        ...
        numdynents = 2;
        for (i = 0; i < numdynents; i++) {
            model = function_e8ef6cb0(settings, "servo_gib_model" + i);
            if (!isdefined(model)) {
                return;
            }
            self.gibbed = 1;
            origin = self.origin;
            angles = self.angles;
            hidetag = function_e8ef6cb0(settings, "servo_gib_tag" + i);
            if (isdefined(hidetag)) {
                origin = self gettagorigin(hidetag);
                angles = self gettagangles(hidetag);
            }
            pitch = isdefined(function_e8ef6cb0(settings, "servo_gib_force_pitch" + i)) ? function_e8ef6cb0(settings, "servo_gib_force_pitch" + i) : 0;
            yaw = isdefined(function_e8ef6cb0(settings, "servo_gib_force_yaw" + i)) ? function_e8ef6cb0(settings, "servo_gib_force_yaw" + i) : 0;
            ...
            minscale = isdefined(function_e8ef6cb0(settings, "servo_gib_force_minscale" + i)) ? function_e8ef6cb0(settings, "servo_gib_force_minscale" + i) : 0;
            maxscale = isdefined(function_e8ef6cb0(settings, "servo_gib_force_maxscale" + i)) ? function_e8ef6cb0(settings, "servo_gib_force_maxscale" + i) : 0;
            force = direction * randomfloatrange(minscale, maxscale);
            offset = (isdefined(function_e8ef6cb0(settings, "servo_gib_offsetX" + i)) ? function_e8ef6cb0(settings, "servo_gib_offsetX" + i) : 0, isdefined(function_e8ef6cb0(settings, "servo_gib_offsetY" + i)) ? function_e8ef6cb0(settings, "servo_gib_offsetY" + i) : 0, isdefined(function_e8ef6cb0(settings, "servo_gib_offsetZ" + i)) ? function_e8ef6cb0(settings, "servo_gib_offsetZ" + i) : 0);
            fx = function_e8ef6cb0(settings, "servo_gib_fx" + i);
