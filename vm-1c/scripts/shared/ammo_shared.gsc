...
function ammo_pouch_think() {
    ...
    for (i = 0; i < offhand_weapons_and_alts.size; i++) {
        ...
        if (weapon == player.grenadetypeprimary && isdefined(player.grenadetypeprimarycount) && player.grenadetypeprimarycount > 0) {
            ...
            var_480e556d = 1;
        } else if (isdefined(level.var_2d59b8c0) && weapon.inventorytype == "hero" && level.var_2d59b8c0) {
            maxammo = weapon.maxammo;
        }
        if (var_480e556d && player function_76f34311("cybercom_copycat") != 2) {
            continue;
        }
        ...
        if (isdefined(level.var_2d59b8c0) && weapon.inventorytype == "hero" && level.var_2d59b8c0) {
