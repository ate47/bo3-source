...
function private __init__() {
    ...
    level.next_map = var_ab91e00d != "" ? var_ab91e00d : world.next_map;
    level.last_map = world.last_map;
    /#
        if (getdvarstring("<dev string:x28>") == "<dev string:x38>") {
            world.var_33c691cb = "<dev string:x3a>";
        }
...
function function_2c93055() {
    ...
    self util::waittill_notify_or_timeout("stats_changed", 2);
    level.var_669268d8++;
    var_4b7ccfd8 = getnumconnectedplayers();
    ...
    while (true) {
        ...
        if (menu == menuname) {
            if (response == "cancel") {
                ...
                var_de6a4e4f = self loadout::getclasschoice(var_bd5d3f48);
...
function function_5b426a60(var_de6a4e4f, var_5a13c491) {
    ...
    self loadout::giveloadout(self.pers["team"], var_de6a4e4f, undefined, var_5a13c491);
}
        ...
        if (var_42bb7bd2 < -1) {
            foreach (player in level.activeplayers) {
                ...
                if (!isdefined(playerclass) || playerclass == "CLASS_CUSTOM10") {
                    var_de6a4e4f = player loadout::getclasschoice("custom0");
                    player function_5b426a60(var_de6a4e4f, player);
                }
...
function function_6eee8df0() {
    ...
    while (true) {
        ...
        if (var_266deb89 == getlobbyclientcount() && !getdvarint("scr_safehouse_test", 0)) {
            level thread function_56c8845e();
            level thread lui::screen_fade_out(0);
            level flag::set("all_players_ready");
            return;
...
function function_c26d52c3() {
    ...
    self util::show_hud(0);
    level.var_ac964c36 = 0;
    self setluimenudata(var_c2dc2b72, "highestMapReached", world.var_33c691cb);
    self setluimenudata(var_c2dc2b72, "showMissionSelect", self ishost());
    self waittill(#"menuresponse", menu, response);
    while (response != "closed") {
