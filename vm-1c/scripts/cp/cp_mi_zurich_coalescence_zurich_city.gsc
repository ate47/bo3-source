...
function function_9940e82f(str_objective, var_74cd64bc) {
    ...
    level zurich_util::function_da579a5d(str_objective, 1);
    level.var_ebb30c1a = [];
...
function function_b8f105c6(a_ents) {
    ...
    var_782205f8 = getvehiclenode("intro_hunter_kill_node", "targetname") zurich_util::function_a569867c(undefined, &function_5568741b);
    ...
    a_ents["zurich_intro_sitrep_guy"] thread function_d8d72142();
    var_edc6e0e1 = getvehiclenode("street_intro_vtol", "targetname") zurich_util::function_a569867c(undefined, &namespace_1beb9396::function_b8380f70);
