...
function function_7403e82b() {
    spawncollision("collision_clip_ramp_256x24", "collider", (-9254.16, 39197.2, -32), (270, 0.6, 23.9983));
    var_6e0c4d3e = spawn("script_model", (-9245.16, 39172.6, -38));
    var_6e0c4d3e setmodel("p7_trashcan_modern");
    var_6e0c4d3e.angles = (270, 0, -74.4002);
    spawncollision("collision_clip_256x256x256", "collider", (-8504, 39076, 479), (0, 30, 0));
    ...
    spawncollision("collision_clip_256x256x256", "collider", (-2341, 4879, 1635), (0, 10.8, 0));
    spawncollision("collision_clip_256x256x256", "collider", (-2400, 5102, 1635), (0, 18.2, 0));
    ...
    spawncollision("collision_clip_512x512x512", "collider", (1608, 3672, 2068), (0, 345, 0));
    spawncollision("collision_clip_256x256x256", "collider", (1702, 3304, 1940), (0, 30, 0));
    spawncollision("collision_clip_ramp_256x24", "collider", (10038.7, -21701.7, 1114.84), (355.809, 139.748, 4.21038));
    spawncollision("collision_clip_wall_256x256x10", "collider", (-30219, 2184, 1208), (0, 4.1998, 0));
    ...
    spawncollision("collision_clip_512x512x512", "collider", (-10122, 39836, 863), (0, 30.8, 0));
    spawncollision("collision_clip_512x512x512", "collider", (-10561, 39575, 863), (0, 30.8, 0));
    spawncollision("collision_clip_wall_512x512x10", "collider", (-6091, 37379, 401), (0, 299.399, 0));
    spawncollision("collision_clip_wall_512x512x10", "collider", (-5922, 37091, 401), (0, 299.399, 0));
    spawncollision("collision_clip_wall_512x512x10", "collider", (-9153, 35614, 401), (0, 299.399, 0));
    spawncollision("collision_clip_wall_512x512x10", "collider", (-8984, 35326, 401), (0, 299.399, 0));
}
