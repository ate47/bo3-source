...
function setupdevgui() {
    /#
        ...
        var_fcdf780c = "script_noteworthy";
        index = 1;
        var_9ba2319f = index;
        ...
        foreach (arena in level.doa.arenas) {
            ...
            name = arena.name + "script_noteworthy" + var_9ba2319f + "script_noteworthy" + var_9c0bafd1 + "script_noteworthy" + index;
            index++;
            cmd = var_fcdf780c + name + "script_noteworthy" + arena.name + "script_noteworthy";
            adddebugcommand(cmd);
        ...
        if (isdefined(world.var_e5cf1b41)) {
            ...
            namespace_49107f3a::debugmsg("script_noteworthy" + world.var_e5cf1b41 + "script_noteworthy" + level.doa.var_33749c8);
            flag::clear("script_noteworthy");
            setdvar("script_noteworthy", "script_noteworthy");
            wait(1);
            namespace_49107f3a::function_f798b582();
            world.var_e5cf1b41 = undefined;
            namespace_49107f3a::debugmsg("script_noteworthy");
            foreach (player in namespace_831a4a7c::function_5eb6e4d1()) {
...
function function_c18f4e35() {
    ...
    while (true) {
        ...
        case 71:
            ...
            namespace_49107f3a::debugmsg("camera debug FIX ARENA CAM LOC [" + (level.var_cee29ae7 == 1 ? "ON" : "OFF") + "]");
        ...
        case 72:
            ...
            namespace_49107f3a::debugmsg("camera FIX CAM[" + (level.var_bbb7743c ? "ON" : "OFF") + "]");
