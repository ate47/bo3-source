...
// namespace_3a8ca1c2<file_0>::function_d290ebfa
...
function main() {
    ...
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (611.5, -2501, -39), 0, 400, -128);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (-138.5, -2159, -48), 0, 400, -128);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (1745, -2474.5, -48), 0, 400, 110);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (2033.5, -2247.5, -48), 0, 400, 110);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (2197, -2001, -48), 0, 400, 110);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (2208, -1869.5, -11), 0, 300, -106);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (2682.5, -1695, -69), 0, 400, -56);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (2720, -1140.5, -113), 0, -6, 300);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (2943.5, -1190, -113), 0, 300, 300);
    trigger thread oob::run_oob_trigger();
    trigger = spawn("trigger_radius_out_of_bounds", (3167, -1152.5, -113), 0, 300, 300);
    trigger thread oob::run_oob_trigger();
...
// Namespace namespace_3a8ca1c2
// Params 0, eflags: 0x1 linked
// namespace_3a8ca1c2<file_0>::function_f7046c76
