...
function main() {
    ...
    var_7c6ce185 = spawn("script_model", (-1359.51, 122.529, 94.9997));
    var_7c6ce185 setmodel("p7_crate_plastic_tech_01");
    var_7c6ce185.angles = (0, 101, 0);
    model2 = spawn("script_model", (-1363.91, 121.69, 69.2893));
    model2 setmodel("p7_crate_plastic_tech_01");
    model2.angles = (0, 101, 0);
    var_c871d657 = spawn("script_model", (-1363.48, 118.246, 44.9548));
    var_c871d657 setmodel("p7_crate_plastic_tech_01");
    var_c871d657.angles = (0, 270, 0);
