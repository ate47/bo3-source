...
function function_684ce0() {
    ...
    while (true) {
        ...
        if (level.round_number == level.var_51a5abd0) {
            ...
            /#
                getplayers()[0] iprintln("<unknown string>" + level.var_51a5abd0);
            #/
            continue;
        }
...
/#
    ...
    function function_3626e3d1(cmd) {
        ...
        default:
            ...
            break;
        case 0:
            function_e115a394(getdvarint("<unknown string>"));
            break;
        case 0:
            function_70864ef2(getdvarint("<unknown string>"));
            break;
        }
    }
    ...
    function function_d8afb0d4(var_eee0e63b) {
        if (isdefined(var_eee0e63b) && var_eee0e63b > 0) {
            setdvar("<unknown string>", var_eee0e63b);
            return;
        }
