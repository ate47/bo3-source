...
function function_33aa4940()
{
    ...
    if ( var_c0692329 )
    {
        ...
        else if ( zm_ai_sentinel_drone::function_74ab7484() && level.var_bd1e3d02 < level.var_b23e9e3a && zm_ai_sentinel_drone::function_19d0b055( 1 ) == 1 )
        {
            level.var_bd1e3d02++;
            level.zombie_total--;
            return true;
    ...
    while ( level.round_number < 20 )
    {
        if ( level.zombie_total <= 0 )
        {
            ...
            if ( var_565450eb == 1 )
            {
                ...
                if ( var_be13851f >= 25 )
                {
                    if ( isdefined( a_zombies[ 0 ].razhasgunattached ) && a_zombies[ 0 ].archetype === "raz" && a_zombies[ 0 ].razhasgunattached )
                    {
...
function function_a9536aec()
{
    ...
    while ( zm_utility::is_player_valid( self ) && zm_stalingrad_util::function_86b1188c( 750, level.mdl_sophia, self ) )
    {
        if ( b_first_loop )
        {
            b_first_loop = 0;
