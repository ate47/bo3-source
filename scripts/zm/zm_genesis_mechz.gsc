...
function function_a0b6d6b9(mechz) {
    ...
    if (isdefined(mechz) && isalive(mechz) && isdefined(mechz.var_ab0efcf6)) {
        ...
        /#
            recordline(mechz.origin, var_c430eda8, (0, 255, 0), "zmb_talon_electrocute", mechz);
        #/
...
/#
    ...
    function function_78e44cda() {
        ...
        wait(0.05);
        setdvar("move allowed", 0);
        adddebugcommand("<unknown string>");
        while (true) {
            if (getdvarint("move allowed")) {
                setdvar("move allowed", 0);
    ...
    function function_eac1444a() {
        var_10b176f0 = getaiarchetypearray("<unknown string>");
        foreach (var_99c3dd59 in var_10b176f0) {
            var_efe3c52f = level.activeplayers[0] gettagorigin("<unknown string>") + (0, 0, 20);
            var_7ddc55f4 = level.activeplayers[0] gettagorigin("<unknown string>") + (5, 0, 20);
            var_a3ded05d = level.activeplayers[0] gettagorigin("<unknown string>") + (-5, 0, 20);
            var_31d76122 = level.activeplayers[0] gettagorigin("<unknown string>") + (0, 0, 15);
