...
function function_801ffa37() {
    ...
    /#
        println("temporary_power_switch");
    #/
...
/#
    ...
    function function_21e3b61f() {
        level clientfield::set("pickup", 1);
        wait(3);
        level clientfield::set("pickup", 2);
        wait(3);
        level clientfield::set("pickup", 3);
    ...
    while (true) {
        ...
        while (true) {
            ...
            if (self.script_int === 1) {
                ...
                /#
                    println("<unknown string>" + e_who.var_c6cad973);
                #/
            } else {
    ...
    while (true) {
        ...
        /#
            if (isdefined(e_who.playernum)) {
                println("<unknown string>" + e_who.playernum + "<unknown string>");
            }
        #/
    }
}
    ...
    while (true) {
        ...
        if (e_player usebuttonpressed()) {
            ...
            if (isdefined(e_player.var_57db2550) && e_player.var_7621b9dd - e_player.var_57db2550 > -6) {
                ...
                /#
                    println("<unknown string>" + e_player.playernum + "<unknown string>");
                #/
            }
        }
    }
...
/#
    ...
    function function_d8d81d72(cmd) {
        ...
        case 0:
            foreach (player in level.players) {
                if (player clientfield::get_to_player("<unknown string>")) {
                    continue;
                }
                player clientfield::set_to_player("<unknown string>", 1);
    ...
    function function_1b3134ae() {
        var_5646068 = struct::get_array("<unknown string>", "<unknown string>");
