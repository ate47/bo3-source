...
/#
    ...
    function function_9b87ec91() {
        setdvar("zm_zod_sword_egg_apothicon_s1", 0);
        setdvar("keeper_spirit_", "zmb_zod_egg_place");
        setdvar("magic_circle_", "zmb_zod_egg_place");
        setdvar("wpn_t7_zmb_zod_sword2_fem_world", 0);
        adddebugcommand("p7_fxanim_zm_zod_statue_apothicon_start_anim");
        adddebugcommand("<unknown string>");
        adddebugcommand("<unknown string>");
        adddebugcommand("<unknown string>");
        adddebugcommand("<unknown string>");
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 0, &function_b3babd8c);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_b3babd8c);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 2, &function_b3babd8c);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 4, &function_b3babd8c);
        var_da3dac0c = 0;
        var_47719d0d = 0;
        var_511a9112 = getent("<unknown string>", "<unknown string>");
        while (true) {
            n_level = getdvarint("zm_zod_sword_egg_apothicon_s1");
            if (n_level == 1) {
                foreach (e_player in level.activeplayers) {
                    ...
                    setdvar("zm_zod_sword_egg_apothicon_s1", "<unknown string>");
                }
            } else if (n_level == 2) {
                foreach (e_player in level.activeplayers) {
                    e_player.var_c8364c36 = 0;
            ...
            var_dc464dee = getdvarstring("keeper_spirit_");
            switch (var_dc464dee) {
            case 0:
                foreach (e_player in level.players) {
            ...
            var_dc464dee = getdvarstring("magic_circle_");
            switch (var_dc464dee) {
            case 0:
                foreach (e_player in level.players) {
            ...
            setdvar("magic_circle_", "zmb_zod_egg_place");
            var_e4b329eb = getdvarint("wpn_t7_zmb_zod_sword2_fem_world");
            if (var_e4b329eb > 0) {
                foreach (e_player in level.players) {
                    namespace_2318f091::function_7855de72(e_player);
                }
            }
            setdvar("wpn_t7_zmb_zod_sword2_fem_world", "<unknown string>");
    ...
    function function_b3babd8c(var_5df86706) {
        foreach (player in level.players) {
            for (i = 0; i < 4; i++) {
                player clientfield::set_to_player("<unknown string>" + i, var_5df86706);
            }
        }
    }
