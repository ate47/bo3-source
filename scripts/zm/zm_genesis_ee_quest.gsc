...
function function_be26578d( var_f5e9fb6c )
{
    ...
    s_start_rock = array::random( var_3a557c26 );
    v_offset = ( 0, 0, 20 );
    mdl_rock = util::spawn_model( "p7_zm_gen_horror_shards_kit_03_h", s_start_rock.origin - v_offset, s_start_rock.angles );
    util::wait_network_frame();
    mdl_rock moveto( s_start_rock.origin, 15 );
    ...
    var_bbd61432 = struct::get( s_start_rock.target, "targetname" );
    var_bbd61432 thread function_bde2ec4( var_f5e9fb6c );
    mdl_rock delete();
    level flag::wait_till( "placed_audio" + var_f5e9fb6c );
    
    foreach ( s_start_rock in var_3a557c26 )
    {
        s_start_rock struct::delete();
    }
}
...
function function_66b6f0e2( n_wave )
{
    ...
    for ( i = 0; i < 3 ; i++ )
    {
        ...
        s_spawn thread zm_genesis_apothican::spawn_apothican_margwa( str_type, 1 );
        wait 1;
    }
}
...
function idgun_upgrade()
{
    ...
    level.zombie_weapons[ level.w_idgun ].upgrade = level.w_idgun_upgraded;
    level.zombie_weapons_upgraded[ level.w_idgun_upgraded ] = level.w_idgun;
    level.aat_exemptions[ level.w_idgun_upgraded ] = 1;
    level.limited_weapon[ level.w_idgun_upgraded ] = 0;
}
...
{
    mdl_shard = getent( self.target, "targetname" );
    mdl_shard setcandamage( 1 );
    v_position = function_4e44f01( mdl_shard.origin, 0 );
    wait 1;
    mdl_shard moveto( v_position, 3 );
    wait 3;
    level.var_6aedbc8b++;
    ...
    mdl_shard setscale( 0.3 );
    mdl_shard ghost();
    level flag::wait_till( "apotho_pack_freed" );
    s_destination = struct::get( mdl_shard.target, "targetname" );
    mdl_shard.origin = s_destination.origin;
    mdl_shard.angles = s_destination.angles;
    mdl_shard show();
}
...
function function_4e44f01( v_target, var_7e879af8 )
{
    ...
    while ( true )
    {
        ...
        if ( var_7e879af8 && w_weapon != level.w_idgun_upgraded )
        {
            continue;
        }
...
function function_1e3b5e00()
{
    ...
    s_sophia = struct::get( "ee_beam_sophia", "targetname" );
    playfx( level._effect[ "lightning_dog_spawn" ], s_sophia.origin );
    level.mdl_sophia = util::spawn_model( "tag_origin", s_sophia.origin, s_sophia.angles );
    level.mdl_sophia.targetname = "sophia_eye";
    level.mdl_sophia playsound( "zmb_main_sophia_ghost_materialize" );
    level.mdl_sophia playloopsound( "zmb_main_sophia_ghost_lp", 3 );
    level thread function_cde49635();
    s_sophia thread function_16d54ad3();
    level flag::wait_till( "sophia_beam_locked" );
    level clientfield::set( "ee_quest_state", 5 );
    s_sophia thread ee_sophia_activate();
    level flag::wait_till( "sophia_activated" );
    level.mdl_sophia thread function_9449053f();
    level flag::wait_till( "sophia_at_teleporter" );
    level clientfield::set( "ee_quest_state", 6 );
    level.mdl_sophia thread function_7389c635();
    level.mdl_sophia thread function_a3bddb7c();
}
...
function function_ccaca679()
{
    ...
    mdl_sophia = util::spawn_model( "p7_zm_gen_dark_arena_sphere", nd_start.origin, nd_start.angles );
    mdl_sophia linkto( var_2309b03e );
...
{
    /#
        if ( level flag::get( "<dev string:x41>" ) )
        {
            return;
        }
    #/
    
    level.mdl_sophia thread function_7eefe596( "sophia_activated" );
}
...
{
    /#
        if ( level flag::get( "<dev string:x52>" ) )
        {
            return;
        }
    #/
...
function function_7389c635()
{
    ...
    level.mdl_sophia.origin = var_57cd6434.origin;
    level.mdl_sophia.angles = var_57cd6434.angles;
    level function_e483fde2( 1 );
    level.mdl_sophia thread function_7eefe596( "boss_fight" );
}
...
{
    /#
        if ( level flag::get( "<dev string:x67>" ) )
        {
            return;
        }
    #/
    ...
    level.mdl_sophia clientfield::set( "electric_charge", 1 );
    level.mdl_sophia playsound( "zmb_main_sophia_connect_teleporter" );
    wait 1;
    level.mdl_sophia playsound( "zmb_main_sophia_energize_teleporter" );
    level flag::set( "teleporter_on" );
    level thread zm_genesis_vo::function_ab35cb95();
    level flag::wait_till_clear( "teleporter_on" );
    level.mdl_sophia clientfield::set( "electric_charge", 0 );
    level.mdl_sophia playsound( "zmb_main_sophia_deenergize_teleporter" );
...
function function_e483fde2( b_solid )
{
    ...
    var_4e0cc636 = 0;
    level.mdl_sophia playsound( "zmb_main_sophia_activate" );
    
    while ( var_4e0cc636 < 6 )
    {
        level.mdl_sophia setmodel( "p7_zm_gen_dark_arena_sphere" );
        wait 0.15;
        level.mdl_sophia setmodel( "p7_zm_gen_dark_arena_sphere_metal" );
        level.mdl_sophia clientfield::set( "sophia_eye_on", 1 );
        wait 0.15;
        var_4e0cc636++;
    }
    
    level.mdl_sophia playsound( "zmb_main_sophia_materialize" );
    
    if ( isdefined( b_solid ) && b_solid )
    {
        level.mdl_sophia setmodel( "p7_zm_gen_dark_arena_sphere_metal" );
        level.mdl_sophia clientfield::set( "sophia_eye_on", 1 );
        level.mdl_sophia playloopsound( "zmb_main_sophia_materialized_lp", 2 );
        return;
    }
    
    level.mdl_sophia setmodel( "p7_zm_gen_dark_arena_sphere" );
    level.mdl_sophia playloopsound( "zmb_main_sophia_ghost_lp", 2 );
}
...
function function_cde49635()
{
    ...
    while ( true )
    {
        e_player = arraygetclosest( level.mdl_sophia.origin, level.activeplayers );
...
function function_a9536aec()
{
    ...
    while ( zm_utility::is_player_valid( self ) && function_86b1188c( 750, level.mdl_sophia, self ) )
    {
        if ( b_first_loop )
        {
            b_first_loop = 0;
...
{
    /#
        if ( level flag::get( "<dev string:x76>" ) )
        {
            return;
        }
    #/
...
{
    /#
        if ( level flag::get( "<dev string:x82>" ) )
        {
            return;
        }
    #/
...
{
    s_rune_pos = struct::get( "ee_book_runes_in_summoning_circle", "targetname" );
    mdl_rune = util::spawn_model( "tag_origin", s_rune_pos.origin, s_rune_pos.angles );
    s_unitrigger = s_rune_pos zm_unitrigger::create_unitrigger( "", 100 );
    s_rune_pos ee_book_runes_in_summoning_circle( mdl_rune );
    zm_unitrigger::unregister_unitrigger( s_unitrigger );
    mdl_rune delete();
}
...
// Size: 0x218
function ee_book_runes_in_summoning_circle( mdl_rune )
{
    level endon( #"book_runes_failed" );
    level endon( #"book_runes_success" );
    ...
    while ( true )
    {
        ...
        {
            mdl_rune setmodel( "p7_zm_gen_rune_" + level.var_63fa69fd + 1 + "_purple" );
            mdl_rune playsound( "zmb_main_bookish_rune_show" );
            mdl_rune playloopsound( "zmb_main_bookish_rune_lp", 1 );
            function_fde3e99f( 3.6 );
            level.var_63fa69fd = undefined;
            mdl_rune setmodel( "tag_origin" );
            mdl_rune stoploopsound( 0.5 );
            mdl_rune playsound( "zmb_main_bookish_rune_disappear" );
        }
...
{
    /#
        if ( level flag::get( "<dev string:x95>" ) )
        {
            return;
        }
    #/
...
{
    /#
        if ( level flag::get( "<dev string:xa0>" ) )
        {
            return;
        }
    #/
...
function function_27b96bc()
{
    ...
    while ( level.var_6e907685.size )
    {
        ...
        else if ( isdefined( var_cb6acc3e ) && v_ball_pos != var_cb6acc3e && distancesquared( v_ball_pos, var_cb6acc3e ) < 40000 )
        {
            foreach ( s_toy in level.var_6e907685 )
            {
                var_32769d76 = pointonsegmentnearesttopoint( v_ball_pos, var_cb6acc3e, s_toy.origin );
                var_7dac19aa = var_32769d76 - s_toy.origin;
                n_length = length( var_7dac19aa );
                assert( isdefined( s_toy.radius ), "<dev string:xaf>" );
                ...
                if ( n_length < s_toy.radius )
                {
                    ...
                    switch ( s_toy.script_string )
                    {
                        case "up":
                            ...
                            break;
                        case "forward":
                            v_move_dir = vectornormalize( e_ball.lastcarrier.origin - s_toy.origin ) * 160;
                            break;
                        default:
                            assert( "<dev string:xcc>" );
                            break;
                    }
                    
                    var_29c135aa thread function_e2a94206( v_move_dir );
                    ...
                    wait 4.8;
                    var_39018584 delete();
                    level thread zm_genesis_vo::function_e644549c( e_ball.lastcarrier );
                    ...
                    if ( level.var_6e907685.size )
                    {
                        ...
                        {
                            e_ball ball::reset_ball( 1, e_ball.lastcarrier.origin, 1 );
                        }
                        else
                        {
                            var_b99670e6 = distance2d( e_ball.lastcarrier.origin, s_toy.origin );
                            var_43b88dc1 = var_b99670e6 * 0.3;
                            n_z_diff = abs( e_ball.lastcarrier.origin[ 2 ] - s_toy.origin[ 2 ] );
                            var_43b88dc1 += n_z_diff * 0.5;
                            var_43b88dc1 += 150;
                            v_force = e_ball.lastcarrier.origin + ( 0, 0, var_43b88dc1 ) - v_ball_pos;
                            e_ball thread ball::function_fed77788( v_ball_pos, v_force );
                        }
...
// Size: 0x134
function function_e2a94206( v_move_dir )
{
    self clientfield::set( "grand_tour_found_toy_fx", 1 );
    self moveto( self.origin + v_move_dir, 5 );
...
function function_48e1990b()
{
    ...
    for ( str_zone = var_6c9f55e zm_zonemgr::get_player_zone(); isdefined( var_6c9f55e.teleporting ) && ( isdefined( var_6c9f55e.is_flung ) && ( var_d6ba68c5 zm_genesis_util::function_37a5b776() || !( isdefined( zm_utility::is_player_valid( var_6c9f55e ) ) && zm_utility::is_player_valid( var_6c9f55e ) ) || var_6c9f55e.is_flung ) || var_6c9f55e.teleporting ) || !isdefined( str_zone ) ; str_zone = var_6c9f55e zm_zonemgr::get_player_zone() )
    {
        wait 2;
...
{
    /#
        if ( level flag::get( "<dev string:xff>" ) )
        {
            return;
        }
    #/
...
function ee_ending()
{
    ...
    a_s_sam_pos = struct::get_array( "sams_room_pos", "script_noteworthy" );
    
    foreach ( e_player in level.players )
    {
        e_player zm_utility::create_streamer_hint( a_s_sam_pos[ 0 ].origin, a_s_sam_pos[ 0 ].angles, 1 );
    }
    
    wait level.n_teleport_delay;
    self notify( #"fx_done" );
    zm_genesis_util::function_342295d8( "samanthas_room_zone" );
    level.t_teleporter zm_genesis_teleporter::teleport_players( a_s_sam_pos, 1, 1, 1 );
...
function function_941e28ac( var_3a814173, n_rotate_time )
{
    ...
    while ( true )
    {
        var_3a814173 rotateto( var_3a814173.angles + ( 0, 180, 0 ), n_rotate_time );
...
// Size: 0xe2
function function_64e4c3ee( b_lock )
{
    if ( !isdefined( b_lock ) )
    {
        b_lock = 1;
...
/#
    ...
    // Size: 0x3dc, Type: dev
    function devgui_ee_quest()
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x10a>", "<dev string:x13e>", 1, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x147>", "<dev string:x13e>", 2, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x17e>", "<dev string:x13e>", 3, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x1b1>", "<dev string:x1e5>", 1, &function_b3e7fd04 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x1f3>", "<dev string:x1e5>", 2, &function_b3e7fd04 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x227>", "<dev string:x1e5>", 3, &function_b3e7fd04 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x25b>", "<dev string:x28e>", 1, &function_2e1bc559 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x299>", "<dev string:x13e>", 4, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2c0>", "<dev string:x13e>", 5, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2e6>", "<dev string:x13e>", 6, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x313>", "<dev string:x13e>", 7, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x33b>", "<dev string:x13e>", 8, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x35d>", "<dev string:x13e>", 9, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x380>", "<dev string:x13e>", 10, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3a7>", "<dev string:x13e>", 11, &margwa_apha_id );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3ca>", "<dev string:x13e>", 12, &margwa_apha_id );
        level flag::init( "<dev string:x3e9>" );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3f8>", "<dev string:x3e9>", 0, &function_ec27cd4b );
    }
    ...
    // Size: 0x506, Type: dev
    function margwa_apha_id( n_val )
    {
        if ( n_val >= 1 )
        {
            level thread zm_devgui::zombie_devgui_open_sesame();
            level flag::set( "<dev string:x412>" );
            ...
            level flag::set( "<dev string:x428>" );
        }
        
        if ( n_val >= 2 )
        {
            level flag::set( "<dev string:x43c>" );
            level flag::set( "<dev string:x447>" );
            level flag::set( "<dev string:x455>" );
        ...
        if ( n_val >= 3 )
        {
            level flag::set( "<dev string:x47b>" );
            level flag::set( "<dev string:x486>" );
        }
        
        if ( n_val >= 4 )
        {
            level flag::set( "<dev string:x494>" );
            level flag::set( "<dev string:x49f>" );
            level flag::set( "<dev string:x4ad>" );
        }
        
        if ( n_val >= 5 )
        {
            level flag::set( "<dev string:x4c1>" );
        }
        
        if ( n_val >= 6 )
        {
            level flag::set( "<dev string:x41>" );
            level flag::set( "<dev string:x52>" );
            level flag::set( "<dev string:x4d4>" );
        }
        
        if ( n_val >= 7 )
        {
            level flag::set( "<dev string:x67>" );
            level flag::set( "<dev string:x76>" );
            level flag::set( "<dev string:x4e2>" );
        }
        ...
        if ( n_val >= 8 )
        {
            ...
            level flag::set( "<dev string:x4f1>" );
        }
        
        if ( n_val >= 9 )
        {
            level.var_62552381 = 1;
            level flag::set( "<dev string:x95>" );
        }
        
        if ( n_val >= 10 )
        {
            level flag::set( "<dev string:xa0>" );
        }
        
        if ( n_val >= 11 )
        {
            level flag::set( "<dev string:xff>" );
        }
        
        if ( n_val >= 12 )
        {
            level flag::set( "<dev string:x4fb>" );
        }
    ...
    {
        level flag::set( "<dev string:x507>" + n_val );
    }
    ...
    {
        var_2efcd138 = getentarray( "<dev string:x511>", "<dev string:x51a>" );
