...
function init_craftables()
{
    ...
    zm_craftables::make_zombie_craftable_open( "idgun", "", ( 0, -90, 0 ), ( 0, 0, 0 ) );
    zm_craftables::add_zombie_craftable( "second_idgun", &"ZM_ZOD_CRAFT_IDGUN", "", &"ZM_ZOD_PICKUP_IDGUN", &function_d80876ac, 1 );
    zm_craftables::make_zombie_craftable_open( "second_idgun", "", ( 0, -90, 0 ), ( 0, 0, 0 ) );
...
function ondisconnect_common( player )
{
    ...
    if ( is_piece_a_relic( self.piecename ) && !level flag::get( "ritual_pap_complete" ) )
    {
