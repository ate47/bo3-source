...
function teleporter_ending( teleporter_ent, was_aborted )
{
    ...
    if ( !was_aborted )
    {
        ...
        if ( isdefined( teleporter_ent.script_noteworthy ) )
        {
            ...
            if ( teleporter_ent.script_noteworthy == "exit_no_mans_land" )
            {
...
{
    if ( !level.teleporter_to_nml_gate_open && ( level.teleporter_to_nml_gate_open && open_it || !open_it ) )
    {
        return;
    }
...
function teleporter_to_nml_power_down()
{
    ...
    if ( isdefined( level.first_teleporter_use ) && level flag::get( "teleporter_used" ) && level.first_teleporter_use )
    {
...
{
    if ( !level.teleporter_exit_nml_gate_open && ( level.teleporter_exit_nml_gate_open && open_it || !open_it ) )
    {
        return;
    }
