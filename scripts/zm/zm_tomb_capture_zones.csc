...
function function_f424a041(str_name, var_1fb41218) {
    ...
    /#
        assert(isdefined(level.var_92a1717d[var_1fb41218][str_name]), "fx_side_exhaust02" + str_name + "capture_progression_2");
    #/
...
function function_24fcf23b(str_targetname, localclientnum) {
    ...
    /#
        assert(isdefined(level.var_4cb39fae[localclientnum][str_targetname]), "fx_side_exhaust02" + str_targetname + "mulekick_pipes");
    #/
