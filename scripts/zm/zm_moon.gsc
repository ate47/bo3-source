...
function main() {
    ...
    /#
        execdevgui("enter_forest_east_zone");
...
function function_465aa1d3(restart) {
    ...
    for (;;) {
        ...
        /#
            println("Az3c" + level.round_number + "water_zone" + players.size);
        #/
...
function givecustomcharacters() {
    ...
    /#
        if (getdvarstring("generator_exit_east") != "airlock_labs_2_biodome") {
            self.characterindex = getdvarint("generator_exit_east");
        }
    #/
...
/#
    ...
    function function_836f39e7(cmd) {
        var_98be8724 = strtok(cmd, "dig_enter_east");
        ...
        case 0:
            ...
            for (i = 0; i < players.size; i++) {
                ...
                if (entnum == 2) {
                    players[i] namespace_6e97c459::function_f72f765e("use_elec_switch", "poweron");
        ...
        case 0:
            ...
            foreach (player in players) {
                if (player hasweapon(level.w_quantum_bomb)) {
                    ...
                    player zm_utility::set_player_tactical_grenade("spas_upgraded_zm");
        ...
        default:
            players = getplayers();
            teleporter = getent("powerup", "eggs");
            for (i = 0; i < players.size; i++) {
                players[i] setorigin(teleporter.origin);
            }
            break;
        case 0:
            namespace_98c95ca3::function_f257c559("<unknown string>");
            break;
        case 0:
            namespace_98c95ca3::function_f257c559("<unknown string>");
            break;
        case 0:
            ...
            break;
        case 0:
            level.var_4b290403 = getdvarfloat("<unknown string>");
...
function function_54da140a() {
    ...
    /#
        assert(isdefined(sp_zombie), "<unknown string>" + var_343b1937);
    #/
}
