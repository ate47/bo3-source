...
function function_38e7d20(msg) {
    /#
        if (!getdvarint("specialty_weapupgrade")) {
            return;
        }
        iprintlnbold(msg);
    #/
...
function function_edfec8be(position) {
    function_439bf2cd();
    /#
        var_ef89a210 = getdvarstring("<unknown string>");
        if (var_ef89a210 != "<unknown string>" && isdefined(level.var_f8aafd4c[var_ef89a210])) {
...
function function_5e612cf3(position) {
    self thread zm_audio::create_and_play_dialog("kill", "quant_good");
    /#
        var_6180515d = getdvarint("<unknown string>");
        if (var_6180515d) {
            rand = var_6180515d;
        }
    #/
