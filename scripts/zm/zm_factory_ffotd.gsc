...
function main_end()
{
    ...
    spawncollision( "collision_player_wall_512x512x10", "collider", ( -371, 640, 237 ), ( 0, 270, 0 ) );
    ...
    spawncollision( "collision_player_wall_512x512x10", "collider", ( -390, 648, 240 ), ( 0, 270, 0 ) );
