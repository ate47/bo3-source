...
// Size: 0xf4
function shadowman_say( vo_lines, n_wait, b_wait_if_busy, n_priority, var_43802352 )
{
    if ( !isdefined( n_wait ) )
    {
        n_wait = 0;
...
function function_4974f895( vo_lines, n_wait, b_wait_if_busy, n_priority )
{
    ...
    {
        level.mdl_sophia [[ var_31290267 ]]( vo_lines, n_wait, b_wait_if_busy, n_priority );
    }
    else
    {
...
function function_2426269b( v_pos, n_range )
{
    ...
    if ( isdefined( level.a_e_speakers ) )
    {
        ...
        for ( i = 0; isdefined( level.a_e_speakers ) && i < level.a_e_speakers.size ; i++ )
        {
    ...
    if ( var_2ea24b84 != "" )
    {
        switch ( var_2ea24b84 )
        {
            case "abcd":
                ...
                break;
            case "shad":
                shadowman_say( str_vo_alias, n_wait, b_wait_if_busy, n_priority );
                break;
            default:
...
/#
    ...
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x226>", "<dev string:x247>", 1, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x255>", "<dev string:x276>", 1, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x281>", "<dev string:x2a2>", 2, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2ad>", "<dev string:x2ce>", 3, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2d9>", "<dev string:x2fa>", 4, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x305>", "<dev string:x326>", 5, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x331>", "<dev string:x352>", 6, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x35d>", "<dev string:x37e>", 7, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x389>", "<dev string:x3aa>", 8, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3b5>", "<dev string:x3d6>", 9, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3e1>", "<dev string:x402>", 10, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x40d>", "<dev string:x42e>", 11, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x439>", "<dev string:x45a>", 12, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x465>", "<dev string:x486>", 13, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x491>", "<dev string:x4b2>", 14, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4bd>", "<dev string:x4de>", 15, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4e9>", "<dev string:x50a>", 16, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x515>", "<dev string:x536>", 17, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x541>", "<dev string:x562>", 18, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x56d>", "<dev string:x58e>", 19, &function_209da490 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x599>", "<dev string:x5b9>", 0, &function_9104f6c3 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x5cc>", "<dev string:x5b9>", 1, &function_9104f6c3 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x5ec>", "<dev string:x5b9>", 2, &function_9104f6c3 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x60c>", "<dev string:x5b9>", 3, &function_9104f6c3 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x62c>", "<dev string:x646>", 0, &function_b28d80bd );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x655>", "<dev string:x646>", 1, &function_b28d80bd );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x66f>", "<dev string:x646>", 2, &function_b28d80bd );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x689>", "<dev string:x646>", 3, &function_b28d80bd );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x6a3>", "<dev string:x6c6>", 0, &function_cb9eba2 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x6cd>", "<dev string:x6c6>", 0, &function_f030bece );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x6f0>", "<dev string:x6c6>", 0, &function_a012e4e0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x711>", "<dev string:x6c6>", 1, &function_cb9eba2 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x734>", "<dev string:x6c6>", 1, &function_f030bece );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x757>", "<dev string:x6c6>", 1, &function_a012e4e0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x778>", "<dev string:x6c6>", 2, &function_cb9eba2 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x79b>", "<dev string:x6c6>", 2, &function_f030bece );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x7be>", "<dev string:x6c6>", 2, &function_a012e4e0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x7df>", "<dev string:x6c6>", 3, &function_cb9eba2 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x802>", "<dev string:x6c6>", 3, &function_f030bece );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x825>", "<dev string:x6c6>", 3, &function_a012e4e0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x846>", "<dev string:x85e>", 0, &function_b780637 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x86a>", "<dev string:x85e>", 1, &function_b780637 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x883>", "<dev string:x85e>", 2, &function_b780637 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x89d>", "<dev string:x85e>", 3, &function_b780637 );
    }
    ...
    function function_b28d80bd( var_9485d9b7 )
    {
        ...
        {
            e_character vo_say( "<dev string:x8c2>", 0, 0, 1000, 1, 1 );
        }
    }
