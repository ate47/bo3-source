...
function function_4b02c768() {
    ...
    /#
        e_origin thread namespace_8aed53c9::function_8faf1d24((0, 0, 255), "<unknown string>");
    #/
...
function function_4824fe93(origin, num) {
    ...
    /#
        s_origin thread namespace_8aed53c9::function_8faf1d24((0, 0, 255), "<unknown string>");
    #/
