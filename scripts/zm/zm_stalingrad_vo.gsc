...
function function_f3477ddd( str_vo_alias, n_wait, b_wait_if_busy, n_priority )
{
    ...
    b_result = level.mdl_sophia vo_say( str_vo_alias, n_wait, b_wait_if_busy, n_priority );
...
function function_267933e4()
{
    ...
    level.var_b7e67f82[ 0 ] += var_85fdde46.size;
    level.var_b7e67f82[ 1 ] += var_85fdde46.size;
    var_559f698d = [];
    ...
    level.var_b7e67f82[ 0 ] += var_559f698d.size;
    level.var_b7e67f82[ 2 ] += var_559f698d.size;
    var_b16db601 = [];
    ...
    level.var_b7e67f82[ 0 ] += var_b16db601.size;
    level.var_b7e67f82[ 3 ] += var_b16db601.size;
    var_4d918dae = [];
    ...
    level.var_b7e67f82[ 1 ] += var_4d918dae.size;
    level.var_b7e67f82[ 2 ] += var_4d918dae.size;
    var_ec060c98 = [];
    ...
    level.var_b7e67f82[ 1 ] += var_ec060c98.size;
    level.var_b7e67f82[ 3 ] += var_ec060c98.size;
    var_4303fff9 = [];
    ...
    level.var_b7e67f82[ 2 ] += var_4303fff9.size;
    level.var_b7e67f82[ 3 ] += var_4303fff9.size;
    var_312fb587 = 11;
...
function function_8141c730()
{
    ...
    str_response = "vox_plr_" + n_character + "_main_ee_power_on_1_0";
...
function function_1f1e411c()
{
    ...
    level.mdl_sophia function_280223ba( var_1f76714 );
}
...
function function_85b7d5f1()
{
    ...
    n_character = level function_1cbd9399( level.mdl_sophia.origin );
    
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_amsel_resp_0_0";
...
function function_38bc572f()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_phase1_resp_1_0";
...
function function_931a3024()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_phase1_resp_3_0";
...
function function_3a7b7b7b()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_phase2_intro_resp_1_0";
...
function function_460341f9()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_anomaly_shoot_third_resp_0_0";
        ...
        if ( isdefined( level.has_richtofen ) && level.players.size == 1 && level.has_richtofen )
        {
            if ( !isdefined( var_1f76714 ) )
            {
                var_1f76714 = [];
...
function function_7c3ff8b2()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_anomaly_trapped_resp_0_0";
...
function function_ececbc4b()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_ascension_complete_resp_0_0";
...
function function_ea234d37()
{
    ...
    level.mdl_sophia function_280223ba( var_1f76714, undefined, 1, 0, 1 );
...
function function_e8e9cba8()
{
    ...
    if ( isdefined( n_character ) )
    {
        str_response = "vox_plr_" + n_character + "_ee_end_resp_0_0";
...
{
    assert( !isdefined( var_6e653641 ) || var_6e653641 < n_max, "<dev string:x1a7>" );
...
function function_2d942575( var_47db2fcf, var_72259a3d )
{
    ...
    {
        return ( self zm_sidequests::is_facing( var_47db2fcf ) && distancesquared( self.origin + ( 0, 0, 64 ), var_47db2fcf.origin + ( 0, 0, 64 ) ) < zombie_utility::squared( var_72259a3d ) && bullettracepassed( self.origin, var_47db2fcf.origin, 0, self, var_47db2fcf ) );
    }
