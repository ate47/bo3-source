...
function function_c4641d12( is_powered )
{
    ...
    while ( true )
    {
        ...
        if ( level.round_number >= level.var_9b1767c1 )
        {
            ...
            e_brush.origin = var_528227ee + var_f72d376e + ( 0, 0, 64 );
            e_brush.angles = var_39796348 + ( 0, 90, 0 );
...
{
    for ( b_touching = util::any_player_is_touching( self, "allies" ); b_touching ; b_touching = util::any_player_is_touching( self, "allies" ) )
    {
        wait 0.05;
    }
}
...
function function_b9cca08f()
{
    ...
    while ( true )
    {
        self util::waittill_player_looking_at( s_pap_location.origin + ( 0, 0, 50 ), 90 );
    ...
    function function_f04119b5( cmd )
    {
        switch ( cmd )
        {
            default:
                ...
                wait 1;
                pap_machine = getent( "<dev string:x91>", "<dev string:x9c>" );
                level.var_54cd8d06 = level.var_1c602ba8[ 0 ];
