...
/#
    ...
    function function_12d043ed() {
        level flag::set("trigger_gas_chamber");
        zm_devgui::add_custom_devgui_callback(&function_efbc0e1);
        adddebugcommand("flag_zipline_in_use");
        adddebugcommand("fxexp_511");
    ...
    function function_efbc0e1(cmd) {
        ...
        case 0:
            ...
            return 1;
        case 0:
            clientfield::set("<unknown string>", 1);
            level scene::init("<unknown string>");
            while (!level scene::is_ready("<unknown string>")) {
                wait(0.05);
            }
            wait(5);
            level flag::set("<unknown string>");
