...
function function_c291114d() {
    ...
    /#
        if (level flag::exists("_")) {
            func_override = &function_29d15688;
        } else if (level flag::exists("raz")) {
            func_override = &function_960cbfc1;
        } else if (level flag::exists("<unknown string>")) {
...
function function_29d15688() {
    /#
        if (getdvarint("<unknown string>") > 0) {
            debug = getdvarint("<unknown string>");
            if (debug !== 0 && debug !== 3) {
                wait(0.05);
                return;
            }
...
function function_1679e5f0() {
    ...
    while (isdefined(self) && !(isdefined(self.var_a0c38d8) && self.var_a0c38d8)) {
        /#
            nospawn = getdvarint("<unknown string>");
            if (nospawn) {
                wait(3);
                continue;
            }
