...
function function_95367d11() {
    /#
        level flag::init("obelisk_runes_drain");
        level flag::init("quest_state_storm");
        level flag::init("rune_prison_magma_ball");
        level flag::init("quest_rune_clock_wall_arrow");
        level flag::init("road");
        level flag::init("trigger_radius");
        level flag::init("upgraded_bow_struct_demon_gate");
        level flag::init("returned");
    #/
    level function_e43ddafb();
    level function_29c80ce1();
    /#
        level flag::set("obelisk_runes_drain");
    #/
    level function_f5e9876("rune", 1);
    level function_c2de3b2b();
    /#
        level flag::set("quest_state_storm");
    #/
    ...
    /#
        level flag::set("quest_rune_clock_wall_arrow");
    #/
...
function function_29c80ce1() {
    /#
        ...
        if (level flag::get("obelisk_runes_drain")) {
            return;
        }
    #/
...
/#
    ...
    function function_7a965585() {
        ...
        if (level.var_714fae39) {
            level thread scene::init("demonic_rune_oth");
            level.var_714fae39 = 0;
            return;
        }
        level thread scene::play("demonic_rune_oth");
        level.var_714fae39 = 1;
    }
    ...
    function function_c272bd2a() {
        ...
        level clientfield::set("aq_wh_ledge_collision", function_85bfa3fd(level.var_c62829c7.characterindex));
        ...
        s_arrow = struct::get("zmb_wolf_arrow_grab");
    ...
    function function_ab3e9362() {
        wait(8);
        level.var_2b11065e = getent("zone_tram_to_gatehouse", "scene");
...
function function_c2de3b2b() {
    /#
        ...
        if (level flag::get("quest_state_storm")) {
            return;
        }
    #/
...
/#
    ...
    function function_3d19bfe5() {
        ...
        level endon(#"hash_c2de3b2b");
        var_94f11108 = getent("aq_es_weather_vane", "scene");
        var_8b1b34fc = getent("zm_castle_quest_elemental_storm_wallrun_rumble", "scene");
        var_ca72ca5f = getent("demon_gate", "scene");
        if (!isdefined(var_94f11108) || !isdefined(var_8b1b34fc) || !isdefined(var_ca72ca5f)) {
            return;
        }
        var_94f11108 clientfield::set("lgt_elemental_bow_plinth", 1);
        var_8b1b34fc clientfield::set("missile_fire", 1);
        var_ca72ca5f clientfield::set("<unknown string>", 1);
        wait(0.05);
        var_94f11108 clientfield::set("lgt_elemental_bow_plinth", 0);
        exploder::exploder("<unknown string>");
        wait(1);
        var_8b1b34fc clientfield::set("missile_fire", 0);
        exploder::exploder("<unknown string>");
        wait(7.5);
        exploder::stop_exploder("<unknown string>");
        var_ca72ca5f clientfield::set("<unknown string>", 0);
        var_94f11108 clientfield::set("lgt_elemental_bow_plinth", 1);
    }
...
/#
    ...
    function function_d326a001() {
        var_a717e964 = getentarray("<unknown string>", "<unknown string>");
        foreach (var_dab58e04 in var_a717e964) {
            if (isdefined(var_dab58e04)) {
                var_dab58e04 delete();
            }
        }
        var_9877e371 = getent("<unknown string>", "scene");
    ...
    function function_6c9ecb6() {
        ...
        if (!(isdefined(level.var_8162c08d) && level.var_8162c08d)) {
            level scene::skipto_end("<unknown string>");
        ...
        var_b4df6e91 = getent("<unknown string>", "scene");
...
function function_292ad7f1() {
    /#
        ...
        if (level flag::get("rune_prison_magma_ball")) {
            return;
        }
    #/
    ...
    foreach (var_6f4e5e57 in var_effd0eae) {
        /#
            if (level flag::get("upgraded_bow_struct_demon_gate")) {
                break;
            }
        #/
...
/#
    ...
    function function_35cccade() {
        if (level flag::get("upgraded_bow_struct_demon_gate") || level flag::get("rune_prison_magma_ball")) {
            return;
        }
        var_effd0eae = getentarray("<unknown string>", "<unknown string>");
        foreach (var_6f4e5e57 in var_effd0eae) {
            if (!level flag::get("quest_state_storm")) {
                var_6f4e5e57 function_eca3cc8a();
                var_6f4e5e57 thread function_1d529530();
            }
            var_6f4e5e57 flag::set("<unknown string>");
        }
        level flag::set("upgraded_bow_struct_demon_gate");
    }
    ...
    function function_6de95813() {
        ...
        zm_spawner::deregister_zombie_death_event_callback(&function_2da80856);
        var_42d1b62e = getentarray("<unknown string>", "<unknown string>");
        foreach (var_9c1f46d7 in var_42d1b62e) {
            var_9c1f46d7 clientfield::set("<unknown string>", 1);
            var_9c1f46d7 clientfield::set("<unknown string>", 0);
        }
        var_11307e05 = getentarray("<unknown string>", "<unknown string>");
        foreach (var_92fe416a in var_11307e05) {
            var_92fe416a clientfield::set("<unknown string>", 1);
        }
        level flag::set("rune_prison_magma_ball");
    }
...
function function_fd254a35() {
    /#
        ...
        if (level flag::get("quest_rune_clock_wall_arrow")) {
            return;
        }
    #/
...
/#
    ...
    function function_455e5c02() {
        a_s_fireplaces = struct::get_array("<unknown string>", "scene");
        if (isdefined(level.var_ca9bb3ac) && level.var_ca9bb3ac) {
            foreach (s_fireplace in a_s_fireplaces) {
                s_fireplace.var_197f1988 scene::stop("<unknown string>");
            }
            exploder::stop_exploder("<unknown string>");
            exploder::stop_exploder("<unknown string>");
            exploder::stop_exploder("<unknown string>");
        ...
        foreach (s_fireplace in a_s_fireplaces) {
            if (!isdefined(s_fireplace.var_197f1988)) {
                s_fireplace.var_197f1988 = util::spawn_model("<unknown string>", s_fireplace.origin + (36, 88, 12));
            }
            s_fireplace.var_197f1988 thread scene::play("<unknown string>");
        }
        exploder::exploder("<unknown string>");
        exploder::exploder("<unknown string>");
        exploder::exploder("<unknown string>");
    ...
    function function_e7cc5223() {
        if (!level flag::get("returned") || level flag::get("<unknown string>")) {
            return;
        }
...
/#
    ...
    function function_e09edb0() {
        ...
        var_11307e05 = getentarray("<unknown string>", "<unknown string>");
        array::thread_all(var_11307e05, &function_561d0d99);
        var_e92aafe5 = getentarray("<unknown string>", "<unknown string>");
        array::run_all(var_e92aafe5, &delete);
        var_e35d5b6e = struct::get("<unknown string>", "scene");
        if (isdefined(var_e35d5b6e.var_7b98b639)) {
            var_e35d5b6e.var_7b98b639 delete();
        }
        level function_a5e1cdff();
...
/#
    ...
    function function_e83bfb3() {
        if (!(isdefined(level.var_1e2db323) && level.var_1e2db323)) {
            var_9dc11e80 = getent("<unknown string>", "scene");
            var_9dc11e80 show();
            level thread scene::play("<unknown string>");
            level.var_1e2db323 = 1;
            return;
    ...
    function function_d4533e0c() {
        wait(2);
        var_5669be5f = getent("<unknown string>", "scene");
        var_5669be5f delete();
    }
...
/#
    ...
    function function_44605b46() {
        ...
        level flag::set("trigger_radius");
        zm_spawner::deregister_zombie_death_event_callback(&function_d04d2c23);
        var_28eeb81a = struct::get("<unknown string>", "scene");
        ...
        level clientfield::set("aq_wh_ledge_collision", 0);
        level function_f5e9876("<unknown string>", 6);
        ...
        level flag::set("<unknown string>");
        var_28eeb81a.var_d4a62e6b = getent("<unknown string>", "scene");
        var_28eeb81a thread function_fb704679();
        level function_2c1c1d3e("<unknown string>");
    }
...
/#
    ...
    function function_4e281784() {
        ...
        if (!(isdefined(level.var_67c3233f) && level.var_67c3233f)) {
            ...
            level.var_67c3233f = 1;
            wait(0.05);
            level.var_72a6d56b = getent("<unknown string>", "scene");
            level.var_72a6d56b hide();
        }
        level thread namespace_2a78f3c::function_a01a53de();
        level.var_6e68c0d8 = level.players[0];
        level clientfield::set("<unknown string>", function_85bfa3fd(level.var_6e68c0d8.characterindex));
        level.var_427e7668[level.var_427e7668.size] = level.players[0];
        level flag::set("<unknown string>");
    }
...
/#
    ...
    function function_c0165d14() {
        if (!isdefined(level.var_8ead83b4)) {
            level.var_8ead83b4 = level flag::get("<unknown string>");
        }
    ...
    function function_ff914e7a() {
        ...
        exploder::exploder("<unknown string>");
        s_urn = struct::get("<unknown string>", "scene");
...
/#
    ...
    function function_de755a0() {
        ...
        level flag::set("<unknown string>");
        var_fc5fd994 = getentarray("<unknown string>", "<unknown string>");
        foreach (var_2c4603e5 in var_fc5fd994) {
            var_f93034eb = getent(var_2c4603e5.target, "scene");
            if (var_f93034eb.script_label == "<unknown string>") {
                var_f93034eb clientfield::set("<unknown string>", 1);
                util::wait_network_frame();
                var_f93034eb clientfield::set("<unknown string>", 2);
            } else {
                var_f93034eb clientfield::set("<unknown string>", 2);
                util::wait_network_frame();
                var_f93034eb clientfield::set("<unknown string>", 2);
...
/#
    ...
    function function_2d151482() {
        ...
        var_90cbeda9 = getent("<unknown string>", "scene");
        var_90cbeda9 clientfield::set("<unknown string>", 1);
        if (!(isdefined(level.var_2114a01) && level.var_2114a01)) {
            zm_spawner::register_zombie_death_event_callback(&function_561017d8);
        }
        var_de75cc7c = getentarray("<unknown string>", "<unknown string>");
        foreach (var_7119a95d in var_de75cc7c) {
            var_7119a95d clientfield::set("<unknown string>", 3);
        }
        level flag::set("<unknown string>");
        level flag::set("<unknown string>");
    }
...
/#
    ...
    function function_8d7d2896() {
        if (!level flag::get("<unknown string>") || level flag::get("<unknown string>") || level flag::get("<unknown string>")) {
            return;
        }
        level flag::set("<unknown string>");
        level notify(#"hash_32d99404");
        var_e488e3fa = struct::get_array("<unknown string>", "<unknown string>");
        foreach (var_e20408bb in var_e488e3fa) {
...
/#
    ...
    function function_dc66bbef() {
        ...
        if (!(isdefined(level.var_b0d821dd) && level.var_b0d821dd)) {
            var_7d849b98 = getent("<unknown string>", "scene");
            var_7d849b98 clientfield::set("<unknown string>", 1);
            var_e1f8771e = getent("<unknown string>", "scene");
            var_e1f8771e scene::skipto_end("<unknown string>");
        }
        if (isdefined(level.var_a81ca85)) {
            level.var_a81ca85 clientfield::set("<unknown string>", 0);
            wait(0.05);
        ...
        var_90cbeda9 = getent("<unknown string>", "scene");
        var_90cbeda9 delete();
        var_9d162495 = getent("<unknown string>", "scene");
        var_9d162495 delete();
        var_7d849b98 = getent("<unknown string>", "scene");
        var_7d849b98 delete();
        var_d8107c7c = getent("<unknown string>", "scene");
        var_d8107c7c delete();
        var_f91a2b6a = getentarray("<unknown string>", "<unknown string>");
        array::run_all(var_f91a2b6a, &delete);
        var_5b00744f = getentarray("<unknown string>", "<unknown string>");
        array::run_all(var_5b00744f, &delete);
        var_6b525fd2 = getentarray("<unknown string>", "<unknown string>");
        array::run_all(var_6b525fd2, &delete);
        zm_spawner::deregister_zombie_death_event_callback(&function_561017d8);
    }
...
/#
    ...
    function function_8c23a1c7() {
        ...
        var_dfd1c443 = struct::get("<unknown string>", "scene");
        ...
        level flag::set("<unknown string>");
        var_dfd1c443.var_d4a62e6b = getent("<unknown string>", "scene");
...
/#
    ...
    function function_2bac97b4() {
        var_18f50dca = struct::get_array("<unknown string>", "<unknown string>");
        foreach (var_48c991cb in var_18f50dca) {
            var_48c991cb.var_b5b31795 clientfield::set("<unknown string>", 1);
        }
        level flag::set("<unknown string>");
    }
    ...
    function function_2a8e7fe2() {
        ...
        level clientfield::set("<unknown string>", function_85bfa3fd(level.var_52978d72.characterindex));
        level.var_427e7668[level.var_427e7668.size] = level.players[0];
        var_18f50dca = struct::get_array("<unknown string>", "<unknown string>");
        foreach (var_48c991cb in var_18f50dca) {
        ...
        if (!(isdefined(level.var_e921c50c) && level.var_e921c50c)) {
            level thread scene::skipto_end("<unknown string>");
            level thread scene::skipto_end("<unknown string>");
    ...
    function function_15f112ea() {
        wait(1);
        level.var_eee1576 = getent("<unknown string>", "scene");
...
/#
    ...
    function function_5928a2a7() {
        if (!isdefined(level.var_e6d07014) || !level flag::get("<unknown string>") || level flag::get("<unknown string>")) {
            return;
        }
...
/#
    ...
    function function_a3638154() {
        if (isdefined(level.var_b9c00aec)) {
            level.var_b9c00aec flag::set("<unknown string>");
        }
    }
...
/#
    ...
    function function_3429d04c() {
        ...
        level flag::set("<unknown string>");
        mdl_skull = getent("<unknown string>", "scene");
        mdl_skull show();
        zm_spawner::deregister_zombie_death_event_callback(&function_d0d62870);
...
/#
    ...
    function function_6c8179b7() {
        level endon(#"hash_b12ab80e");
        var_dddbfe51 = getent("<unknown string>", "scene");
        if (level flag::get("<unknown string>") || level flag::get("<unknown string>") || !level flag::get("<unknown string>") || var_dddbfe51 flag::get("<unknown string>")) {
            return;
        }
        level flag::set("<unknown string>");
        var_dddbfe51 function_6ab969b7();
...
/#
    ...
    function function_b6709ba6() {
        ...
        level flag::set("<unknown string>");
        level flag::set("<unknown string>");
        var_605e43a9 = struct::get("<unknown string>", "scene");
        ...
        if (isdefined(level.var_e6d07014)) {
            ...
            level.var_e6d07014 clientfield::set("<unknown string>", 0);
            level.var_e6d07014 clientfield::set("<unknown string>", 0);
            wait(0.05);
            level.var_e6d07014 delete();
        }
...
/#
    ...
    function function_4bf5f2() {
        ...
        var_afd26121 = struct::get("<unknown string>", "scene");
        ...
        level flag::set("<unknown string>");
        var_afd26121.var_d4a62e6b = getent("<unknown string>", "scene");
...
/#
    ...
    function function_2db350be() {
        ...
        level clientfield::set("<unknown string>", function_85bfa3fd(level.var_f8d1dc16.characterindex));
        level.var_427e7668[level.var_427e7668.size] = level.players[0];
        ...
        s_arrow = struct::get("<unknown string>");
        zm_unitrigger::unregister_unitrigger(s_arrow.var_67b5dd94);
        level flag::set("<unknown string>");
    }
    ...
    function function_9ad758f3() {
        wait(1);
        level.var_18c771ad = getent("<unknown string>", "scene");
...
/#
    ...
    function function_c57b4999() {
        if (!isdefined(level.var_a6503511)) {
            level.var_a6503511 = level flag::get("<unknown string>");
        }
        a_s_beacons = struct::get_array("<unknown string>", "<unknown string>");
        if (level.var_a6503511) {
            foreach (s_beacon in a_s_beacons) {
                if (isdefined(s_beacon.var_41f52afd)) {
                    s_beacon.var_41f52afd clientfield::set("<unknown string>", 0);
                }
            }
        ...
        foreach (s_beacon in a_s_beacons) {
            if (!isdefined(s_beacon.var_41f52afd)) {
                s_beacon.var_41f52afd = util::spawn_model("<unknown string>", s_beacon.origin);
            }
            s_beacon.var_41f52afd clientfield::set("<unknown string>", 1);
        }
...
function function_ba8e8ad8(e_who) {
    ...
    while (var_968c3922 < 4) {
        ...
        if (e_who.origin[2] < 320) {
            ...
            var_968c3922++;
            /#
                iprintlnbold("<unknown string>" + var_968c3922 + "<unknown string>");
            #/
        }
        wait(0.05);
    }
...
/#
    ...
    function function_5508467e() {
        ...
        level flag::set("<unknown string>");
        var_5c7ef569 = getentarray("<unknown string>", "scene");
        foreach (var_634fac89 in var_5c7ef569) {
            mdl_symbol = getent(var_634fac89.target, "scene");
            mdl_symbol clientfield::set("<unknown string>", 2);
            exploder::exploder("<unknown string>" + var_634fac89.script_int);
        }
        level flag::set("<unknown string>");
    }
...
/#
    ...
    function function_6a8283d3() {
        ...
        foreach (s_beacon in a_s_beacons) {
            ...
            s_beacon.var_41f52afd clientfield::set("<unknown string>", 2);
        }
    ...
    function function_ae42a737() {
        ...
        var_9e89bcdc = getentarray("<unknown string>", "<unknown string>");
        foreach (var_8f88d1fd in var_9e89bcdc) {
            var_a4f8e4d0 = getent(var_8f88d1fd.targetname + "<unknown string>", "scene");
            var_a4f8e4d0.b_activated = 1;
            var_a4f8e4d0.b_used = 0;
            var_d186cfae = struct::get(var_8f88d1fd.target, "scene");
            var_d186cfae.var_41f52afd clientfield::set("<unknown string>", 2);
        }
        level flag::set("<unknown string>");
        level flag::set("<unknown string>");
    }
    ...
    function function_1ad44df5() {
        ...
        var_66b0cbbe = struct::get_array("<unknown string>", "<unknown string>");
        if (level.var_f3ff8b16) {
            foreach (var_d186cfae in var_66b0cbbe) {
                var_d186cfae.var_41f52afd clientfield::set("<unknown string>", 1);
            }
            level.var_f3ff8b16 = 0;
            return;
        }
    ...
    function function_b1cac6d2() {
        ...
        foreach (var_d186cfae in var_66b0cbbe) {
            if (isdefined(var_d186cfae.var_41f52afd)) {
                var_d186cfae.var_41f52afd clientfield::set("<unknown string>", 0);
                var_d186cfae.var_41f52afd delete();
            }
        }
        zm_spawner::deregister_zombie_death_event_callback(&function_71e6353);
...
/#
    ...
    function function_1b2a8d00() {
        ...
        var_defe3942 = struct::get("<unknown string>");
        if (level.var_e1c25eb8) {
            if (isdefined(var_defe3942.var_41f52afd)) {
                var_defe3942.var_41f52afd clientfield::set("<unknown string>", 0);
                var_defe3942.var_41f52afd clientfield::set("<unknown string>", 0);
                level.var_e1c25eb8 = 0;
            }
            return;
        ...
        if (!isdefined(var_defe3942.var_41f52afd)) {
            var_defe3942.var_41f52afd = util::spawn_model("<unknown string>", var_defe3942.origin, (-90, 0, 0));
        }
        var_defe3942.var_41f52afd clientfield::set("<unknown string>", 1);
        var_defe3942.var_41f52afd clientfield::set("<unknown string>", 1);
...
/#
    ...
    function function_b88a3579() {
        ...
        var_fe3506f1 = struct::get("<unknown string>", "scene");
        ...
        level flag::set("<unknown string>");
        var_fe3506f1.var_d4a62e6b = getent("<unknown string>", "scene");
...
function function_42084ad5(var_e459d8fb) {
    ...
    /#
        level endon("<unknown string>" + var_1493eda1 + "<unknown string>");
    #/
...
/#
    ...
    function function_7bbe3a25() {
        ...
        if (level.players[0] === level.var_6e68c0d8) {
            var_1493eda1 = "<unknown string>";
            var_78cede1 = "<unknown string>";
            level.var_6e68c0d8 = undefined;
        } else if (level.players[0] === level.var_c62829c7) {
            var_1493eda1 = "<unknown string>";
            var_78cede1 = "aq_wh_ledge_collision";
            level.var_c62829c7 = undefined;
        ...
        level clientfield::set(var_78cede1, 0);
        level notify("<unknown string>" + var_1493eda1 + "<unknown string>");
...
function function_14dd5ea5() {
    ...
    case 136:
        /#
            ...
            if (level flag::get("trigger_radius")) {
                return;
            }
        #/
        var_1493eda1 = "rune_prison";
...
/#
    ...
    function function_1a76d37c() {
        level scene::stop("<unknown string>", 1);
        level scene::stop("<unknown string>", 1);
        level scene::stop("<unknown string>", 1);
        level scene::stop("<unknown string>", 1);
        exploder::exploder("<unknown string>");
        ...
        level thread scene::play("<unknown string>");
        level scene::play("<unknown string>");
        var_682d4b77 = getent("<unknown string>", "scene");
        var_682d4b77 thread function_bf26d3fb("<unknown string>");
        var_5d79f228 = getent("<unknown string>", "scene");
        var_5d79f228 thread function_bf26d3fb("<unknown string>");
        var_3133abfb = getent("<unknown string>", "scene");
        var_3133abfb thread function_bf26d3fb("<unknown string>");
        var_48ce3e52 = getent("<unknown string>", "scene");
        var_48ce3e52 thread function_bf26d3fb("<unknown string>");
