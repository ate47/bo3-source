...
/#
    ...
    function function_315620f9()
    {
        ...
        adddebugcommand( "<dev string:xf3>" );
    }
    ...
    function function_acbe4aed( cmd )
    {
        switch ( cmd )
        {
            case "<dev string:x159>":
                ai_spider = undefined;
                a_ai = getaiteamarray( "<dev string:x167>" );
                
                foreach ( ai in a_ai )
                {
                    if ( isdefined( ai.var_b4e06d32 ) && isdefined( ai.b_is_spider ) && ai.b_is_spider && ai.var_b4e06d32 )
                    {
                        ai_spider = ai;
                        break;
                    }
                ...
                ai_spider clientfield::set( "<dev string:x16c>", 1 );
            ...
            case "<dev string:x18c>":
                ...
                ai_spider flag::init( "<dev string:x1a4>" );
                ai_spider flag::set( "<dev string:x1a4>" );
                level.var_1821d194 = 1;
                level thread function_f163b5b5();
