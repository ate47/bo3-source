...
function function_f64162f4() {
    /#
        assert(!isdefined(level.var_c0091dc4), "femme");
    #/
    level.var_c0091dc4 = [];
    var_ab765abb = array("boxer", "detective", "femme", "magician");
    foreach (str_name in var_ab765abb) {
...
function function_1b8f72e5(str_name) {
    /#
        assert(!isdefined(level.var_c0091dc4[str_name]), "deco_door_clip");
    #/
...
function function_2d12aef1(str_name) {
    ...
    while (true) {
        ...
        /#
            println("quest_ritual_pap_wallimpacts_" + var_b55bd3d0);
        #/
...
function function_8ff18033() {
    ...
    /#
        var_4c4fcdb0 = array("rain_state", "o_zombie_zod_packapunch_tentacle_worldgun_ejected", "<unknown string>", "<unknown string>");
...
/#
    ...
    function quest_devgui() {
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_dc59b750);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &namespace_81256d2f::function_3f95af32);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_7dda8ea9);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_6c6a5914);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_c0a29676);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_546835a);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_832e2eaa);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_11a2ca3b);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_1dadcc76);
        level thread namespace_8e578893::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_150df737);
    }
...
/#
    ...
    function function_861cf6b3() {
        var_92d58fd4 = getentarray("<unknown string>", "<unknown string>");
