...
function function_8aac3fe() {
    ...
    while (true) {
        ...
        if (level.round_number == level.var_ebc4830) {
            ...
            level.var_175273f2++;
            /#
                iprintln("<unknown string>" + level.var_ebc4830);
            #/
        }
    }
}
...
function function_68ee76ee(var_d1cba433, var_48cf4a3d) {
    ...
    level endon(#"end_of_round");
    /#
        assert(var_d1cba433.size >= var_48cf4a3d, "<unknown string>");
    #/
...
/#
    ...
    function function_13a79919() {
        var_81b7a825 = getaiarchetypearray("<unknown string>");
        players = getplayers();
    ...
    function function_da954e93(cmd) {
        ...
        case 0:
            ...
            thrasher = zombie_utility::spawn_zombie(level.var_feebf312[0], "<unknown string>", spot);
            if (isdefined(thrasher)) {
                ...
                var_80f08819 = trace["<unknown string>"];
                var_a6621bfd = var_80f08819;
                thrasher forceteleport(var_a6621bfd, v_angles);
            }
            break;
        case 0:
            var_5613e8c5 = getaiarchetypearray("<unknown string>");
        ...
        case 0:
            thrasher = function_13a79919();
            if (isdefined(thrasher)) {
                thrasher ai::set_behavior_attribute("<unknown string>", "<unknown string>");
                players = getplayers();
                if (players.size > 0) {
