    ...
    function function_290563e9()
    {
        while ( true )
        {
            ...
            if ( !self.var_11a8191e && !self.var_a802d3d9 )
            {
                ...
                /#
                    iprintlnbold( "<dev string:x35>" + var_5375e06e + "<dev string:x3c>" + var_15a04435 + "<dev string:x46>" + var_a0dd62e5 );
                #/
...
class class_d7100ae3
{
    ...
    {
        self.m_b_active = !self.m_b_active;
    }
    ...
    {
        self.m_mdl_switch zm_castle_util::create_unitrigger();
        
        while ( true )
        {
            self.m_mdl_switch waittill( #"trigger_activated" );
            self function_aa7c5ce2();
            self.m_mdl_switch playsound( "evt_lever" );
            ...
            self.m_mdl_switch rotatepitch( 60, 0.333 );
            wait 0.333;
            self.m_mdl_switch rotatepitch( -60, 0.2 );
            wait 0.2;
        }
    }
    ...
    function function_ec1f5e9( var_8deda1b1, n_minutes, var_1133e63b )
    {
        ...
        /#
            iprintln( "<dev string:x4e>" + var_2dc617a1 + "<dev string:x65>" + var_16c3da4f );
        #/
        ...
        /#
            iprintln( "<dev string:x67>" + self.var_a117a15d + "<dev string:x65>" + self.var_246b41b3 );
        #/
    ...
    function init()
    {
        ...
        self.m_mdl_switch = getent( "ee_clocktower_activation_switch", "targetname" );
        self.m_b_active = 0;
        self.var_246b41b3 = 0;
        self.var_a117a15d = 0;
        self.var_23036e82 = 0;
...
function function_c7bb86e5( attacker )
{
    ...
    /#
        iprintln( "<dev string:xa9>" + attacker.var_ea5424ae );
    #/
...
function function_5c600852()
{
    ...
    a_gramophone = getentarray( "hs_gramophone", "targetname" );
    array::thread_all( a_gramophone, &function_db46cccd );
    
    while ( true )
    {
        level waittill( #"hash_9c9fb305" );
        
        if ( level.var_89ad28cd == a_gramophone.size )
        {
            break;
        }
    }
...
function function_db46cccd()
{
    ...
    /#
        self thread zm_castle_util::function_8faf1d24( ( 0, 0, 255 ), "<dev string:xba>" );
    #/
...
function function_4b02c768()
{
    ...
    /#
        e_origin thread zm_castle_util::function_8faf1d24( ( 0, 0, 255 ), "<dev string:xbe>" );
    #/
...
/#
    ...
    function devgui_ee()
    {
        level thread zm_castle_util::setup_devgui_func( "<dev string:xc2>", "<dev string:xde>", 1, &function_3d627178 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:xea>", "<dev string:x10b>", 1, &function_f0dc1bf3 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x11c>", "<dev string:x144>", 0, &function_3388f3a3 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x15a>", "<dev string:x144>", 1, &function_3388f3a3 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x182>", "<dev string:x144>", 2, &function_3388f3a3 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x1aa>", "<dev string:x1d6>", 1, &function_239f31ac );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x1ea>", "<dev string:x217>", 1, &function_8f84cfff );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x22c>", "<dev string:x261>", 1, &function_e6679107 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x278>", "<dev string:x2ab>", 1, &function_71626c1a );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x2c3>", "<dev string:x2f3>", 1, &function_c8b68402 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x30b>", "<dev string:x33e>", 1, &function_14004ce0 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x35e>", "<dev string:x390>", 1, &function_5b000c75 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x3af>", "<dev string:x3da>", 1, &function_4e8ebeb2 );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x3ee>", "<dev string:x418>", 1, &function_d40e8eab );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x42a>", "<dev string:x452>", 1, &function_ce8b131c );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x462>", "<dev string:x48c>", 1, &function_71bd024b );
        level thread zm_castle_util::setup_devgui_func( "<dev string:x4a6>", "<dev string:x4ce>", 1, &function_ad9da95f );
    }
    ...
    {
        level flag::set( "<dev string:x10b>" );
    }
    ...
    {
        zm_zonemgr::enable_zone( "<dev string:x4e8>" );
    }
    ...
    {
        level flag::set( "<dev string:x1d6>" );
    }
