    ...
    function function_290563e9() {
        while (true) {
            ...
            if (!self.var_11a8191e && !self.var_a802d3d9) {
                ...
                /#
                    iprintlnbold("c_t6_zom_mech_claw" + var_5375e06e + "fx_rocket" + var_15a04435 + "zombie" + var_a0dd62e5);
                #/
                if (var_a0dd62e5 <= 45) {
...
class class_d7100ae3 {
    ...
    function function_ec1f5e9(var_8deda1b1, n_minutes, var_1133e63b) {
        ...
        /#
            iprintln("wpn_t7_zmb_dlc1_plunger_world" + var_2dc617a1 + "fxexp_600" + var_16c3da4f);
        #/
        ...
        /#
            iprintln("zm_factory_teleport" + self.var_a117a15d + "fxexp_600" + self.var_246b41b3);
        #/
        self.var_2ed6212f = 0;
...
function main() {
    ...
    function_9e325d85();
    /#
        if (getdvarint("ee_disco_arm_rocket") > 0) {
...
function function_c7bb86e5(attacker) {
    ...
    /#
        iprintln("<unknown string>" + attacker.var_ea5424ae);
    #/
    wait(60);
    attacker.var_ea5424ae--;
    /#
...
function function_db46cccd() {
    ...
    /#
        self thread namespace_744abc1c::function_8faf1d24((0, 0, 255), "<unknown string>");
    #/
...
function function_4b02c768() {
    ...
    /#
        e_origin thread namespace_744abc1c::function_8faf1d24((0, 0, 255), "<unknown string>");
    #/
...
/#
    ...
    function function_d6026710() {
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_3d627178);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_f0dc1bf3);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 0, &function_3388f3a3);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_3388f3a3);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 2, &function_3388f3a3);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_239f31ac);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_8f84cfff);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_e6679107);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_71626c1a);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_c8b68402);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_14004ce0);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_5b000c75);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_4e8ebeb2);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_d40e8eab);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_ce8b131c);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_71bd024b);
        level thread namespace_744abc1c::function_72260d3a("<unknown string>", "<unknown string>", 1, &function_ad9da95f);
    }
