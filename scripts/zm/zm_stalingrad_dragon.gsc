...
/#
    ...
    function function_40dbf71() {
        ...
        while (true) {
            if (isdefined(level.var_e29dd7ca)) {
                origin = level.var_e29dd7ca gettagorigin("p7_fxanim_zm_stal_dragon_hazard_dept_store_01_bundle");
...
function function_ffa0a9ed() {
    ...
    /#
        scene::add_scene_func("fxexp_408", &function_e73b4306, "alley_A_zone");
        scene::add_scene_func("department_store_floor3_B_zone", &function_a2ac4477, "alley_A_zone");
    #/
}
...
/#
    ...
    function function_16734812() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "zmb_stalingrad_cooldown_over";
    ...
    function function_e7982921() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "ZM_STALINGRAD_CONSOLE_DISABLED";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_cfe0d523() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "ZM_STALINGRAD_CONSOLE_DRAGON_ARRIVED";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_5f0cb06e() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "t_dragon_console_judicial";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_84bd37c8() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "dragon_transport_alert_";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_8bf8d33b() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "s_dragon_boss_debug_player";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_7977857() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "cin_t7_ai_zm_dlc3_dragon_boss_fight_idle_c_loop";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_b8de630a() {
        level notify(#"hash_dfaade1d");
        util::wait_network_frame();
        level.var_777ffc66 = "cin_t7_ai_zm_dlc3_dragon_boss_fight_hover_idle_b";
        level thread function_c5bbc2a7(1);
    }
    ...
    function function_941c2339() {
        if (!level flag::get("cin_t7_ai_zm_dlc3_dragon_boss_fight_taunt_a") && !level flag::get("cin_t7_ai_zm_dlc3_dragon_boss_fight_lance_pain_neck_b")) {
            namespace_48c05c81::function_4da6e8(0);
            wait(0.05);
    ...
    function function_ef4a09c3() {
        if (level flag::get("cin_t7_ai_zm_dlc3_dragon_boss_fight_taunt_a") && !level flag::get("cin_t7_ai_zm_dlc3_dragon_boss_fight_lance_pain_neck_b")) {
            ...
            util::wait_network_frame();
            level thread function_b4d22afe();
            level flag::clear("cin_t7_ai_zm_dlc3_dragon_boss_fight_taunt_a");
        }
    }
    ...
    function function_c09859f(n_seat) {
        if (!level flag::get("j_neck_7_anim_wound")) {
            function_11700745();
        }
        function_17b7a6a();
        function_8a29cbcb();
    ...
    function function_e73b4306(a_ents) {
        level waittill(#"fadeout");
        level thread lui::screen_fade_out(1, "north");
    }
    ...
    function function_a2ac4477(a_ents) {
        level thread lui::screen_fade_in(1, "north");
    }
