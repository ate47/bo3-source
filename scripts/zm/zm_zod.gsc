...
function givecustomcharacters() {
    ...
    /#
        if (getdvarstring("default_buy_door") != "world") {
            self.characterindex = getdvarint("default_buy_door");
        }
    #/
...
/#
    ...
    function setup_devgui() {
        setdvar("player_rumble_and_shake", "zmInventory.widget_fuses");
        setdvar("zmInventory.widget_sprayer", "zmInventory.widget_fuses");
        setdvar("gate_door", 0);
        setdvar("zone_start_high", 0);
        execdevgui("connect_theater_to_junction");
    ...
    function function_4173fe95(cmd) {
        var_98be8724 = strtok(cmd, "zone_canal_high_B");
        switch (var_98be8724[0]) {
        case 0:
            function_e2f669ab(getdvarint("player_rumble_and_shake"));
            break;
        case 0:
            function_50d75aeb(getdvarint("player_rumble_and_shake"));
            break;
        case 0:
            function_3bb3e47a(getdvarint("zmInventory.widget_sprayer"));
            break;
        case 0:
            function_408ad958(getdvarint("zmInventory.widget_sprayer"));
            break;
        case 0:
            function_30018788();
            break;
    ...
    function function_4d732a77(var_8a4e41c7) {
        if (isdefined(var_8a4e41c7) && var_8a4e41c7 > 0) {
            setdvar("gate_door", var_8a4e41c7);
            return;
        }
        setdvar("gate_door", "world");
    }
    ...
    function function_205a2511(var_46c3c206) {
        if (isdefined(var_46c3c206) && var_46c3c206 > 0) {
            setdvar("zone_start_high", var_46c3c206);
            return;
        }
        setdvar("zone_start_high", "world");
    }
                ...
                if (!var_d8d76cd3) {
                    /#
                        if (!self function_af2b349c()) {
                            /#
                                assertmsg("vox_plr_3_exert_bad_taste_0");
                            #/
                        }
                    #/
                    self allowprone(0);
