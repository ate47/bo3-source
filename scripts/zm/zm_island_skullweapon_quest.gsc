...
function main() {
    ...
    /#
        assert(var_cdbcb282.size == 4, "s_skulltar_attack_pos" + var_cdbcb282.size);
    #/
    /#
        assert(var_a7ba3819.size == 4, "zmb_skull_ritual_hit" + var_a7ba3819.size);
    #/
    level.var_cdbcb282 = [];
    level.var_d76f80e0 = [];
    level.var_a576e0b9 = [];
                    ...
                    if (level.var_a576e0b9[var_f2e38849].var_41335b73.size < var_3be27b2b) {
                        ...
                        /#
                            if (isdefined(level.var_32d5991a) && level.var_32d5991a) {
                                iprintlnbold("has_skull" + i + "<unknown string>" + self.var_4a27984b[i].origin);
                            }
                        #/
                    }
                    break;
...
function function_c46730e7(var_f2e38849) {
    ...
    if (!self function_b948e12a(var_f2e38849)) {
        /#
            if (isdefined(level.var_32d5991a) && level.var_32d5991a) {
                iprintlnbold("<unknown string>" + self.origin + "<unknown string>");
            }
        #/
...
/#
    ...
    function function_138d72ee(var_f2e38849) {
        level thread function_fae0aa01(var_f2e38849, "<unknown string>", level.activeplayers[0]);
    }
    ...
    function function_f7ec6ad4(var_f2e38849, ent) {
        if (ent.var_d64275e8 === 0) {
            function_fae0aa01(var_f2e38849, "<unknown string>", ent);
        }
    }
