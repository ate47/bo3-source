...
/#
    ...
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x49>", "<dev string:x71>", 1, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x80>", "<dev string:xa4>", 1, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xb2>", "<dev string:x71>", 2, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xda>", "<dev string:xa4>", 2, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xfe>", "<dev string:x71>", 3, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x126>", "<dev string:xa4>", 3, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x14a>", "<dev string:x71>", 4, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x172>", "<dev string:xa4>", 4, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x196>", "<dev string:x71>", 5, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x1be>", "<dev string:xa4>", 5, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x1e2>", "<dev string:x71>", 6, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x20a>", "<dev string:xa4>", 6, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x22e>", "<dev string:x71>", 7, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x256>", "<dev string:xa4>", 7, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x27a>", "<dev string:x71>", 8, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2a2>", "<dev string:xa4>", 8, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2c6>", "<dev string:x71>", 9, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2ee>", "<dev string:xa4>", 9, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x312>", "<dev string:x71>", 10, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x33a>", "<dev string:xa4>", 10, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x35e>", "<dev string:x71>", 11, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x386>", "<dev string:xa4>", 11, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3aa>", "<dev string:x71>", 12, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3d2>", "<dev string:xa4>", 12, &function_dda18b8e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3f6>", "<dev string:x71>", 13, &function_418d5e87 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x41e>", "<dev string:xa4>", 13, &function_dda18b8e );
    }
