...
/#
    ...
    function private function_e48879e3(cmd) {
        ...
        default:
            ...
            zombies = getaispeciesarray(level.zombie_team, "<unknown string>");
            foreach (zombie in zombies) {
                if (isdefined(level.var_c43a1504) && level.var_c43a1504) {
                    zombie set_gravity("<unknown string>");
                    if (zombie ai::has_behavior_attribute("<unknown string>")) {
                        zombie ai::set_behavior_attribute("<unknown string>", "<unknown string>");
                    }
                    continue;
                }
                zombie set_gravity("<unknown string>");
