...
function function_e38b964d() {
    ...
    while (true) {
        ...
        if (level.round_number == level.var_a78effc7) {
            ...
            /#
                level.players[0] iprintln("<unknown string>" + level.var_a78effc7);
            #/
            continue;
        }
...
function function_7766fb04() {
    ...
    /#
        if (getdvarstring("<unknown string>") != "<unknown string>" && getdvarint("<unknown string>") > 0) {
            level.zombie_total = getdvarint("<unknown string>");
...
function function_23a30f49(var_c94972aa) {
    ...
    if (isdefined(level.var_2babfade)) {
        ...
        /#
            if (level.zm_loc_types["<unknown string>"].size == 0) {
...
/#
    ...
    function function_c630bba3(cmd) {
        ...
        case 0:
            ...
            var_feba5c63 = positionquery_source_navigation(trace["<unknown string>"], -128, 256, -128, 20);
            s_spot = spawnstruct();
        ...
        case 0:
            ...
            return 1;
        case 0:
            curvalue = getdvarint("<unknown string>", 0);
            if (curvalue == 0) {
                curvalue = 1;
            } else {
                curvalue = 0;
            }
            setdvar("<unknown string>", curvalue);
            return 1;
        case 0:
            curvalue = getdvarint("<unknown string>", 0);
            if (curvalue == 0) {
