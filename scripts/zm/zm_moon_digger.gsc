...
function function_7b5ffa5e(var_b4ecbf81) {
    /#
        ...
        elem.horzalign = "teleporter_digger_body_lights";
        elem.vertalign = "hangar_digger_arm_lights";
        elem.alignx = "teleporter_digger_body_lights";
        elem.aligny = "teleporter_used";
        elem.x = 0;
        elem.y = 0;
        elem.foreground = 1;
        elem.font = "Dz3";
