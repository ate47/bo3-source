...
class class_d90687be
{
        ...
        while ( level clientfield::get( "circle_state" ) == 3 )
        {
            ...
            if ( self.var_eeb77e19.size < var_16d0ce4b )
            {
                if ( isdefined( spawn_point ) )
                {
                    ...
                    {
                        v_spawn_origin = v_ground + ( 0, 0, 40 );
                    }
    ...
    // Size: 0x134
    function arena_shutdown_thread()
    {
        level notify( #"arena_shutdown_thread" );
        level endon( #"arena_shutdown_thread" );
    ...
    function function_f115a4c8()
    {
        ...
        {
            /#
                iprintlnbold( "<dev string:x28>" + 5 - i );
            #/
    ...
    function function_15715797()
    {
        ...
        while ( true )
        {
            ...
            level thread arena_shutdown_thread();
...
function function_6a03c1d4( var_87c8152d, var_eadfbdd4 )
{
    ...
    if ( level flag::get( "custom_challenge" ) )
    {
        /#
            ...
            iprintlnbold( "<dev string:x91>" + level flag::get( "<dev string:x9b>" ) + "<dev string:xb4>" + level flag::get( "<dev string:xbf>" ) + "<dev string:xd8>" + level flag::get( "<dev string:xe1>" ) );
            iprintlnbold( "<dev string:xf8>" + level flag::get( "<dev string:x101>" ) + "<dev string:x119>" + level flag::get( "<dev string:x121>" ) + "<dev string:x137>" + level flag::get( "<dev string:x13f>" ) + "<dev string:x155>" + level flag::get( "<dev string:x163>" ) );
        #/
    ...
    /#
        iprintlnbold( "<dev string:x17f>" + function_6ab2d662( var_87c8152d ) );
    #/
...
function function_80340a8d( n_path_index, var_45868921 )
{
    ...
    mdl_tornado = util::spawn_model( "tag_origin", var_e453ffc4.origin, ( -90, 0, 0 ) );
...
function function_36c2a88b( v_spawn_pos, n_wait )
{
    ...
    while ( level.var_fe2fb4b9 == 2 )
    {
        ...
        mdl_lava = util::spawn_model( "p7_fxanim_zm_gen_dark_arena_lava_01_small_mod", v_spawn_pos + ( 0, 0, -13 ), ( 0, randomintrange( 0, 360 ), 0 ) );
...
// Size: 0x140
function function_11a85c29( b_devgui_skip )
{
    if ( !isdefined( b_devgui_skip ) )
    {
        b_devgui_skip = 0;
    }
...
function function_386f30f4()
{
    ...
    if ( !isdefined( level.a_mdl_shadowman ) )
    {
        level.a_mdl_shadowman = [];
    }
...
// Size: 0x2fc
function function_1a4e2d94( n_move_duration, var_8fc8c481 )
{
...
function function_867f6495()
{
    ...
    while ( true )
    {
        ...
        v_ball_pos = var_d6ba68c5.origin;
        ...
        else if ( isdefined( var_cb6acc3e ) && v_ball_pos != var_cb6acc3e )
        {
            s_sophia = struct::get( "boss_sophia_hover", "targetname" );
            var_32769d76 = pointonsegmentnearesttopoint( v_ball_pos, var_cb6acc3e, s_sophia.origin );
            var_bcf81f62 = var_32769d76 - s_sophia.origin;
...
function function_43049e1e()
{
    ...
    /#
        iprintlnbold( "<dev string:x23a>" + var_61d59a5a.size + "<dev string:x252>" );
    #/
...
// Size: 0x844
function function_14c1c18d( player, a_s_port_locs, var_edface0, show_fx )
{
...
function function_44d21c21( b_on )
{
    ...
    e_bridge.is_on = 0;
    e_bridge ghost();
    e_bridge moveto( e_bridge.v_start - ( 0, 0, 1000 ), 0.01 );
...
function function_f2c00181()
{
    while ( true )
    {
        ...
        level notify( #"arena_picked_up_reward" );
        break;
    }
}
...
/#
    ...
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x25d>", "<dev string:x289>", 1, &function_506d0aab );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x29d>", "<dev string:x2bc>", 1, &function_db4e54c1 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2d0>", "<dev string:x2f6>", 1, &function_5addbab1 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x308>", "<dev string:x338>", 1, &function_4f66f424 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x35a>", "<dev string:x38b>", 1, &function_e4990d03 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x39b>", "<dev string:x38b>", 2, &function_e4990d03 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3c6>", "<dev string:x38b>", 3, &function_e4990d03 );
    }
    ...
    function function_506d0aab( n_val )
    {
        ...
        foreach ( e_player in level.activeplayers )
        {
            ...
            e_player thread zm_devgui::zombie_devgui_equipment_give( "<dev string:x3f2>" );
        }
    }
    ...
    function function_4f66f424( n_val )
    {
        ...
        {
            s_teleport = struct::get( "<dev string:x401>" + i, "<dev string:x416>" );
    ...
    {
        setdvar( "<dev string:x421>", "<dev string:x433>" );
        wait 1;
        setdvar( "<dev string:x444>", "<dev string:x452>" );
        wait 1;
        setdvar( "<dev string:x444>", "<dev string:x466>" );
    }
    ...
    // Size: 0xb0c, Type: dev
    function devgui_arena()
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x47c>", "<dev string:x4aa>", 0, &function_c4923f72 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4b4>", "<dev string:x4aa>", 1, &function_c4923f72 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4e3>", "<dev string:x4aa>", 2, &function_c4923f72 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x510>", "<dev string:x4aa>", 3, &function_c4923f72 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x544>", "<dev string:x572>", 0, &function_251f28c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x57c>", "<dev string:x572>", 1, &function_251f28c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x5ab>", "<dev string:x572>", 2, &function_251f28c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x5d8>", "<dev string:x572>", 3, &function_251f28c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x60c>", "<dev string:x638>", 0, &function_871092c9 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x644>", "<dev string:x638>", 1, &function_871092c9 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x66e>", "<dev string:x638>", 2, &function_871092c9 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x699>", "<dev string:x638>", 4, &function_871092c9 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x6c8>", "<dev string:x6f4>", 0, &function_59d78fe0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x701>", "<dev string:x6f4>", 1, &function_59d78fe0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x72f>", "<dev string:x6f4>", 2, &function_59d78fe0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x75a>", "<dev string:x6f4>", 3, &function_59d78fe0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x783>", "<dev string:x6f4>", 4, &function_59d78fe0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x7af>", "<dev string:x6f4>", 5, &function_59d78fe0 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x7df>", "<dev string:x806>", 0, &function_9efa2460 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x817>", "<dev string:x806>", 1, &function_9efa2460 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x83f>", "<dev string:x806>", 2, &function_9efa2460 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x865>", "<dev string:x806>", 3, &function_9efa2460 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x892>", "<dev string:x8b1>", 1, &function_10d73de7 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x8c6>", "<dev string:x8e9>", 1, &function_3e3aa4a2 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x8f9>", "<dev string:x8e9>", 2, &function_3e3aa4a2 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x91c>", "<dev string:x937>", 1, &function_88f1ee45 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x944>", "<dev string:x937>", 0, &function_88f1ee45 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x960>", "<dev string:x988>", 1, &function_ef5cc959 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x999>", "<dev string:x9c8>", 1, &function_7104ee61 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x9e0>", "<dev string:x9b>", 1, &function_bc5b95af );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xa0d>", "<dev string:x9b>", 0, &function_bc5b95af );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xa3b>", "<dev string:xbf>", 1, &function_fe9efe30 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xa69>", "<dev string:xbf>", 0, &function_fe9efe30 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xa98>", "<dev string:xe1>", 1, &function_8a771d77 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xac3>", "<dev string:xe1>", 0, &function_8a771d77 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xaef>", "<dev string:x101>", 1, &function_82a40293 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xb1b>", "<dev string:x101>", 0, &function_82a40293 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xb48>", "<dev string:xb79>", 2, &function_ce0fad48 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xb8d>", "<dev string:xbbe>", 3, &function_ce0fad48 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xbd2>", "<dev string:xbf2>", 1, &function_11f7a042 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xc05>", "<dev string:xbf2>", 2, &function_11f7a042 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xc25>", "<dev string:xbf2>", 3, &function_11f7a042 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xc46>", "<dev string:xbf2>", 4, &function_11f7a042 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xc67>", "<dev string:xc8a>", 0, &function_4e3a221e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xc9a>", "<dev string:xcb4>", 1, &function_f8dfefdd );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xcc0>", "<dev string:xcb4>", 0, &function_f8dfefdd );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xcdb>", "<dev string:xcfb>", 1, &function_1189737f );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xd10>", "<dev string:xd35>", 1, &function_4dd54050 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xd4b>", "<dev string:xd73>", 1, &function_cdccd485 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xd89>", "<dev string:xda0>", 1, &function_995cb46 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xdb1>", "<dev string:xda0>", 1, &function_3cf095ce );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xdce>", "<dev string:xde5>", 1, &function_60a02f3a );
    }
    ...
    {
        level flag::set( "<dev string:xdf0>" );
    }
    ...
    {
        level flag::set( "<dev string:xdfc>" );
        level thread function_c2578b2a();
    }
    ...
    {
        a_s_elec = struct::get_array( "<dev string:xe11>", "<dev string:x416>" );
        
        foreach ( s_elec in a_s_elec )
        {
            playfx( level._effect[ "<dev string:xe22>" ], s_elec.origin );
        }
    }
    ...
    function function_11f7a042( n_val )
    {
        ...
        iprintlnbold( "<dev string:xe33>" + level.var_c4133b63 );
    }
    ...
    function function_251f28c( var_87c8152d )
    {
        ...
        str_flag_name = var_5a2492d5 + "<dev string:xe42>";
    ...
    {
        level clientfield::set( "<dev string:x638>", n_val );
    }
    ...
    {
        level clientfield::set( "<dev string:x6f4>", n_val );
    }
    ...
    function function_f8dfefdd( n_val )
    {
        if ( n_val > 0 )
        {
            level flag::set( "<dev string:xcb4>" );
            return;
        }
        
        level flag::clear( "<dev string:xcb4>" );
    }
    ...
    function function_1189737f( n_val )
    {
        ...
        foreach ( player in players )
        {
            var_8e5264b2 = struct::get( "<dev string:xe4b>" + player.characterindex, "<dev string:x416>" );
    ...
    {
        level flag::set( "<dev string:x988>" );
    ...
    function function_7104ee61( n_val )
    {
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe61>";
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe69>";
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe71>";
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe77>";
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe7e>";
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe83>";
        ...
        a_str_flags[ a_str_flags.size ] = "<dev string:xe88>";
        
        foreach ( str_flag in a_str_flags )
        {
            if ( math::cointoss() )
            {
                level flag::set( "<dev string:xe93>" + str_flag );
                continue;
            }
            
            level flag::clear( "<dev string:xe93>" + str_flag );
        }
    ...
    function function_9bc9cf70( str_msg, n_val )
    {
        if ( n_val > 0 )
        {
            iprintlnbold( str_msg + "<dev string:xea5>" );
            return;
        }
        
        iprintlnbold( str_msg + "<dev string:xea8>" );
    }
    ...
    {
        level flag::set( "<dev string:x9b>" );
        function_9bc9cf70( "<dev string:xeac>", n_val );
    }
    ...
    {
        level flag::set( "<dev string:xbf>" );
        function_9bc9cf70( "<dev string:xec9>", n_val );
    }
    ...
    {
        level flag::set( "<dev string:xe1>" );
        function_9bc9cf70( "<dev string:xee6>", n_val );
    }
    ...
    {
        level flag::set( "<dev string:x101>" );
        function_9bc9cf70( "<dev string:xf01>", n_val );
    }
    ...
    {
        level flag::set( "<dev string:x121>" );
        function_9bc9cf70( "<dev string:xf1d>", n_val );
    }
    ...
    {
        level flag::set( "<dev string:x13f>" );
        function_9bc9cf70( "<dev string:xf37>", n_val );
    }
    ...
    {
        level flag::set( "<dev string:x163>" );
        function_9bc9cf70( "<dev string:xf51>", n_val );
    }
    ...
    function function_3e3aa4a2( n_val )
    {
        ...
        {
            level notify( #"hash_f115a4c8" );
            level clientfield::set( "<dev string:x638>", 2 );
            level clientfield::set( "<dev string:x6f4>", 3 );
