...
function function_7039f685()
{
    ...
    while ( true )
    {
        ...
        {
            str_att = level.var_5013e65c[ var_1ff6fb34 ];
            var_1ff6fb34++;
        ...
        do
        {
            b_got_weapon = self function_4035ce17( n_index, b_upgraded, str_att );
            n_index++;
        }
        while ( !b_got_weapon );
...
// Size: 0x1a8
function function_4035ce17( n_index, b_upgraded, str_att )
{
    ...
    if ( !self has_weapon( w_random ) )
    {
        ...
        if ( isdefined( str_att ) && str_att != "none" )
        {
            self thread aat::acquire( w_random, str_att );
        }
