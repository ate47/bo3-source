...
function function_b4575902() {
    ...
    /#
        iprintlnbold("c_zom_dlc4_player_arlington_helmet");
    #/
    ...
    while (var_5a533244.size > 0) {
        ...
        if (n_closest_dist <= var_6b63f67e) {
            ...
            if (var_688f490b.var_b4a21360 <= 0) {
                ...
                /#
                    iprintlnbold("s_dire_wolf_path_start");
                #/
            }
        }
    }
...
function function_c81a7efa() {
    /#
        iprintlnbold("apothicon_mask_all_zombies_killed");
    #/
...
/#
    ...
    function function_b03acf4e(var_b3ecaf28) {
        s_loc = struct::get(var_b3ecaf28, "<unknown string>");
    ...
    function function_82e9c58d(cmd) {
        ...
        switch (cmd) {
        case 0:
            function_f6b20985("<unknown string>", "<unknown string>", "<unknown string>", 0);
            break;
        case 0:
            function_f6b20985("<unknown string>", "<unknown string>", "<unknown string>", 0);
            break;
        ...
        case 0:
            ...
            break;
        default:
            player function_b03acf4e("<unknown string>");
            break;
        case 0:
            player function_b03acf4e("<unknown string>");
            break;
