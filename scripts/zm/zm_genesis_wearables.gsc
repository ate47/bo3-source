...
function function_f6b20985( var_8fca9f8c, var_f48b681c, str_tag, var_f3776824 )
{
    ...
    s_uni_trigger = s_loc zm_unitrigger::create_unitrigger( &"ZM_GENESIS_WEARABLE_PICKUP", undefined, &function_24061b58, &function_7f0ec71c );
    s_uni_trigger.var_f4b4f2f2 = var_f48b681c;
    s_uni_trigger.str_tag = str_tag;
    s_uni_trigger.var_475b0a4e = var_8fca9f8c;
    v_offset = ( 0, 0, var_f3776824 );
    s_uni_trigger.origin += v_offset;
    zm_unitrigger::unitrigger_force_per_player_triggers( s_uni_trigger, 1 );
}
...
function function_b8449f8c( a_mdl_batteries )
{
    ...
    while ( a_mdl_batteries.size > 0 )
    {
        ...
        {
            zm_genesis_power::zombie_blood_soul_streak_fx( v_kill_pos + ( 0, 0, 50 ), ( 0, 0, 0 ), var_688f490b.origin, 0.75 );
...
function function_9d85b9ce( e_attacker )
{
    ...
    if ( isdefined( level.var_a92f045 ) && level.var_a92f045 )
    {
        if ( level flag::get( "low_grav_on" ) )
        {
            ...
            if ( n_dist <= 256 )
            {
                level thread zm_genesis_power::zombie_blood_soul_streak_fx( self.origin + ( 0, 0, 50 ), self.angles, var_d0c30abc, 1 );
...
/#
    ...
    function function_b03acf4e( var_b3ecaf28 )
    {
        ...
        teleportpoint = getclosestpointonnavmesh( s_loc.origin, 100 );
        
        if ( !isdefined( teleportpoint ) )
        {
            teleportpoint = s_loc.origin;
        }
        
        self setorigin( teleportpoint );
    }
