...
/#
    ...
    function function_8b7501aa() {
        ...
        level flag::set("connect_jungle_lab_to_jungle_lab_upper");
        level flag::set("zone_flooded_bunker_right");
        level flag::set("<unknown string>");
        level flag::set("<unknown string>");
        level thread namespace_5f2c95ae::function_3bd86987("<unknown string>");
        level flag::set("<unknown string>");
        level flag::set("<unknown string>");
        level flag::set("<unknown string>");
    }
