...
function function_a96551fe()
{
    ...
    while ( true )
    {
        ...
        if ( isdefined( level.var_f618f3e1 ) && ( isdefined( self.who.b_is_spider ) && self.who.b_is_spider || level.var_f618f3e1 ) )
        {
            ...
            if ( var_94aebe65 < level.var_42034f6a )
            {
                ...
                if ( isdefined( var_59bd3c5a.b_is_spider ) && isalive( var_59bd3c5a ) && var_59bd3c5a.b_is_spider )
                {
...
function function_e96bd0d2()
{
    ...
    while ( true )
    {
        ...
        if ( isdefined( e_who.b_is_spider ) && e_who.b_is_spider && !( isdefined( e_who.var_a56241ac ) && e_who.var_a56241ac ) )
        {
...
function function_9b4a5d94( t_web )
{
    ...
    while ( true )
    {
        ...
        if ( isdefined( t_web.var_f83345c7 ) && self istouching( t_web ) && t_web.var_f83345c7 )
        {
            continue;
        }
...
// Size: 0x54
function function_e0f04a8a( n_delay_timer )
{
