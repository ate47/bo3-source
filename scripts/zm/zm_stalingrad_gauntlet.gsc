...
function function_48a9eab7()
{
    while ( true )
    {
        ...
        if ( !level flag::get( "egg_placed_in_hazard" ) )
        {
            ...
            level.var_de98e3ce.var_d54b9ade.mdl_egg = util::spawn_model( "p7_fxanim_zm_stal_dragon_incubator_egg_mod", self.stub.related_parent.origin + ( 0, 0, -40 ) );
...
function function_dcc4fd22()
{
    ...
    if ( self istouching( e_goal ) )
    {
        ...
        println( "<dev string:xc9>" + level.var_de98e3ce.var_179b5b71 + "<dev string:xdb>" + level.var_de98e3ce.var_a6563820 );
    }
}
