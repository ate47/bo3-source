...
/#
    ...
    function function_881d11a1( a_vh_turrets )
    {
        ...
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4b>", "<dev string:x6b>", 1, &devgui_skull_turret_skip_timeout );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x85>", "<dev string:xab>", 1, &function_1f8c58a1 );
    }
