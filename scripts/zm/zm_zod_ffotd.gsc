...
function main_end()
{
    ...
    if ( !zm_ffotd::optimize_for_splitscreen() )
    {
        ...
        spawncollision( "collision_player_wall_256x256x10", "collider", ( 2216, -4036, 254 ), ( 0, 270, 0 ) );
    ...
    if ( !zm_ffotd::optimize_for_splitscreen() )
    {
        spawncollision( "collision_clip_wedge_32x256", "collider", ( 4017, -4376, 224 ), ( 0, 90, 0 ) );
        ...
        spawncollision( "collision_utility_wall_128x128x10", "collider", ( 3156, -5642, 179 ), ( 0, 315, 0 ) );
    }
