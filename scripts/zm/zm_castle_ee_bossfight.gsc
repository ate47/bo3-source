...
function init() {
    ...
    /#
        ...
        level flag::init("tag_fx");
        level flag::init("face default");
        if (getdvarint("boss_weak_point_blocker") > 0) {
...
function function_1261fd50() {
    ...
    while (self.var_7e383b58 < 6) {
        /#
            ...
            if (level flag::get("tag_fx")) {
                self.var_7e383b58 = 4;
            }
            if (level flag::get("face default")) {
                self.var_7e383b58 = 5;
            }
        #/
...
/#
    ...
    function function_fb4ac7ae() {
        ...
        adddebugcommand("boss_start_tele_point");
