...
function init()
{
    ...
    /#
        ...
        level flag::init( "<dev string:x4e>" );
        
        if ( getdvarint( "<dev string:x61>" ) > 0 )
        {
    ...
    s_keeper_boss = spawnstruct();
    s_keeper_boss boss_fight_init();
    ...
    s_keeper_boss boss_fight_start();
    s_keeper_boss boss_fight_complete();
    s_keeper_boss function_1690ddb0();
...
function function_91a378e3()
{
    ...
    mdl_keeper = util::spawn_anim_model( "c_zom_dlc1_keeper_archon_small_fb", s_keeper.origin, ( 0, 90, 0 ) );
    wait 0.05;
    mdl_keeper ghost();
    wait 0.05;
...
// Size: 0x200
function get_unused_spawn_point( var_4a032429, var_f759b439, var_610499ec )
{
...
function function_1261fd50()
{
    ...
    while ( self.var_7e383b58 < 6 )
    {
        /#
            ...
            if ( level flag::get( "<dev string:x3b>" ) )
            {
                self.var_7e383b58 = 4;
            }
            
            if ( level flag::get( "<dev string:x4e>" ) )
            {
                self.var_7e383b58 = 5;
            }
        #/
...
function function_1b20ff86( var_5ed78a5f )
{
    ...
    p_random = array::random( level.activeplayers );
    angle = vectortoangles( p_random.origin - self.var_40b46e43.origin );
        ...
        case 5:
            ...
            /#
                if ( level flag::get( "<dev string:x4e>" ) )
                {
                    ...
                    self.var_41c1a53f[ 3 ] = &function_db1c6f68;
                    level flag::clear( "<dev string:x4e>" );
                }
            #/
...
function function_1dddcbf0()
{
    ...
    /#
        if ( level flag::get( "<dev string:x3b>" ) )
        {
            ...
            level flag::clear( "<dev string:x3b>" );
        }
    #/
...
function function_a77c2ade( var_70f504b7 )
{
    ...
    while ( var_76ecb142 < var_33efb6fa )
    {
        if ( !isdefined( self.var_29204bf[ var_ea42537d ] ) )
        {
            self thread function_36927923( var_c4ceda7e, p_random, var_ea42537d, undefined );
            var_76ecb142++;
        }
        else if ( self.var_29204bf[ var_ea42537d ].b_spawned === 0 )
        {
            self thread function_36927923( var_c4ceda7e, p_random, var_ea42537d, self.var_29204bf[ var_ea42537d ] );
            var_76ecb142++;
        }
...
function function_93570bbc( var_70f504b7 )
{
    ...
    var_eafe595f = 0;
    p_random = array::random( level.activeplayers );
    v_target = getclosestpointonnavmesh( p_random.origin + ( 128, 128, 0 ), 384 );
    ...
    v_target = getclosestpointonnavmesh( p_random.origin + ( 192, 0, 0 ), 384 );
...
/#
    ...
    function function_fb4ac7ae()
    {
        ...
        adddebugcommand( "<dev string:x234>" );
    ...
    function function_b68d06ec( cmd )
    {
        switch ( cmd )
        {
            case "<dev string:x304>":
                level flag::set( "<dev string:x318>" );
                wait 1;
                level flag::set( "<dev string:x334>" );
                break;
            case "<dev string:x349>":
                level flag::set( "<dev string:x318>" );
                wait 1;
                level flag::set( "<dev string:x352>" );
                wait 1.5;
                level notify( #"hash_3921dbad" );
                break;
            case "<dev string:x363>":
                level flag::set( "<dev string:x352>" );
                break;
            case "<dev string:x36e>":
                level flag::set( "<dev string:x352>" );
                level flag::set( "<dev string:x37f>" );
                level flag::set( "<dev string:x318>" );
                wait 1.5;
                level notify( #"hash_3921dbad" );
                level flag::set( "<dev string:x39c>" );
                break;
