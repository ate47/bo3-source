...
function main()
{
    ...
    level.custom_devgui = &zm_castle_devgui;
    ...
    level.zm_custom_spawn_location_selection = &castle_custom_spawn_location_selection;
...
{
    return isdefined( ai_enemy.b_flyin_done ) && ai_enemy.archetype == "mechz" && ( ai_enemy.archetype !== "mechz" || isdefined( ai_enemy ) && !issubstr( ai_enemy.classname, "keeper" ) && ai_enemy.b_flyin_done ) && !( isdefined( ai_enemy.var_1ea49cd7 ) && ai_enemy.var_1ea49cd7 ) && !( isdefined( ai_enemy.var_bce6e774 ) && ai_enemy.var_bce6e774 ) && !( isdefined( ai_enemy.in_gravity_trap ) && ai_enemy.in_gravity_trap ) && !( isdefined( ai_enemy.b_melee_kill ) && ai_enemy.b_melee_kill );
}
...
// Size: 0x16c
function castle_custom_spawn_location_selection( a_spots )
{
    if ( math::cointoss() )
    {
...
/#
    ...
    function super_sesame()
    {
        ...
        level flag::set( "<dev string:x8d>" );
        var_15ed352b = getentarray( "<dev string:xa4>", "<dev string:xb5>" );
        
        foreach ( t_pad_trigger in var_15ed352b )
        {
            t_pad_trigger delete();
        }
        
        level notify( #"pressure_pads_activated" );
        var_a6e47643 = struct::get_array( "<dev string:xc0>", "<dev string:xb5>" );
    ...
    {
        var_1143aa58 = getent( self.target, "<dev string:xb5>" );
        var_9ca35935 = self.script_noteworthy;
        level flag::set( var_9ca35935 );
        var_1143aa58 setmodel( "<dev string:xd8>" );
    }
