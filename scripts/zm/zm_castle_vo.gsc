...
function function_44c11f63()
{
    ...
    var_2e6638a7 = [];
    s_deathray = struct::get( "death_ray_button", "targetname" );
    var_d808cbab = spawn( "script_model", s_deathray.origin );
...
{
    assert( !isdefined( var_6e653641 ) || var_6e653641 < n_max, "<dev string:x14a>" );
