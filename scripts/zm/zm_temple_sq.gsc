...
function init() {
    ...
    namespace_abd6a8a5::init();
    namespace_435c2400::function_2387a156();
    ...
    namespace_d0f39865::init();
    namespace_44e3f385::init();
    namespace_f2fc2e52::init();
    namespace_a28ea140::init();
    namespace_7ea42b03::init();
    namespace_3335be::init();
    namespace_e30f98f8::init();
    namespace_6d88ee3a::init();
...
function function_6ad41e2e() {
    ...
    while (true) {
        amount, attacker, dir, point, mod = self.var_bbca234.var_4ba5f5f1 waittill(#"damage");
...
function function_b4c87a43() {
    self thread namespace_6d88ee3a::function_8cadb8d9();
}
...
function function_a63b1e99() {
    self thread namespace_a28ea140::function_fbbc8808();
}
...
function function_44229e01() {
    ...
    self thread namespace_e30f98f8::function_fbbc8808();
}
...
function function_f0b40ff2() {
    ...
    while (true) {
        ...
        if (!level.var_17714997 && level.var_305d1f14) {
            ...
            delay = 1;
            /#
                if (getplayers().size == 1 || getdvarint("M") == 2) {
                    delay = 10;
                }
            #/
            wait(delay);
...
function function_bb41e83b() {
    ...
    var_f6d46300 = getent("sq_anti_115", "targetname");
    var_f6d46300 show();
...
function function_37426445() {
    ...
    wall notsolid();
    var_f6d46300 = getent("sq_anti_115", "targetname");
    var_f6d46300 thread function_c4024977();
    var_f6d46300 playloopsound("zmb_meteor_loop");
    exploder::exploder("fxexp_520");
    trigger = spawn("trigger_radius_use", var_f6d46300.origin, 0, 32, 72);
    ...
    trigger delete();
    var_f6d46300 stoploopsound(1);
    var_f6d46300 notify(#"picked_up");
...
function function_251b8f40() {
    if (isdefined(self.trigger)) {
        namespace_e822cb43::function_d705d94f(self.trigger);
    ...
    self ghost();
    var_1e404668 = level waittill("raise_crystal_" + self.script_int);
    ...
    namespace_e822cb43::function_80738220(trigger);
...
function function_d7fe0309(num) {
    var_18d84fad = getentarray("sq_crystals", "targetname");
    for (i = 0; i < var_18d84fad.size; i++) {
        if (var_18d84fad[i].script_int == num) {
            return var_18d84fad[i];
        }
    }
}
...
function function_9301abe7(start, var_56f050bf) {
    ...
    level thread function_f5c88bbf(start, level.var_68f41fb4, var_56f050bf);
}
    ...
    if (isdefined(var_2ecbb0cd)) {
        for (i = 0; i < var_2ecbb0cd.size; i++) {
            if ("" + var_2ecbb0cd[i] == "M") {
                ...
                start playsound("evt_sq_bag_crystal_bounce_fail");
                function_9301abe7(start, var_56f050bf);
                break;
            } else if (function_5b24d5a1(var_2ecbb0cd[i])) {
                end = function_d7fe0309(var_2ecbb0cd[i]);
                start playsound("evt_sq_bag_crystal_bounce_correct");
                level thread function_f5c88bbf(start, end, var_56f050bf);
                start = end;
            } else {
                start playsound("evt_sq_bag_crystal_bounce_fail");
                function_9301abe7(start, var_56f050bf);
            ...
            if (var_56f050bf && isdefined(end) && isdefined(end.dynamite) && !isdefined(end.dynamite.dropped) && namespace_6e97c459::function_c0c0cab6("sq", "BaG")) {
                end.dynamite thread namespace_6d88ee3a::function_ee5cccb6();
            }
...
function function_2bfcbd0e() {
    self endon(#"death");
    while (true) {
        var_56f050bf = self waittill(#"hash_9622c92a");
        if (!level flag::get("gongs_resonating")) {
            var_56f050bf = 0;
        }
        if (!isdefined(level.var_ac3f0659)) {
            self.var_bbca234 thread function_e562bcb4(var_56f050bf);
        }
    }
}
...
function function_3129bf4e() {
    ...
    var_dc26cf5 = level.pack_a_punch.triggers[0].clip;
    var_dc26cf5 notsolid();
    var_dc26cf5 connectpaths();
