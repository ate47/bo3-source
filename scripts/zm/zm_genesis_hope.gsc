...
/#
    ...
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x82>", "<dev string:xc1>", 1, &function_7ecb414e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xd1>", "<dev string:xf4>", 1, &function_3246e71d );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x103>", "<dev string:x128>", 1, &function_3ff1131a );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x139>", "<dev string:x15d>", 1, &function_8070468 );
    }
