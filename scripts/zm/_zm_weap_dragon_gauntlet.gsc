...
function function_c0093887()
{
    ...
    while ( !( isdefined( self.var_cc844f4c ) && self.var_cc844f4c ) )
    {
        ...
        if ( !isdefined( level.var_163a43e4 ) || self adsbuttonpressed() && self getcurrentweapon() === self.weapon_dragon_gauntlet && !( isdefined( self.var_a0a9409e ) && self.var_a0a9409e ) && !is_in_array( self, level.var_163a43e4 ) )
        {
...
function function_fa885ef2( e_player, ai_enemy )
{
    ...
    if ( isdefined( e_player ) && isdefined( e_player.var_8afc8427 ) )
    {
        if ( isdefined( ai_enemy.heroweapon_kill_power ) )
        {
            ...
            e_player.var_8afc8427 += n_perk_factor * ai_enemy.heroweapon_kill_power;
