...
function perk_set_max_health_if_jugg( str_perk, set_premaxhealth, clamp_health_to_max_health )
{
    ...
    if ( isdefined( n_max_total_health ) )
    {
        ...
        {
            n_max_total_health += level.pers_jugg_upgrade_health_bonus;
        }
...
function perk_think( perk )
{
    ...
    if ( do_retain )
    {
        ...
        else if ( isdefined( self._retain_perks_array[ perk ] ) && isdefined( self._retain_perks_array ) && self._retain_perks_array[ perk ] )
        {
            return;
        }
    }
...
function perk_unpause( perk )
{
    ...
    for ( j = 0; j < getplayers().size ; j++ )
    {
        ...
        if ( isdefined( player.disabled_perks[ perk ] ) && isdefined( player.disabled_perks ) && player.disabled_perks[ perk ] )
        {
