...
/#
    ...
    function function_5efc91a4() {
        ...
        level flag::set("lockdown_zombie");
    }
...
function function_809fbbff(var_db0ac3dc) {
    ...
    /#
        println("pavlov_gate_collision" + var_e7a36389.script_string);
    #/
...
function function_d32eac7f() {
    ...
    default:
        /#
            assert(level.var_583e4a97.var_365bcb3c > 2, "sndEED");
        #/
        break;
    }
}
...
function function_6236d848(var_e57afa84, var_7741a4b8, var_ed686791, var_2a448c91, var_16b2096, var_adb8dbea, var_2b71b5b4, var_15eb9a52, var_f92c3865, var_af22dd13, var_ed448d3b, var_e25e1ccc, var_12e29bd4, var_84ea0b0f, var_3642df18, var_54939bf3) {
    ...
    if (isdefined(var_2b71b5b4)) {
        /#
            assert(isdefined(var_15eb9a52), "<unknown string>");
        #/
        /#
            assert(isdefined(var_f92c3865), "<unknown string>");
        #/
    }
    if (isdefined(var_af22dd13)) {
        /#
            assert(isdefined(var_ed448d3b), "<unknown string>");
        #/
        /#
            assert(isdefined(var_e25e1ccc), "<unknown string>");
        #/
    }
    if (isdefined(var_54939bf3) && var_54939bf3) {
        /#
            assert(isdefined(var_3642df18), "<unknown string>");
        #/
    }
    if (isdefined(var_e57afa84)) {
        /#
            assert(isdefined(var_7741a4b8), "<unknown string>");
        #/
        /#
            assert(isdefined(var_ed686791), "<unknown string>");
        #/
        /#
            assert(isdefined(var_2a448c91), "<unknown string>");
        #/
        /#
            assert(isdefined(var_16b2096), "<unknown string>");
        #/
        /#
            assert(isdefined(var_adb8dbea), "<unknown string>");
        #/
    } else {
        var_639b5936 = isdefined(var_2b71b5b4) || isdefined(var_af22dd13);
        /#
            assert(var_639b5936, "<unknown string>");
        #/
    }
