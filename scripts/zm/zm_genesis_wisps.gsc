...
// Size: 0x1c2
function function_719d3043( b_on, str_who )
{
    if ( !isdefined( b_on ) )
    {
        b_on = 1;
    ...
    if ( b_on )
    {
        assert( str_who == "<dev string:x35>" || str_who == "<dev string:x3a>", "<dev string:x3f>" );
...
// Size: 0x194
function function_26ed5998( b_on, str_who )
{
    if ( !isdefined( b_on ) )
    {
        b_on = 1;
...
/#
    ...
    {
        level thread zm_genesis_util::setup_devgui_func( "<dev string:xeb>", "<dev string:x11d>", 0, &function_d4b54e53 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x133>", "<dev string:x165>", 1, &function_d4b54e53 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x17b>", "<dev string:x1af>", 2, &function_d4b54e53 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x1c5>", "<dev string:x1f5>", 3, &function_d4b54e53 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x20b>", "<dev string:x234>", 0, &function_910a409b );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x244>", "<dev string:x26d>", 1, &function_910a409b );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x27d>", "<dev string:x2a8>", 2, &function_910a409b );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2b8>", "<dev string:x2df>", 3, &function_910a409b );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x2ef>", "<dev string:x31c>", 0, &function_920920c8 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x331>", "<dev string:x35f>", 1, &function_920920c8 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x374>", "<dev string:x3a4>", 2, &function_920920c8 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3b9>", "<dev string:x3e5>", 3, &function_920920c8 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x3fa>", "<dev string:x41d>", 1, &function_4701ab9e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x42c>", "<dev string:x44f>", 2, &function_4701ab9e );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x45e>", "<dev string:x487>", 1, &function_76a93e50 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x495>", "<dev string:x4be>", 2, &function_76a93e50 );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4cd>", "<dev string:x4ee>", 1, &function_eaebf31c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x4f9>", "<dev string:x51a>", 2, &function_eaebf31c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x525>", "<dev string:x540>", 0, &function_eaebf31c );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x54a>", "<dev string:x57c>", 0, &function_371c89ce );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x589>", "<dev string:x5be>", 1, &function_371c89ce );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x5cc>", "<dev string:x600>", 2, &function_371c89ce );
        level thread zm_genesis_util::setup_devgui_func( "<dev string:x60e>", "<dev string:x644>", 3, &function_371c89ce );
    }
    ...
    {
        a_str_dest = array( "<dev string:x658>", "<dev string:x66a>", "<dev string:x67c>", "<dev string:x68e>" );
        s_dest = struct::get( a_str_dest[ n_val ], "<dev string:x6a0>" );
    ...
    {
        a_str_dest = array( "<dev string:x6ca>", "<dev string:x6d6>", "<dev string:x6e2>", "<dev string:x6ee>" );
        s_dest = struct::get( a_str_dest[ n_val ] );
