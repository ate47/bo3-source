...
/#
    ...
    function function_4f46a12() {
        ...
        adddebugcommand("cin_t7_ai_zm_dlc2_spider_queen_backwall_outro");
    ...
    function function_10abb15e() {
        e_weapon = getweapon("<unknown string>");
    ...
    function swap_weapon(var_9f85aad5) {
        ...
        if (!self hasweapon(var_9f85aad5.rootweapon, 1)) {
            if (var_9f85aad5.type === "<unknown string>") {
    ...
    function function_f77f0da9() {
        ...
        var_6c9b76cd = self zm_perks::perk_give_bottle_begin("<unknown string>");
        str_notify = self util::waittill_any_return("<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>");
        if (str_notify == "<unknown string>") {
            self thread zm_perks::wait_give_perk("<unknown string>", 1);
        }
        self zm_perks::function_938ed54c(var_6c9b76cd, "<unknown string>");
    }
