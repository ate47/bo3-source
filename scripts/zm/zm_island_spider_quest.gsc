...
function function_83b9f02b()
{
    ...
    var_85683d05 thread spider_queen_killed();
...
/#
    ...
    function swap_weapon( wpn_new )
    {
        ...
        {
            if ( wpn_new.type === "<dev string:x432>" )
            {
    ...
    function function_f77f0da9()
    {
        ...
        e_gun = self zm_perks::perk_give_bottle_begin( "<dev string:x438>" );
        ...
        self zm_perks::perk_give_bottle_end( e_gun, "<dev string:x438>" );
    }
