...
function __main__()
{
    /#
        ...
        level scene::add_scene_func( "<dev string:x35>", &function_7e02b332, "<dev string:x4d>", 0 );
        level scene::add_scene_func( "<dev string:x52>", &function_7e02b332, "<dev string:x6a>", 1 );
    #/
...
function function_c5f1b67()
{
    ...
    while ( !isdefined( level.mdl_sophia ) )
    {
        wait 2;
        level.mdl_sophia = getent( "computer_sophia", "targetname" );
    }
    
    level.mdl_sophia hidepart( "slot_decoder_jnt" );
    level.mdl_sophia hidepart( "button_green_jnt" );
    level.mdl_sophia scene::init( "p7_fxanim_zm_stal_computer_sophia_code_door_open_bundle" );
}
...
function function_dbdd2358()
{
    ...
    for ( n_current_line = 0; n_current_line < 5 ; n_current_line++ )
    {
        ...
        level.mdl_sophia thread function_cbc0e672( var_1f76714[ n_current_line ], 1, str_notify );
...
function function_851880c()
{
    ...
    for ( var_5dac1aa3 = 0; var_5dac1aa3 < 9 ; var_5dac1aa3++ )
    {
        ...
        if ( var_5dac1aa3 < 9 )
        {
            ...
            level.mdl_sophia thread function_cbc0e672( var_f5badf05[ var_5dac1aa3 ], 1, str_notify );
            level waittill( str_notify );
        }
    }
}
...
function function_811523a8()
{
    ...
    for ( var_983c388b = 0; var_983c388b < 6 ; var_983c388b++ )
    {
        ...
        if ( var_983c388b < 6 && function_8d6e71cf() && math::cointoss() )
        {
            ...
            level.mdl_sophia thread function_cbc0e672( var_68a6b7a1[ var_983c388b ], 1, str_notify );
            level waittill( str_notify );
        }
    }
}
...
function function_8d6e71cf()
{
    ...
    {
        if ( e_player.characterindex == 2 && zm_utility::is_player_valid( e_player ) && !zm_stalingrad_util::function_86b1188c( 1000, e_player, level.mdl_sophia ) )
        {
            return true;
        }
    }
...
function function_957ac17d()
{
    ...
    n_current_line = 0;
    s_sophia = struct::get( "ee_sophia_struct", "targetname" );
    
    while ( n_current_line < 6 )
    {
        level function_fa7fbd4c( 1 );
        s_sophia waittill( #"trigger_activated", e_who );
        level function_fa7fbd4c( 0 );
...
function function_96953619()
{
    ...
    {
        n_index = i - 1;
        var_51a2f105 = level.mdl_sophia gettagorigin( "code_wheel_0" + i + "_jnt" );
...
{
    s_sophia = struct::get( "ee_sophia_struct", "targetname" );
    s_sophia function_6e3a6092( 100, "", 0 );
    level.mdl_sophia showpart( "slot_decoder_jnt" );
    level.mdl_sophia thread zm_stalingrad_vo::function_e4acaa37( "vox_soph_amsel_need_auth_0", 0, 1, 0, 1 );
    level.mdl_sophia scene::play( "p7_fxanim_zm_stal_computer_sophia_code_door_open_bundle" );
    level function_fa7fbd4c( 1 );
}
...
function function_c6d84fe1()
{
    ...
    while ( true )
    {
        ...
        level.mdl_sophia thread zm_stalingrad_vo::function_e4acaa37( "vox_soph_amsel_incorrect_0", 0, 1, 0, 1 );
        level waittill( #"between_round_over" );
        level function_fa7fbd4c( 1 );
    }
    
    level.mdl_sophia scene::play( "p7_fxanim_zm_stal_computer_sophia_code_door_close_bundle" );
...
function function_469f74c5()
{
    ...
    s_map_button = struct::get( "ee_map_button_struct", "targetname" );
    s_map_button zm_unitrigger::create_unitrigger( "" );
    
    while ( true )
    {
        s_map_button waittill( #"trigger_activated", e_who );
...
function function_72dd3113()
{
    ...
    var_f4570d42 = 0;
    s_map_button = struct::get( "ee_map_button_struct", "targetname" );
    level.var_f0d11538 = spawn( "script_origin", s_map_button.origin );
    
    /#
        if ( !isdefined( s_map_button.s_unitrigger ) )
        {
            s_map_button zm_unitrigger::create_unitrigger( "<dev string:x6f>" );
        }
    #/
    ...
    zm_unitrigger::unregister_unitrigger( s_map_button.s_unitrigger );
    s_map_button.s_unitrigger = undefined;
    s_map_button struct::delete();
...
{
    /#
        level.var_8b2f7f24 = "<dev string:x70>";
...
{
    /#
        level.var_8b2f7f24 = "<dev string:x9d>";
...
{
    /#
        level.var_8b2f7f24 = "<dev string:xa4>";
...
{
    /#
        level.var_8b2f7f24 = "<dev string:xa9>";
...
function function_18375f27( a_str_locations )
{
    ...
    /#
        ...
        {
            s_map_button = struct::get( "<dev string:xaf>", "<dev string:xc4>" );
            level.var_f0d11538 = spawn( "<dev string:xcf>", s_map_button.origin );
        }
    #/
...
{
    /#
        level.var_8b2f7f24 = "<dev string:xdd>";
...
{
    /#
        level.var_8b2f7f24 = "<dev string:xe4>";
    #/
...
function function_73e24bb9()
{
    ...
    text hud::setpoint( str_point, undefined, var_a84ec5dc, var_ce514045 );
    text.sort = -1;
    return text;
}
...
function function_914bd2ef()
{
    ...
    var_c6ca3fd9 = util::spawn_model( "veh_t7_dlc3_mech_nikolai_weapon_core", level.mdl_sophia gettagorigin( "tag_weapon_cores" ) + ( 0, 3, 2 ) );
    var_c6ca3fd9 setscale( 0.75 );
    level thread function_777295a0();
    level.mdl_sophia scene::play( "p7_fxanim_zm_stal_computer_sophia_core_door_open_bundle" );
    ...
    s_sophia = struct::get( "ee_sophia_struct", "targetname" );
    zm_unitrigger::unregister_unitrigger( s_sophia.s_unitrigger );
    s_sophia struct::delete();
}
...
function function_e0c4c3a8()
{
    ...
    while ( !level.mdl_sophia zm_stalingrad_util::function_1af75b1b( 500 ) )
    {
        wait 1;
    }
    ...
    level.mdl_sophia thread scene::play( "p7_fxanim_zm_stal_computer_sophia_leave_bundle" );
    level.mdl_sophia waittill( #"hash_6c477355" );
...
// Size: 0x2ec
function ee_outro( n_wait, b_dev )
{
    if ( !isdefined( n_wait ) )
    {
        n_wait = 0;
    ...
    mdl_mech = getent( "mech", "targetname" );
    mdl_mech clientfield::set( "post_outro_smoke", 1 );
...
{
    mdl_mech = a_ents[ "mech" ];
    mdl_mech hidepart( "tag_heat_vent_01_d0" );
    mdl_mech hidepart( "tag_heat_vent_02_d0" );
    mdl_mech hidepart( "tag_heat_vent_03_d0" );
    mdl_mech hidepart( "tag_heat_vent_04_d0" );
    mdl_mech hidepart( "tag_heat_vent_05_d0" );
...
// Size: 0xe2
function function_1c04ad71( b_lock )
{
    if ( !isdefined( b_lock ) )
    {
        b_lock = 1;
...
// Size: 0x1cc
function function_694a61ea( e_grabbed, var_c57c38fc )
{
...
function function_d9d36a17( str_model, str_hint, v_angles, var_c991b769 )
{
    ...
    while ( !level.mdl_sophia zm_stalingrad_util::function_1af75b1b( 250 ) )
    {
        wait 0.5;
    }
    
    level.mdl_sophia scene::play( "p7_fxanim_zm_stal_computer_sophia_drawer_open_bundle" );
    s_sophia = struct::get( "ee_sophia_struct", "targetname" );
    s_sophia function_6e3a6092( 100, str_hint, 0 );
    var_51a2f105 = level.mdl_sophia gettagorigin( "drawer_link_jnt" );
    var_b71f6be1 = util::spawn_model( str_model, var_51a2f105 + var_c991b769, v_angles );
    var_b71f6be1 linkto( level.mdl_sophia, "drawer_link_jnt" );
    var_b71f6be1 playsound( "zmb_scenarios_sophia_drawer_return" );
    wait 1;
    level.mdl_sophia scene::play( "p7_fxanim_zm_stal_computer_sophia_drawer_close_bundle" );
    var_b71f6be1 delete();
}
...
function function_fa7fbd4c( b_show )
{
    if ( b_show )
    {
        level.mdl_sophia showpart( "button_green_jnt" );
        level.mdl_sophia hidepart( "button_red_jnt" );
        level.mdl_sophia playsound( "zmb_scenarios_button_activate" );
        return;
    }
    
    level.mdl_sophia hidepart( "button_green_jnt" );
    level.mdl_sophia showpart( "button_red_jnt" );
}
...
/#
    ...
    function devgui_ee()
    {
        level thread function_a1f6ef06( "<dev string:xe9>", "<dev string:xfa>", 1, &function_4fdd3e35 );
        level thread function_a1f6ef06( "<dev string:x107>", "<dev string:x11b>", 1, &function_2ce0ea3d );
        level thread function_a1f6ef06( "<dev string:x12f>", "<dev string:x146>", 1, &function_96a879de );
        level thread function_a1f6ef06( "<dev string:x156>", "<dev string:x16c>", 1, &function_453d1020 );
        level thread function_a1f6ef06( "<dev string:x179>", "<dev string:x18e>", 1, &function_43beec5a );
        level thread function_a1f6ef06( "<dev string:x19e>", "<dev string:x1b6>", 1, &function_5879102a );
        level thread function_a1f6ef06( "<dev string:x1c6>", "<dev string:x1da>", 1, &function_2be548b9 );
        level thread function_a1f6ef06( "<dev string:x1ed>", "<dev string:x208>", 1, &function_8265c377 );
        level thread function_a1f6ef06( "<dev string:x219>", "<dev string:x23a>", 1, &function_da01ea0 );
        level thread function_a1f6ef06( "<dev string:x24d>", "<dev string:x26e>", 1, &function_d95ba8e4 );
        level thread function_a1f6ef06( "<dev string:x281>", "<dev string:x2a0>", 1, &function_81799b1b );
        level thread function_a1f6ef06( "<dev string:x2b1>", "<dev string:x2d1>", 1, &function_15b02c6d );
        level thread function_a1f6ef06( "<dev string:x2e3>", "<dev string:x304>", 1, &function_f8be6f86 );
        level thread function_a1f6ef06( "<dev string:x317>", "<dev string:x336>", 1, &function_126d3a92 );
        level thread function_a1f6ef06( "<dev string:x347>", "<dev string:x36a>", 1, &function_1b02c173 );
        level thread function_a1f6ef06( "<dev string:x380>", "<dev string:x3a6>", 1, &function_98be294 );
        level thread function_a1f6ef06( "<dev string:x3b8>", "<dev string:x3e1>", 1, &function_90a2468c );
        level thread function_a1f6ef06( "<dev string:x3f6>", "<dev string:x42c>", 1, &function_63ef4ccd );
        level thread function_a1f6ef06( "<dev string:x440>", "<dev string:x477>", 1, &function_474a5f0 );
        level thread function_a1f6ef06( "<dev string:x48c>", "<dev string:x4c9>", 1, &function_d810756e );
        level thread function_a1f6ef06( "<dev string:x4dd>", "<dev string:x51b>", 1, &function_400ba4a5 );
        level thread function_a1f6ef06( "<dev string:x530>", "<dev string:x566>", 1, &function_c25033fa );
        level thread function_a1f6ef06( "<dev string:x57a>", "<dev string:x5b2>", 1, &function_e6dcb4c9 );
        level thread function_a1f6ef06( "<dev string:x5c8>", "<dev string:x5e0>", 1, &function_e7aa9b86 );
        level thread function_a1f6ef06( "<dev string:x5f0>", "<dev string:x601>", 1, &function_9d07a3ef );
        level thread function_a1f6ef06( "<dev string:x612>", "<dev string:x627>", 1, &function_67c46c97 );
        level thread function_a1f6ef06( "<dev string:x63c>", "<dev string:x64a>", 1, &function_bbf6c2d0 );
        level thread function_a1f6ef06( "<dev string:x653>", "<dev string:x66c>", 1, &function_22557cc3 );
        level thread function_a1f6ef06( "<dev string:x67d>", "<dev string:x69e>", 1, &function_3de60ba3 );
        level thread function_a1f6ef06( "<dev string:x6af>", "<dev string:x6c5>", 1, &function_4f92d875 );
        level thread function_a1f6ef06( "<dev string:x6d6>", "<dev string:x6e7>", 1, &function_9b3c25cd );
        level thread function_a1f6ef06( "<dev string:x6f3>", "<dev string:x713>", 1, &function_ff112fdc );
        level thread function_a1f6ef06( "<dev string:x71f>", "<dev string:x733>", 1, &function_5446a1da );
        level thread function_a1f6ef06( "<dev string:x740>", "<dev string:x75f>", 1, &function_10f1fb15 );
        level thread function_a1f6ef06( "<dev string:x775>", "<dev string:x78d>", 1, &function_9cde71dd );
        level thread function_a1f6ef06( "<dev string:x79e>", "<dev string:x7ba>", 1, &function_bd5b4406 );
    }
    ...
    {
        level flag::set( "<dev string:x7cf>" );
    }
    ...
    {
        level flag::set( "<dev string:x7e1>" );
        level function_ef39c304( 1 );
    }
    ...
    function function_453d1020( n_value )
    {
        level flag::set( "<dev string:x7cf>" );
        wait 0.5;
        level flag::set( "<dev string:x7ee>" );
    }
    ...
    {
        level flag::set( "<dev string:x803>" );
    }
    ...
    function function_5879102a( n_value )
    {
        ...
        level flag::set( "<dev string:x818>" );
    }
    ...
    {
        level notify( #"hash_72a2fa02" );
        level flag::set( "<dev string:x826>" );
    }
    ...
    function function_98be294( n_value )
    {
        ...
        {
            level.var_9f752812 thread zm_utility::print3d_ent( "<dev string:x832>", ( 0, 1, 0 ), 3, ( 0, 0, 24 ) );
        }
    }
    ...
    function function_1b02c173( n_value )
    {
        if ( isdefined( level.var_a5fb1d00 ) )
        {
            ...
            level.var_a5fb1d00 thread zm_utility::print3d_ent( "<dev string:x832>", ( 0, 1, 0 ), 3, ( 0, 0, 24 ) );
        }
    }
    ...
    {
        a_str_locations = array( "<dev string:x834>", "<dev string:x83b>", "<dev string:x844>", "<dev string:x84c>", "<dev string:x852>", "<dev string:x859>" );
        a_str_locations = array::randomize( a_str_locations );
        level function_18375f27( a_str_locations );
    }
    ...
    {
        level.var_c47b244 = function_c5c5f391( "<dev string:x85e>", 1 );
    }
    ...
    {
        level.var_c47b244 = function_c5c5f391( "<dev string:x85e>", 2 );
    }
    ...
    {
        level.var_c47b244 = function_c5c5f391( "<dev string:x869>", 1 );
    }
    ...
    {
        level.var_c47b244 = function_c5c5f391( "<dev string:x869>", 2 );
    }
    ...
    {
        level.var_c47b244 = function_c5c5f391( "<dev string:x874>", 1 );
    }
    ...
    {
        level.var_c47b244 = function_c5c5f391( "<dev string:x874>", 2 );
    }
    ...
    {
        var_afe8026c = struct::get_array( "<dev string:x87f>", "<dev string:xc4>" );
    ...
    {
        var_fc275254 = "<dev string:x886>" + level.var_8b2f7f24 + "<dev string:x88a>";
    ...
    function function_e7aa9b86( n_value )
    {
        ...
        level flag::set( "<dev string:x894>" );
    }
    ...
    function function_9d07a3ef( n_value )
    {
        ...
        level notify( #"hash_deeb3634" );
        level clientfield::set( "<dev string:x8a7>", 0 );
        level flag::set( "<dev string:x8ba>" );
    }
    ...
    {
        level flag::set( "<dev string:x8d1>" );
    }
    ...
    function function_22557cc3( n_value )
    {
        level notify( #"hash_deeb3634" );
        level clientfield::set( "<dev string:x8a7>", 0 );
        exploder::stop_exploder( "<dev string:x8e0>" );
        level thread scene::play( "<dev string:x8ea>" );
        level thread zm_stalingrad_vo::function_ea234d37();
        level waittill( #"hash_34e4b03f" );
        level.mdl_sophia scene::play( "<dev string:x913>" );
    }
    ...
    {
        a_mdl_buttons = getentarray( "<dev string:x942>", "<dev string:x94b>" );
    ...
    {
        self scene::play( "<dev string:x958>", array( self ) );
        wait 5;
        self scene::play( "<dev string:x986>", array( self ) );
    }
    ...
    {
        s_capture_point = struct::get( "<dev string:x9b5>", "<dev string:xc4>" );
        var_663b2442 = zombie_utility::spawn_zombie( level.var_fda4b3f3[ 0 ], "<dev string:x9c6>", s_capture_point );
        var_663b2442 vehicle_ai::set_state( "<dev string:x9cf>" );
    ...
    {
        s_capture_point = struct::get( "<dev string:x9b5>", "<dev string:xc4>" );
        ai_raz = zombie_utility::spawn_zombie( level.var_6bca5baa[ 0 ], "<dev string:x9d8>", s_capture_point );
    ...
    {
        exploder::exploder( "<dev string:x9dc>" );
    }
    ...
    {
        exploder::exploder( "<dev string:x9e6>" );
    }
    ...
    {
        exploder::exploder( "<dev string:x9f0>" );
    }
    ...
    {
        exploder::exploder( "<dev string:x9fa>" );
    }
    ...
    function function_a1f6ef06( str_devgui_path, str_dvar, n_value, func, n_base_value )
    {
        ...
        str_devgui_path = "<dev string:xa04>" + str_devgui_path;
        adddebugcommand( "<dev string:xa16>" + str_devgui_path + "<dev string:xa23>" + str_dvar + "<dev string:xa27>" + n_value + "<dev string:xa29>" );
