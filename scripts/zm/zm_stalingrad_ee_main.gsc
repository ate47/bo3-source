...
function __main__() {
    /#
        if (getdvarint("ee_round") > 0) {
            level thread function_d6026710();
        }
        level scene::add_scene_func("tag_map_screen_glow_square", &function_7e02b332, "vox_soph_sophia_observes_", 0);
        level scene::add_scene_func("vox_soph_sophia_chatter_4", &function_7e02b332, "tag_buttons_off", 1);
    #/
...
function function_72dd3113() {
    ...
    /#
        if (!isdefined(var_385ae3a2.s_unitrigger)) {
            var_385ae3a2 zm_unitrigger::create_unitrigger("ee_generator_volume");
        }
    #/
    var_78d02c88 = getent("ee_map_shelf", "targetname");
...
function function_4769ea02() {
    /#
        level.var_8b2f7f24 = "sentinel_drone";
...
function function_62f0a233() {
    /#
        level.var_8b2f7f24 = "p7_zm_sta_wall_map_figure_04_drone";
...
function function_6a1cc377() {
    /#
        level.var_8b2f7f24 = "sewer_switch";
...
function function_18375f27(a_str_locations) {
    ...
    /#
        if (!isdefined(level.var_f0d11538)) {
            var_385ae3a2 = struct::get("ee_library_safe_debris", "zmb_scenarios_map_beep");
            level.var_f0d11538 = spawn("vox_soph_cargo_orders_repeat_0", var_385ae3a2.origin);
        }
    #/
    level.var_f0d11538 playsound("zmb_scenarios_map_scenario_select");
    for (i = 0; i < 4; i++) {
...
function function_21284834() {
    /#
        level.var_8b2f7f24 = "p7_conduit_metal_1_outlet_box";
...
function function_101e5b38() {
    /#
        level.var_8b2f7f24 = "ee_harasser";
    #/
...
/#
    ...
    function function_d6026710() {
        level thread function_a1f6ef06("ee_escort_failed", "factory_C_spawn_2", 1, &function_4fdd3e35);
        level thread function_a1f6ef06("ee_timed", "zmb_rigged_button_press_bad", 1, &function_2ce0ea3d);
        level thread function_a1f6ef06("ee_pursue_pre_capture", "zmb_scenario_torrent_start", 1, &function_96a879de);
        level thread function_a1f6ef06("ee_core_end_struct", "zmb_robo_eye_head_stop", 1, &function_453d1020);
        level thread function_a1f6ef06("black", "p7_fxanim_zm_stal_computer_sophia_drawer_open_bundle", 1, &function_43beec5a);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_5879102a);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_2be548b9);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_8265c377);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_da01ea0);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_d95ba8e4);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_81799b1b);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_15b02c6d);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_f8be6f86);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_126d3a92);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_1b02c173);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_98be294);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_90a2468c);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_63ef4ccd);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_474a5f0);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_d810756e);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_400ba4a5);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_c25033fa);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_e6dcb4c9);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_e7aa9b86);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_9d07a3ef);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_67c46c97);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_bbf6c2d0);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_22557cc3);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_3de60ba3);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_4f92d875);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_9b3c25cd);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_ff112fdc);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_5446a1da);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_10f1fb15);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_9cde71dd);
        level thread function_a1f6ef06("<unknown string>", "<unknown string>", 1, &function_bd5b4406);
    }
    ...
    function function_98be294(n_value) {
        if (isdefined(level.var_9f752812)) {
            level.var_9f752812 thread zm_utility::print3d_ent("<unknown string>", (0, 1, 0), 3, (0, 0, 24));
        }
    }
    ...
    function function_1b02c173(n_value) {
        if (isdefined(level.var_a5fb1d00)) {
            ...
            level.var_a5fb1d00 thread zm_utility::print3d_ent("<unknown string>", (0, 1, 0), 3, (0, 0, 24));
        }
    }
    ...
    function function_90a2468c(n_value) {
        a_str_locations = array("<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>");
        a_str_locations = array::randomize(a_str_locations);
        level function_18375f27(a_str_locations);
    }
    ...
    function function_63ef4ccd(n_value) {
        level.var_c47b244 = function_c5c5f391("<unknown string>", 1);
    }
    ...
    function function_474a5f0(n_value) {
        level.var_c47b244 = function_c5c5f391("<unknown string>", 2);
    }
    ...
    function function_c5c5f391(str_location, n_position) {
        var_afe8026c = struct::get_array("<unknown string>", "zmb_scenarios_map_beep");
    ...
    function function_8265c377(n_value) {
        var_fc275254 = "<unknown string>" + level.var_8b2f7f24 + "<unknown string>";
    ...
    function function_22557cc3(n_value) {
        ...
        level thread namespace_dcf9c464::function_ea234d37();
        level waittill(#"hash_34e4b03f");
        level.var_a090a655 scene::play("<unknown string>");
    }
    ...
    function function_3de60ba3(n_value) {
        var_7953b28 = getentarray("<unknown string>", "<unknown string>");
        foreach (var_c2d73a21 in var_7953b28) {
    ...
    function function_2ffdc89() {
        self scene::play("<unknown string>", array(self));
        wait(5);
        self scene::play("<unknown string>", array(self));
    }
    ...
    function function_4f92d875(n_value) {
        s_capture_point = struct::get("<unknown string>", "zmb_scenarios_map_beep");
        var_663b2442 = zombie_utility::spawn_zombie(level.var_fda4b3f3[0], "<unknown string>", s_capture_point);
        var_663b2442 vehicle_ai::set_state("<unknown string>");
    ...
    function function_9b3c25cd(n_value) {
        s_capture_point = struct::get("<unknown string>", "zmb_scenarios_map_beep");
        ai_raz = zombie_utility::spawn_zombie(level.var_6bca5baa[0], "<unknown string>", s_capture_point);
    ...
    function function_a1f6ef06(var_2fa24527, str_dvar, n_value, func, var_f0ee45c9) {
        ...
        var_2fa24527 = "<unknown string>" + var_2fa24527;
