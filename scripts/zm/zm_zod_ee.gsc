...
function function_c3466d96( b_on )
{
    ...
    if ( b_on )
    {
        for ( i = 0; i < 3 ; i++ )
        {
            ...
            mdl_clip.origin = s_keeper.origin + ( 0, 0, 48 );
...
function ee_boss()
{
    ...
    level.var_dbc3a0ef.mdl_shadowman clientfield::set( "boss_shield_fx", 1 );
    level.var_dbc3a0ef.mdl_shadowman playsound( "zmb_zod_shadfight_shield_up_short" );
...
// Size: 0x17c
function function_8f4b6b20( var_ee1ff130, b_is_devgui )
{
    if ( !isdefined( b_is_devgui ) )
    {
        b_is_devgui = 0;
    }
...
function function_4bcb6826()
{
    ...
    while ( true )
    {
        ...
        level.var_dbc3a0ef.mdl_shadowman playsound( "zmb_zod_shadfight_shield_down" );
        wait 3;
        level.var_dbc3a0ef.mdl_shadowman clientfield::set( "boss_shield_fx", 0 );
...
function function_c188d0b0()
{
    ...
    if ( isdefined( level.var_dbc3a0ef.mdl_shadowman ) )
    {
        level.var_dbc3a0ef.mdl_shadowman playsound( "zmb_zod_shadfight_shield_up" );
    }
}
...
function function_3fc4aca5()
{
    ...
    if ( isdefined( level.var_dbc3a0ef ) && isdefined( level.var_dbc3a0ef.mdl_shadowman ) )
    {
        level.var_dbc3a0ef.mdl_shadowman delete();
    }
...
function function_737ebab()
{
    ...
    while ( true )
    {
        ...
        {
            for ( n_wasps_alive = zm_ai_wasp::get_current_wasp_count(); n_wasps_alive >= 8 || n_wasps_alive >= level.players.size * 4 ; n_wasps_alive = zm_ai_wasp::get_current_wasp_count() )
            {
                wait randomfloatrange( 2, 4 );
            }
...
function function_83bdd16b()
{
    ...
    while ( true )
    {
        for ( n_raps_alive = zm_ai_raps::get_current_raps_count(); n_raps_alive >= 13 || n_raps_alive >= level.players.size * 4 ; n_raps_alive = zm_ai_raps::get_current_raps_count() )
        {
            wait randomfloatrange( 2, 4 );
        }
...
/#
    ...
    // Size: 0x664, Type: dev
    function ee_quest_devgui()
    {
        level thread zm_zod_util::setup_devgui_func( "<dev string:x55>", "<dev string:x74>", 1, &function_b44200f1 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x87>", "<dev string:xaf>", 1, &function_7a0bffae );
        level thread zm_zod_util::setup_devgui_func( "<dev string:xc3>", "<dev string:xeb>", 1, &function_54098545 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:xff>", "<dev string:x127>", 1, &function_d2f61efa );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x138>", "<dev string:x165>", 1, &function_bdd0041e );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x178>", "<dev string:x198>", 1, &function_932267b5 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x1ab>", "<dev string:x1d2>", 1, &function_3089f820 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x1e8>", "<dev string:x214>", 1, &function_fdcb978b );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x22a>", "<dev string:x214>", 2, &function_fdcb978b );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x256>", "<dev string:x214>", 3, &function_fdcb978b );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x282>", "<dev string:x2ae>", 1, &function_892e1f69 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x2c6>", "<dev string:x2ef>", 1, &function_656b9ef0 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x304>", "<dev string:x330>", 1, &function_690f9751 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x33f>", "<dev string:x362>", 1, &function_7787c089 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x373>", "<dev string:x362>", 2, &function_7787c089 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x399>", "<dev string:x362>", 3, &function_7787c089 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x3c0>", "<dev string:x3dd>", 1, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x3f0>", "<dev string:x3dd>", 2, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x40e>", "<dev string:x3dd>", 3, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x42b>", "<dev string:x3dd>", 4, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x449>", "<dev string:x3dd>", 5, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x468>", "<dev string:x3dd>", 6, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x488>", "<dev string:x3dd>", 7, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x4a8>", "<dev string:x3dd>", 8, &function_1c4c22d9 );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x4c9>", "<dev string:x4f7>", 1, &function_2a306df );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x511>", "<dev string:x4f7>", 2, &function_2a306df );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x549>", "<dev string:x4f7>", 3, &function_2a306df );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x580>", "<dev string:x4f7>", 4, &function_2a306df );
        level thread zm_zod_util::setup_devgui_func( "<dev string:x5b5>", "<dev string:x4f7>", 5, &function_2a306df );
    }
...
function function_2a306df( n_val )
{
    switch ( n_val )
    {
        ...
        case 2:
            ...
            wait 3;
            level.shadowman.mdl_shadowman clientfield::set( "boss_shield_fx", 0 );
            break;
        case 3:
            break;
        case 4:
