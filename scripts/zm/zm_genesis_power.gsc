...
function function_9cc9b090( e_attacker )
{
    ...
    {
        level thread zombie_blood_soul_streak_fx( self.origin + ( 0, 0, 60 ), self.angles, self.var_a6e673dd, 2 );
    }
    
    if ( isdefined( level.var_a6e673dd ) )
    {
        level thread zombie_blood_soul_streak_fx( self.origin + ( 0, 0, 60 ), self.angles, level.var_a6e673dd.origin, 2 );
