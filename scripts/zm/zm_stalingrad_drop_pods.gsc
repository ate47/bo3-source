...
{
    if ( isdefined( self.no_powerups ) && ( isdefined( self.b_cleaned_up ) && self.b_cleaned_up || isdefined( level.var_583e4a97.var_caa5bc3e ) || level flag::get( "drop_pod_spawned" ) || level flag::get( "drop_pod_active" ) || self.no_powerups ) )
    {
        return 0;
    }
...
{
    if ( isdefined( self.b_cleaned_up ) && self.b_cleaned_up || self.archetype === "sentinel_drone" )
    {
        return;
    }
    ...
    e_pod = level.var_8cc024f2.mdl_pod;
