...
function function_94bb84a1(var_e7a36389, var_51d4ce0d) {
    ...
    if (!var_51d4ce0d) {
        /#
            iprintlnbold("zmInventory.piece_cylinder");
            if (level.var_583e4a97.var_365bcb3c >= 3 && !level flag::get("factory1")) {
                iprintlnbold("drop_pod_hp_light");
            }
        #/
        mdl_pod = level.var_8cc024f2.mdl_pod;
        var_2d41c802 = level.var_8cc024f2.var_2d41c802;
...
function function_737e2ef4() {
    ...
    if (self istouching(e_goal)) {
        ...
        /#
            println("zmb_pod_alarm_health_critical" + level.var_8cc024f2.n_current_progress + "axis" + level.var_3947d49c);
        #/
