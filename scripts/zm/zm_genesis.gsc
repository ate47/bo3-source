...
/#
    ...
    function function_e26adf8d(player, ip1) {
        weapon_name = "p7_fxanim_zm_gen_apoth_corpt_engine_pillar_mod";
        adddebugcommand("octobomb" + player.name + "burp" + ip1 + "vox_plr_0_exert_burp_4" + weapon_name + "vox_plr_0_exert_burp_6" + ip1 + "vox_plr_2_exert_pain_2" + weapon_name + "vox_plr_2_exert_pain_4");
        weapon_name = "vox_plr_3_exert_pain_3";
        adddebugcommand("vox_plr_0_exert_cough_0" + player.name + "burp" + ip1 + "vox_plr_0_exert_burp_4" + weapon_name + "vox_plr_0_exert_burp_6" + ip1 + "vox_plr_2_exert_pain_2" + weapon_name + "vox_plr_2_exert_pain_4");
        weapon_name = "vox_plr_0_exert_underwater_gasp_1";
        adddebugcommand("vox_plr_3_exert_underwater_gasp_1" + player.name + "burp" + ip1 + "vox_plr_0_exert_burp_4" + weapon_name + "vox_plr_0_exert_burp_6" + ip1 + "vox_plr_2_exert_pain_2" + weapon_name + "vox_plr_2_exert_pain_4");
        weapon_name = "boss_fight";
        adddebugcommand("connect_prototype_start_to_upstairs" + player.name + "burp" + ip1 + "vox_plr_0_exert_burp_4" + weapon_name + "vox_plr_0_exert_burp_6" + ip1 + "vox_plr_2_exert_pain_2" + weapon_name + "vox_plr_2_exert_pain_4");
    }
...
function function_9160f4d3() {
    ...
    if (var_bbe5e3fe > 0 && var_8643fc8a <= var_bbe5e3fe) {
        ...
        /#
            assert(var_e632342f > 0, "<unknown string>");
        #/
    }
    return sp_zombie;
}
...
function givecustomcharacters() {
    ...
    /#
        if (getdvarstring("<unknown string>") != "<unknown string>") {
            self.characterindex = getdvarint("<unknown string>");
        }
    #/
