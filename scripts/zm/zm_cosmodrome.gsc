...
function main()
{
    ...
    /#
        ...
        level.custom_devgui = &cosmodrome_devgui;
        setup_devgui();
    #/
...
/#
    ...
    // Size: 0x21a, Type: dev
    function cosmodrome_devgui( cmd )
    {
        level.var_6708aa9c = 0;
        cmd_strings = strtok( cmd, "<dev string:x7a>" );
    ...
    function function_9d5d7bb3( choose )
    {
        ...
        if ( isdefined( level.var_93621cb ) )
        {
            ...
            if ( choose == 0 )
            {
                ...
                {
                    perk_attack_anim = level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ][ "<dev string:xc2e>" ];
                }
            }
            else if ( choose == 1 )
            {
                if ( isdefined( level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ] ) )
                {
                    perk_attack_anim = level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ][ "<dev string:xc34>" ];
                }
            }
            else if ( choose == 2 )
            {
                if ( isdefined( level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ] ) )
                {
                    perk_attack_anim = level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ][ "<dev string:xc39>" ];
                }
            }
            else if ( choose == 3 )
            {
                if ( isdefined( level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ] ) )
                {
                    perk_attack_anim = level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ][ "<dev string:xc42>" ];
                }
            }
            else if ( choose == 4 )
            {
                if ( isdefined( level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ] ) )
                {
                    perk_attack_anim = level.monkey_perk_attack_anims[ target_trigger.script_noteworthy ][ "<dev string:xc48>" ];
                }
            }
            ...
            attack_spots = struct::get_array( target_trigger.machine.target, "<dev string:xc52>" );
            spot = undefined;
    ...
    function function_a15d765e( spot, perk_attack_anim )
    {
        ...
        if ( isdefined( spot ) )
        {
            while ( true )
            {
                ...
                level.var_93621cb animscripted( "<dev string:xc5d>", spot.origin, spot.angles, perk_attack_anim );
                wait time;
            }
        }
    }
