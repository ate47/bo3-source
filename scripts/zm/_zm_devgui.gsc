...
/#
    ...
    function devgui_add_weapon( weapon, upgrade, hint, cost, weaponvo, weaponvoresp, ammo_cost )
    {
        ...
        {
            devgui_add_weapon_and_attachments( weapon.name, "<dev string:x40>", "<dev string:x69f>" );
            return;
        }
        
        devgui_add_weapon_and_attachments( weapon.name, "<dev string:x40>", "<dev string:x40>" );
    }
    ...
    function zombie_weapon_devgui_think()
    {
        ...
        level.zombie_devgui_att = getdvarstring( "<dev string:x71f>" );
    ...
    function devgui_bot_spawn( team )
    {
        ...
        yaw = direction[ 1 ];
        bot thread devgui_bot_spawn_think( trace[ "<dev string:x1530>" ], yaw );
    }
    ...
    function zombie_devgui_debug_pers( index )
    {
        ...
        println( "<dev string:x16a5>" + level.pers_upgrades_keys.size + "<dev string:x16c8>" );
        ...
        for ( pers_upgrade_index = 0; pers_upgrade_index < level.pers_upgrades_keys.size ; pers_upgrade_index++ )
        {
            ...
            println( pers_upgrade_index + "<dev string:x16ca>" + name );
            pers_upgrade = level.pers_upgrades[ name ];
            ...
            for ( i = 0; i < pers_upgrade.stat_names.size ; i++ )
            {
                ...
                println( "<dev string:x16e0>" + i + "<dev string:x1709>" + player_current_stat_value );
            }
    ...
    {
        vending_triggers = getentarray( "<dev string:x181f>", "<dev string:x133b>" );
        level.devcheater = 1;
