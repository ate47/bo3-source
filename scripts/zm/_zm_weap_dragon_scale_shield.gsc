...
function should_shield_absorb_damage( einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime )
{
    if ( isdefined( self.hasriotshield ) && self.hasriotshield )
    {
        if ( isdefined( eattacker.is_elemental_zombie ) && isdefined( self.hasriotshieldequipped ) && self.hasriotshieldequipped && smeansofdeath == "MOD_EXPLOSIVE" && isdefined( eattacker ) && eattacker.is_elemental_zombie && eattacker.var_9a02a614 === "napalm" )
        {
            return 1;
        }
