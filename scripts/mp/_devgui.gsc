...
/#
    ...
    function __init__()
    {
        ...
        level.acv_cycling_dvars[ level.acv_cycling_dvars.size ] = "<dev string:x23c>";
        level.acv_cycling_dvars[ level.acv_cycling_dvars.size ] = "<dev string:x254>";
        level.acv_cycling_dvars[ level.acv_cycling_dvars.size ] = "<dev string:x26c>";
        level.acv_cycling_dvars[ level.acv_cycling_dvars.size ] = "<dev string:x284>";
        level.acv_cycling_dvars[ level.acv_cycling_dvars.size ] = "<dev string:x29c>";
        level.acv_cycling_dvars[ level.acv_cycling_dvars.size ] = "<dev string:x2b4>";
    ...
    function devgui_player_weapons()
    {
        ...
        menu_index++;
        acv_devgui_base_mp = player_devgui_base_mp + "<dev string:x3fa>" + "<dev string:x40c>";
        menu_index++;
        acv_menu_index = 1;
        ...
        for ( i = 0; i <= 3 ; i++ )
        {
            adddebugcommand( acv_devgui_base_mp + "<dev string:x40e>" + "<dev string:x40c>" + i + "<dev string:x2eb>" + "<dev string:xb9>" + "<dev string:x2f3>" + i + "<dev string:x41c>" );
            acv_sub_menu_index++;
        }
        ...
        for ( i = 0; i < attachmentnames.size ; i++ )
        {
            ...
            function_27141585();
            adddebugcommand( acv_devgui_base_mp + "<dev string:x425>" + "<dev string:x40c>" + attachmentnames[ i ] + "<dev string:x2eb>" + "<dev string:xea>" + "<dev string:x2f3>" + attachmentnames[ i ] + "<dev string:x41c>" );
            acv_sub_menu_index++;
        }
        ...
        for ( i = 0; i < attachmentnames.size ; i++ )
        {
            ...
            function_27141585();
            adddebugcommand( acv_devgui_base_mp + "<dev string:x432>" + "<dev string:x40c>" + attachmentnames[ i ] + "<dev string:x2eb>" + "<dev string:x127>" + "<dev string:x2f3>" + attachmentnames[ i ] + "<dev string:x41c>" );
            acv_sub_menu_index++;
        }
    ...
    {
        old_index = 0;
        old_attachment_1 = "<dev string:x122>";
        old_attachment_2 = "<dev string:x122>";
        
        for ( ;; )
        {
            index = getdvarint( "<dev string:xb9>" );
            attachment_1 = getdvarstring( "<dev string:xea>" );
            attachment_2 = getdvarstring( "<dev string:x127>" );
    ...
    function devgui_update_attachment_cosmetic_variant( attachment_1, attachment_2 )
    {
        ...
        assert( isalive( self ) );
        currentweapon = self getcurrentweapon();
        variant_index = getdvarint( "<dev string:xb9>" );
