...
function main()
{
    ...
    spawncollision( "collision_clip_wall_64x64x10", "collider", ( 1580.5, -180.5, 141 ), ( 0, 270, 0 ) );
    spawncollision( "collision_clip_wall_64x64x10", "collider", ( 1640, -180.5, 141 ), ( 0, 270, 0 ) );
