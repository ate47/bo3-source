...
function main()
{
    ...
    level.allow_vehicle_challenge_check = 1;
    function_f0cb6507();
...
function vehicle_spawner_init( veh_spawner_id, veh_name, origin, angles )
{
    ...
    var_e208fe99.fx_red = spawnfx( "vehicle/fx_siegebot_spawn_teleport_light_red", var_7b0a32fb, forward, up );
    level.var_f0d5ca04[ veh_spawner_id ] = var_e208fe99;
    level thread function_938a8c2b( veh_spawner_id, 1 );
}
...
// Size: 0xc4
function function_938a8c2b( veh_spawner_id, delay )
{
    wait delay;
    triggerfx( level.var_f0d5ca04[ veh_spawner_id ].var_96997dd6 );
    triggerfx( level.var_f0d5ca04[ veh_spawner_id ].fx_red );
    wait 0.1;
    level.var_f0d5ca04[ veh_spawner_id ].var_96997dd6 hide();
    level.var_f0d5ca04[ veh_spawner_id ].fx_red hide();
}
...
// Size: 0xc4
function vehicle_about_to_spawn( veh_spawner_id, veh_name, origin, angles, var_d47ecfec )
{
    playfx( "vehicle/fx_siegebot_spawn_teleport", origin, anglestoforward( angles ), anglestoup( angles ) );
    level.var_f0d5ca04[ veh_spawner_id ].fx_red hide();
    level thread function_8464fee5( veh_spawner_id, veh_name, origin, angles, var_d47ecfec );
}
...
// Size: 0x1dc
function function_8464fee5( veh_spawner_id, veh_name, origin, angles, var_d47ecfec )
{
    remaining_time = float( var_d47ecfec );
    var_35c1d8a6 = level.var_f0d5ca04[ veh_spawner_id ].var_96997dd6;
    
    while ( remaining_time >= 0.2 )
    {
        playsoundatposition( "evt_siegepad_yellow", level.var_f0d5ca04[ veh_spawner_id ].var_96997dd6.origin + ( 0, 0, 10 ) );
        var_35c1d8a6 show();
...
{
    level.var_f0d5ca04[ veh_spawner_id ].fx_red show();
    playsoundatposition( "evt_siegepad_red", level.var_f0d5ca04[ veh_spawner_id ].fx_red.origin + ( 0, 0, 10 ) );
}
