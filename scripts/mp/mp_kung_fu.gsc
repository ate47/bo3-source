...
function main()
{
    ...
    spawncollision( "collision_clip_wall_32x32x10", "collider", ( 43.5, 3073, 207 ), ( 0, 270, 0 ) );
    ...
    spawncollision( "collision_clip_32x32x32", "collider", ( -712, 2387.5, 138 ), ( 0, 0, 0 ) );
...
{
    trigger = spawn( "trigger_radius", ( 3.5, 3155.5, 155 ), 0, 80, 200 );
