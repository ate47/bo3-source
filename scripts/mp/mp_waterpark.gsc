...
function main()
{
    ...
    spawncollision( "collision_clip_wall_128x128x10", "collider", ( -656.104, -395.497, 314.493 ), ( 14, 237, -8 ) );
...
function spawnkilltrigger()
{
    ...
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( -201.964, -534.052, -25.5276 ), 0, 125, 200 );
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( -60.8686, -583.028, -25.5276 ), 0, 125, 200 );
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( 81.691, -595.348, -25.5276 ), 0, 125, 200 );
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( 232.691, -556.348, -25.5276 ), 0, 125, 200 );
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( 321.691, -524.348, -25.5276 ), 0, 125, 200 );
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( 1003.01, -552.034, 267.349 ), 0, 200, 128 );
    trigger thread watchkilltrigger();
    trigger = spawn( "trigger_radius", ( 1313.41, -491.234, 267.349 ), 0, 200, 128 );
    trigger thread watchkilltrigger();
}
