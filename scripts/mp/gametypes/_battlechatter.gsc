...
function say_kill_battle_chatter( attacker, weapon, victim, inflictor )
{
    ...
    else if ( isdefined( attacker.gadget_camo_off_time ) && ( attacker _gadget_camo::camo_is_inuse() || attacker.gadget_camo_off_time + mpdialog_value( "camoKillTime", 0 ) * 1000 >= gettime() ) )
    {
...
function game_end_vox( winner )
{
    ...
    gameisdraw = level.teambased && ( !isdefined( winner ) || winner == "tie" );
