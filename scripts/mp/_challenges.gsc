...
function challengekills( data )
{
    ...
    if ( !isdefined( killstreak ) )
    {
        ...
        {
            if ( attacker_slide_begin > attacker_slide_end || attacker_doublejump_begin > attacker_doublejump_end || attacker_doublejump_end + 3000 > time || attacker_slide_end + 3000 > time )
            {
        ...
        if ( isdefined( player.primaryloadoutaltweapon ) && ( isdefined( player.primaryloadoutweapon ) && weapon == player.primaryloadoutweapon || weapon == player.primaryloadoutaltweapon ) )
        {
        ...
        else if ( isdefined( player.secondaryloadoutaltweapon ) && ( isdefined( player.secondaryloadoutweapon ) && weapon == player.secondaryloadoutweapon || weapon == player.secondaryloadoutaltweapon ) )
        {
