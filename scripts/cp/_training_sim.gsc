            ...
            for ( i = 0; i < n_count ; i++ )
            {
                ...
                while ( true )
                {
                    ...
                    if ( isdefined( e_spawned ) )
                    {
                        ...
                        {
                            v_origin = get_spawn_location( e_spawned, self.s_beacon.origin, var_8e7d3ece );
                        }
...
// Size: 0x622
function get_spawn_location( e_spawned, v_pos, var_8e7d3ece )
{
            ...
            if ( !getdvarint( "tu1_trainingSimDisableTeleport", 1 ) )
            {
                if ( var_f2053c49 >= 450 * 450 && var_77f64226 >= 450 * 450 && var_fba032a4 >= 300 * 300 )
                {
                    ...
                    else if ( gettime() > self.var_c9a40973 )
                    {
                        ...
                        v_origin += anglestoright( player.s_beacon.angles ) * randomfloatrange( -150, 150 );
