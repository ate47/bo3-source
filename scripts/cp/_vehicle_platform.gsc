...
class class_fa0d90fd {
    ...
    function function_9cdfa1cb(var_d5b66a0) {
        ...
        /#
            assert(isdefined(open_struct), "<unknown string>" + var_d5b66a0.origin);
        #/
        /#
            assert(isdefined(open_struct.target), "<unknown string>" + var_d5b66a0.origin);
        #/
        var_f0bc435f = struct::get(open_struct.target, "targetname");
        /#
            assert(isdefined(var_f0bc435f), "<unknown string>" + var_d5b66a0.origin);
        #/
    ...
    function function_99848f4e(var_87b2bbe5) {
        ...
        /#
            assert(isdefined(self.var_e0473e16), "<unknown string>" + var_87b2bbe5);
        #/
    ...
    function init(var_e6d08de, var_87b2bbe5) {
        ...
        /#
            assert(isdefined(self.var_6c951b00), "<unknown string>" + self.var_950bb2b2 + "<unknown string>");
        #/
        ...
        foreach (var_4efa37e7 in self.var_1a144436) {
            ...
            if (var_4efa37e7.classname == "script_brushmodel") {
                /#
                    assert(!isdefined(self.var_86d0e1a0), "<unknown string>" + self.var_950bb2b2);
                #/
