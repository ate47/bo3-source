...
/#
    ...
    function function_81f84c9c(str_objective, var_74cd64bc) {
        ...
        namespace_63b4601c::function_b87f9c13(str_objective, var_74cd64bc);
        namespace_63b4601c::function_66773296("CP_MI_SING_VENGEANCE_INTRO_LINE_2_FULL", str_objective);
        level.var_2fd26037 ai::set_ignoreall(1);
        level.var_2fd26037 ai::set_ignoreme(1);
        level.var_2fd26037.goalradius = 32;
        level.var_2fd26037 battlechatter::function_d9f49fba(0);
        level flag::wait_till("set_breadcrumb_apartment1");
        objectives::set("apt_door_r_clip", struct::get("cin_ven_01_intro_3rd_sh060"));
        level flag::set("strip_video_start");
    ...
    function function_616e9ab6(str_objective, var_74cd64bc) {
        ...
        objectives::set("apt_door_r_clip", struct::get("cin_ven_01_intro_3rd_sh060"));
        level flag::set("strip_video_start");
        setdvar("syncshot_lookat_trigger", "apartment_enemy_dead");
        wait(1);
        if (level.activeplayers.size == 1) {
            setdvar("syncshot_lookat_trigger", "ffim1_all_of_you_have_liv_0");
        }
        wait(1);
        level thread takedown_main();
        level waittill(#"hash_ee2ef2f3");
    ...
    function function_6fa5f384() {
        ...
        foreach (player in level.var_7cd6979b) {
            if (isdefined(player.pers) && isdefined(player.pers["ffim1_no_one_s_left_to_sav_0"]) && player.pers["ffim1_no_one_s_left_to_sav_0"] == 1) {
        ...
        if (level.activeplayers.size >= 2) {
            if (getdvarstring("fciv_crying_hysterically_0") === "chair_a_clip") {
                foreach (player in level.var_7cd6979b) {
                    if (isdefined(player.pers) && (!isdefined(player.pers) || player.pers["ffim1_no_one_s_left_to_sav_0"] == undefined)) {
        ...
        if (level.activeplayers.size >= 3) {
            if (getdvarstring("fciv_crying_hysterically_0") === "waypoint_intro6") {
                foreach (player in level.var_7cd6979b) {
                    if (isdefined(player.pers) && (!isdefined(player.pers) || player.pers["ffim1_no_one_s_left_to_sav_0"] == undefined)) {
        ...
        if (level.activeplayers.size == 4) {
            if (getdvarstring("fciv_crying_hysterically_0") === "takedown_gate_left") {
                foreach (player in level.var_7cd6979b) {
                    if (isdefined(player.pers) && (!isdefined(player.pers) || player.pers["ffim1_no_one_s_left_to_sav_0"] == undefined)) {
