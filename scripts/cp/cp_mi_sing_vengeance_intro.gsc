...
function function_b3c6efd1()
{
    level flag::wait_till( "player_near_apartment_stairs" );
    wait 0.5;
    level.ai_hendricks notify( #"player_near_apartment_stairs" );
    level thread function_cce1e811();
    level.ai_hendricks waittill( #"plyr_once_we_find_her_n_0" );
...
function function_a5bf9c17( bedroom_audio_origin )
{
    ...
    bedroom_audio_origin = getent( "bedroom_audio_origin", "targetname" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim1_what_are_you_going_t_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "mciv_leave_us_alone_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim2_no_no_he_s_mine_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim2_death_will_be_quick_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "mciv_what_s_wrong_with_yo_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim1_you_did_plenty_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim1_all_of_you_have_liv_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim2_tell_her_goodbye_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "mciv_no_0" );
    wait 2;
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim3_now_it_s_your_turn_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim1_no_one_s_left_to_sav_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim3_i_want_a_piece_of_he_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim3_you_ll_get_them_one_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim2_the_last_one_died_to_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim1_is_that_your_daughte_0" );
    bedroom_audio_origin vengeance_util::function_5fbec645( "ffim2_i_bet_she_s_soft_0" );
}
...
function function_4bd6211( bedroom_audio_origin )
{
    ...
    while ( true )
    {
        ...
        bedroom_audio_origin vengeance_util::function_5fbec645( random_vo );
...
function hendricks_takedown_vo()
{
    ...
    level.ai_hendricks waittill( #"plyr_this_is_what_happens_0" );
...
function function_caf96976()
{
    ...
    takedown_enemy_leader_audio_origin vengeance_util::function_5fbec645( "ffim1_today_we_rise_agains_0" );
    takedown_enemy_leader_audio_origin vengeance_util::function_5fbec645( "ffim1_these_things_do_not_0" );
    takedown_enemy_leader_audio_origin vengeance_util::function_5fbec645( "ffim1_do_not_make_it_quick_0" );
    takedown_enemy_leader_audio_origin vengeance_util::function_5fbec645( "ffim1_they_are_the_oppress_0" );
    takedown_enemy_leader_audio_origin vengeance_util::function_5fbec645( "ffim1_every_drop_of_their_0" );
    takedown_enemy_leader_audio_origin vengeance_util::function_5fbec645( "ffim1_today_the_immortals_0" );
    takedown_enemy_leader_audio_origin thread vengeance_util::function_5fbec645( "ffim2_yeaaaaahhh_an_0" );
    takedown_enemy_leader_audio_origin thread vengeance_util::function_5fbec645( "ffim3_death_to_the_oppress_0" );
    takedown_enemy_leader_audio_origin thread vengeance_util::function_5fbec645( "ffif0_aaaahhhhhh_0" );
    takedown_enemy_leader_audio_origin thread vengeance_util::function_5fbec645( "ffim2_immorrrtaalllls_0" );
}
...
function function_8b1bdf0e()
{
    ...
    level.ai_hendricks notify( #"takedown_enemies_dead" );
}
...
/#
    ...
    function function_81f84c9c( str_objective, b_starting )
    {
        ...
        vengeance_util::skipto_baseline( str_objective, b_starting );
        vengeance_util::init_hero( "<dev string:x28>", str_objective );
        level.ai_hendricks ai::set_ignoreall( 1 );
        level.ai_hendricks ai::set_ignoreme( 1 );
        level.ai_hendricks.goalradius = 32;
        level.ai_hendricks battlechatter::function_d9f49fba( 0 );
