...
// Size: 0x4d4
function increment( str_accolade, n_val, var_50f65478 )
{
    if ( !isdefined( n_val ) )
    {
        n_val = 1;
    ...
    /#
        ...
        {
            var_cacb0169 = tablelookupistring( "<dev string:x28>", 4, str_accolade, 5 );
...
function private function_115de864()
{
    ...
    foreach ( str_accolade, s_accolade in level.accolades )
    {
        ...
        var_aa6073.award_xp = function_7efd1da3( str_accolade );
        self function_50f58bd0( str_accolade, var_aa6073 );
    }
...
/#
    ...
    function function_1ea616fe()
    {
        ...
        if ( !isdefined( level.accolades ) || isdefined( self.var_ab872594 ) || !isdefined( self savegame::get_player_data( "<dev string:x7a>" ) ) )
        {
            return;
        }
        ...
        foreach ( str_accolade, s_accolade in level.accolades )
        {
            if ( var_c74eaab3 % 7 == 6 )
            {
                ...
                y += 73;
                var_c74eaab3 = 1;
                var_c06a516a = str_accolade + "<dev string:x95>";
                ...
                var_16bed2ea = self function_520227e6( s_accolade.index ) + "<dev string:x95>";
                continue;
            }
    ...
    while ( true )
    {
        ...
        foreach ( e_player in level.players )
        {
            foreach ( str_accolade, s_accolade in level.accolades )
            {
                ...
                if ( isdefined( var_89eb65c1 ) && ( s_accolade.index == 2 || var_89eb65c1 ) && isdefined( var_dd586ee5 ) )
                {
...
function commit( map_name )
{
    ...
    if ( isarray( self savegame::get_player_data( "accolades" ) ) )
    {
        foreach ( str_accolade, s_accolade in level.accolades )
        {
            accolade = self function_4f9d8dec( str_accolade );
