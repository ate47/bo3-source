...
function function_6e45ce5d( params )
{
    ...
    {
        params.eattacker.iffowner notify( #"accolade_4_increment" );
        return;
    }
...
function function_109e560b()
{
    ...
    if ( self.archetype === "human_riotshield" )
    {
        ...
        while ( !isdefined( self.var_66202c1f ) )
        {
            ...
            if ( s_type === "MOD_RIFLE_BULLET" || s_type === "MOD_PISTOL_BULLET" || isplayer( e_attacker ) && s_type === "MOD_HEAD_SHOT" )
            {
                self.var_66202c1f = 1;
            }
        }
...
function function_436940b1( params )
{
    if ( self.archetype === "robot" )
    {
        ...
        if ( isdefined( params.eattacker.iffowner ) && params.eattacker.archetype === "amws" && isplayer( params.eattacker.iffowner ) )
        {
            params.eattacker.iffowner notify( #"accolade_13_increment" );
        }
    }
}
