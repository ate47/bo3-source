...
function function_2b89d912( landing_zone )
{
    ...
    self.pvtol cleartargetyaw();
    self.pvtol notsolid();
    safeheight = self.pvtol.origin[ 2 ];
    ...
    self.pvtol stopanimscripted( 0 );
    self.pvtol ghost();
    self.pvtol.origin = ( self.pvtol.origin[ 0 ], self.pvtol.origin[ 1 ], safeheight );
...
function exterior_aerial_threats()
{
    ...
    while ( true )
    {
        ...
        while ( !var_736c8af )
        {
            sp_safe = array::random( aerial_enemy_spawners );
            ...
            foreach ( player in level.activeplayers )
            {
                ...
                if ( sighttracepassed( e_test gettagorigin( str_tag ), sp_safe.origin, 0, player ) )
                {
                    var_736c8af = 0;
                    break;
                }
        ...
        veh = vehicle::_vehicle_spawn( sp_safe );
        veh.crashtype = "explode";
