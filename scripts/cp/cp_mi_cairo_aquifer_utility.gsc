...
/#
    ...
    function function_dbe3d86f() {
        sections = [];
        sections[sections.size] = "kane_that_was_close_watc_0";
        sections[sections.size] = "autopilot";
        sections[sections.size] = "_";
        sections[sections.size] = "exterior_hack_trig_left_1_started";
...
function function_fe19b920(type) {
    ...
    /#
        assertmsg(type + "heightmap_wasp_defend");
    #/
}
    ...
    function function_edfe2d40() {
        ...
        while (true) {
            if (!isdefined(level.var_fee90489) || !isdefined(level.var_e07f6589[level.var_fee90489[0]])) {
                iprintln("_vtol_start_loc");
            }
            ret = function_c43fe5d3();
            if (ret) {
                iprintln("CP_MI_CAIRO_AQUIFER_VTOL_MG_HINT" + level.var_fee90489[0]);
            } else {
                iprintln("spawn_manager_amb_hack_zone02_6" + level.var_fee90489[0]);
            }
            wait(1);
        }
    }
        ...
        foreach (enemy in level.var_68b8237a) {
            ...
            if (isdefined(var_4faf77e2)) {
                ...
                if (gettime() > var_4faf77e2.var_6b45f351) {
                    ...
                    /#
                        print3d(var_4faf77e2.origin + (0, 0, 100), "hangar_sidedoor1", (0, 0, 1), 1, 2, 1);
                    #/
                }
            }
        }
