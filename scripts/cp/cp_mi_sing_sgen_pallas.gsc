...
// Size: 0xb8
function pallas_init( b_doppelganger )
{
    if ( !isdefined( b_doppelganger ) )
    {
        b_doppelganger = 0;
    }
...
function elevator_set_door_state( str_side, str_state )
{
    ...
    if ( !( e_lift.a_e_doors[ str_side ].str_state === str_state ) )
    {
        ...
        e_lift.a_e_doors[ str_side ] movez( n_zvalue, 3.94737, 3.94737 * 0.1, 3.94737 * 0.25 );
...
function elevator_set_shaft_state( str_state )
{
    ...
    if ( !( e_lift.a_e_shaft_doors[ "left" ].str_state === str_state ) )
    {
        foreach ( e_shaft_door in e_lift.a_e_shaft_doors )
        {
            ...
            e_shaft_door moveto( e_shaft_door.origin + v_move_value, 3.94737, 3.94737 * 0.1, 3.94737 * 0.25 );
        }
    }
}
...
function elevator_set_move_direction( str_direction )
{
    ...
    e_lift movez( n_zvalue, 48.6111, 48.6111 * 0.1, 48.6111 * 0.25 );
...
function handle_pallas_pillar_weakspot()
{
    ...
    while ( true )
    {
        ...
        playfx( level._effect[ "coolant_tower_unleash" ], e_pallas_pillar.origin + ( 0, 0, -250 ) );
...
function function_e8ee435e()
{
    ...
    wait 0.1;
    level notify( #"all_suicide_bots_killed" );
}
...
// Size: 0x112
function detonate_robots( b_immediate )
{
