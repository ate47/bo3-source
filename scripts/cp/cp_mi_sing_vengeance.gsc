...
function setup_skiptos()
{
    ...
    /#
        skipto::add_dev( "<dev string:x28>", &vengeance_intro::function_616e9ab6, "<dev string:x3d>" );
        skipto::add_dev( "<dev string:x4f>", &vengeance_intro::function_8771151f, "<dev string:x64>" );
        skipto::add_dev( "<dev string:x76>", &vengeance_intro::function_7d5fbc40, "<dev string:x8b>" );
    #/
