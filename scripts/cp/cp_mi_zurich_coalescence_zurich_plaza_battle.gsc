...
function skipto_main( str_objective, b_starting )
{
    ...
    level thread function_9590c294( b_starting );
    ...
    zurich_util::function_1b3dfa61( "plaza_battle_train_exit_breadcrumb_struct_trig", undefined, 180, 1000 );
    ...
    trigger::wait_till( "plaza_battle_enter_hq_gathertrig", undefined, level.ai_kane );
    ...
    level.ai_kane thread zurich_util::function_4fb68dd5();
...
function skipto_done( str_objective, b_starting, b_direct, player )
{
    ...
    if ( !b_starting )
    {
        level.ai_kane thread zurich_util::function_fe5160df( 0 );
    }
...
function function_5ea42950()
{
    ...
    ai_hunter = spawner::simple_spawn_single( "zurich_ambient_hunter", &function_c89b08c9, nd_spline );
    ai_hunter waittill( #"death" );
...
function function_4e20543d()
{
    ...
    var_56f344e5 = zurich_util::get_num_scaled_by_player_count( n_base, 18 );
    ...
    wait 0.05;
    var_bd24b897 = zurich_util::get_num_scaled_by_player_count( 10, 5 );
...
{
    self.script_health = zurich_util::get_num_scaled_by_player_count( int( self.health * 8 ), int( self.health / 2 ) );
    self colors::disable();
...
function function_d297683e()
{
    ...
    self colors::disable();
    wait 0.05;
    n_chance = zurich_util::get_num_scaled_by_player_count( 30, 25 );
...
function siegebot_callback_damage( einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal )
{
    if ( isdefined( level.var_7ebc8836 ) && isai( eattacker ) )
    {
        ...
        {
            var_df4257db = zurich_util::get_num_scaled_by_player_count( 5, -1 );
...
function function_da51418e( a_ents )
{
    ...
    level dialog::player_say( "plyr_we_ll_see_about_that_0" );
...
function function_5e886797()
{
    ...
    level dialog::player_say( "plyr_you_still_with_me_k_0", 1 );
    level.ai_kane dialog::say( "kane_i_m_still_with_you_0", 1 );
}
...
function function_d9c927f6()
{
    ...
    level dialog::player_say( "plyr_i_don_t_know_if_you_1", 1 );
    level dialog::player_say( "plyr_it_s_not_too_late_to_0", 1 );
    level dialog::player_say( "plyr_give_yourself_up_and_0", 1 );
    level dialog::player_say( "plyr_you_know_me_you_can_0", 1 );
}
...
function function_c89b08c9( var_9c1a7bea )
{
    ...
    self setignoreent( level.ai_kane, 1 );
...
function function_29fa5d37()
{
    ...
    self setignoreent( level.ai_kane, 1 );
    self quadtank_util::function_35209d64();
...
{
    level.ai_boss = self;
    self.mdl_goal = util::spawn_model( "tag_origin", self gettagorigin( "tag_target_upper" ), self gettagangles( "tag_target_upper" ) );
    self.mdl_goal linkto( self, "tag_target_upper", ( 0, 0, 256 ) );
...
// Size: 0x11c
function function_9590c294( b_starting )
{
    ...
    level.ai_kane thread function_9d42d43b();
    function_e87739b();
    function_9c800460();
    function_c2827ec9();
    function_808ee2d6();
...
function function_e87739b()
{
    ...
    a_t_spawn = getentarray( "plaza_battle_siegebot_back_spawn_trig", "targetname" );
    
    foreach ( t_spawn in a_t_spawn )
    {
        trigger::add_function( t_spawn, undefined, &function_55a7a759, a_t_spawn );
    }
    ...
    vh_vtol = spawner::simple_spawn_single( "plaza_vtol_back_nocrew", &vtol_spawnfunc );
...
// Size: 0xa2
function function_55a7a759( a_t_spawn )
{
    wait 2;
...
function function_9c800460()
{
    ...
    spawn_manager::set_global_active_count( 15 );
    ...
    vh_vtol = spawner::simple_spawn_single( "plaza_vtol_back", &vtol_spawnfunc );
...
function function_a30a9296()
{
    ...
    spawn_manager::set_global_active_count( 20 );
}
...
function function_c2827ec9()
{
    ...
    var_b1df9263 = zurich_util::get_num_scaled_by_player_count( 1.5, -0.5 );
    var_1c97712d = zurich_util::get_num_scaled_by_player_count( 2, -0.5 );
...
function function_b727abb6()
{
    ...
    wait 21;
    spawn_manager::set_global_active_count( 8 );
    var_b1df9263 = zurich_util::get_num_scaled_by_player_count( 1, -0.2 );
    var_1c97712d = zurich_util::get_num_scaled_by_player_count( 1.5, -0.2 );
    level thread zurich_util::function_27904cd4( "plaza_battle_robot_spawn_station_left", "plaza_battle", undefined, undefined, var_b1df9263, var_1c97712d );
    level thread zurich_util::function_27904cd4( "plaza_battle_robot_spawn_station_right", "plaza_battle", undefined, undefined, var_b1df9263, var_1c97712d );
    level thread zurich_util::function_27904cd4( "plaza_battle_robot_spawn_station_left2", "plaza_battle", undefined, undefined, var_b1df9263, var_1c97712d );
    level thread zurich_util::function_27904cd4( "plaza_battle_robot_spawn_station_right2", "plaza_battle", undefined, undefined, var_b1df9263, var_1c97712d );
...
{
    level endon( #"plaza_battle_exit_cleared" );
    a_str_vtols = array( "plaza_vtol_front", "plaza_vtol_back" );
    
    for ( vh_vtol = spawner::simple_spawn_single( "plaza_vtol_front", &vtol_spawnfunc ); true ; vh_vtol = spawner::simple_spawn_single( array::random( a_str_vtols ), &vtol_spawnfunc ) )
    {
...
// Size: 0xa4
function function_f058728a( ai_kane )
{
    self endon( #"death" );
    level endon( #"plaza_battle_cleared" );
    self waittill( #"trigger" );
    ai_kane colors::enable();
    ai_kane colors::set_force_color( self.script_string );
    var_12e44341 = getentarray( "plaza_battle_kane_choose_trig", "targetname" );
...
function function_9d42d43b()
{
    ...
    level.ai_kane setgoal( getnode( "plaza_battle_kane_door_node", "targetname" ), 1 );
    level flag::wait_till( "blast_doors_opened" );
...
{
    level endon( #"hash_1fc32e88" );
    level thread zurich_util::spawn_phalanx( var_cdbd94b1, "phanalx_wedge", 3, 1, 6, "plaza_battle_train_exit_reached", 1 );
...
{
    level endon( #"hash_1fc32e88" );
    level thread zurich_util::spawn_phalanx( var_7680f4ba, "phanalx_wedge", 3, 1, 7, "plaza_battle_train_exit_reached", 1 );
    level flag::wait_till_timeout( 10, "plaza_battle_artillery_intro_stop" );
    spawner::waittill_ai_group_ai_count( "robot_phalanx", 4 );
    level flag::set( "plaza_battle_front_defenses_broken" );
...
function function_695f38a7()
{
    ...
    self ai::set_ignoreall( 0 );
    level flag::wait_till( "plaza_battle_hunter_destroyed" );
    a_ai_wasps = spawn_manager::get_ai( "plaza_battle_boss_wasp_spawn_manager" );
    var_8ba55d7b = spawn_manager::get_ai( "plaza_battle_boss_wasp_spawn_manager" );
    a_ai_wasps = arraycombine( a_ai_wasps, var_8ba55d7b, 0, 0 );
    array::thread_all( a_ai_wasps, &function_5a1e5a49 );
    ...
    var_8ba55d7b = spawn_manager::get_ai( "plaza_battle_boss_wasp_spawn_manager" );
    a_ai_wasps = arraycombine( a_ai_wasps, var_8ba55d7b, 0, 0 );
    array::thread_all( a_ai_wasps, &function_c4b462a7 );
}
...
function function_2686975a()
{
    ...
    for ( nd_last = undefined; true ; nd_last = var_2ef061f7[ var_2ef061f7.size - 1 ] )
    {
        do
        {
...
function function_e1159e2b()
{
    ...
    self.mdl_goal = util::spawn_model( "tag_origin", self gettagorigin( "tag_target_upper" ), self gettagangles( "tag_target_upper" ) );
    self.mdl_goal linkto( self, "tag_target_upper", ( 0, 0, 256 ) );
    self.mdl_goal.script_objective = "plaza_battle";
    level.ai_boss = self;
    self thread function_2686975a();
}
...
function function_d645af75()
{
    ...
    foreach ( ai in var_a44ce9b5 )
    {
        if ( isalive( ai ) )
        {
            ...
            t_goal = getent( str_goal, "targetname" );
            ai setgoal( t_goal );
        }
    }
}
...
function function_d1db5654()
{
    ...
    do
    {
        var_965f3899 = int( zurich_util::get_num_scaled_by_player_count( 3, -0.5 ) );
...
function function_baaaa286()
{
    ...
    foreach ( ai_wasp in a_ai_wasps )
    {
        if ( !( isdefined( ai_wasp.is_attacking ) && ai_wasp.is_attacking ) )
        {
            ai_wasp.is_attacking = 1;
            ...
            ai_wasp setentitytarget( self );
            ai_wasp setgoal( self.var_439c885e, 1 );
            return;
        }
    }
}
...
{
    self setgoal( level.ai_boss.mdl_goal, 0, 400, 96 );
}
...
{
    self setgoal( level.ai_hunter, 0, 128, 32 );
}
...
{
    t_goal = getent( "plaza_battle_wasp_goaltrig", "targetname" );
...
function function_a2b45d70()
{
    ...
    while ( true )
    {
        self waittill( #"damage", _, _, _, _, _, _, _, _, w_attacker );
        
        if ( w_attacker === var_b711578c )
        {
...
/#
    ...
    function function_6744b8e3( var_4d75b06, e_target, n_radius, v_color )
    {
        if ( isdefined( e_target ) && isdefined( var_4d75b06 ) )
        {
            ...
            {
                e_target thread zurich_util::debug_draw_line( e_target, var_4d75b06, undefined, v_color, "<dev string:xac>" );
            }
