...
function function_87d295ed( params )
{
    if ( isplayer( params.eattacker ) )
    {
        if ( params.smeansofdeath === "MOD_MELEE" || params.smeansofdeath === "MOD_MELEE_ASSASSINATE" || params.smeansofdeath === "MOD_MELEE_WEAPON_BUTT" || params.weapon === level.cybercom.electro_strike.human_weapon )
        {
            player = params.eattacker;
...
{
    if ( isdefined( self.melee_monitor_execute ) && ( isplayer( params.eattacker ) || self.melee_monitor_execute == 1 ) )
    {
