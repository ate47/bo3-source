...
// Size: 0x36c
function recordcpendgamecomscoreeventforplayer( player, result )
{
...
function callback_playerdisconnect()
{
    ...
    recordcpendgamecomscoreeventforplayer( self, "disconnected" );
    ...
    else if ( smeansofdeath == "MOD_MELEE" || smeansofdeath == "MOD_MELEE_ASSASSINATE" )
    {
        if ( weapon.isriotshield )
        {
            ...
            if ( isdefined( attacker.class_num ) )
            {
                ...
                if ( secondaryweaponnum && level.tbl_weaponids[ secondaryweaponnum ][ "reference" ] == "riotshield" && ( primaryweaponnum && level.tbl_weaponids[ primaryweaponnum ][ "reference" ] == "riotshield" && !secondaryweaponnum || !primaryweaponnum ) )
                {
...
function callback_playerkilled( einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration )
{
    ...
    if ( !( isdefined( level.var_d59daf8 ) && level.var_d59daf8 ) || !died_in_vehicle && !hit_by_train && level.players.size > 1 )
    {
