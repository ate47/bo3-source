...
function callback_actorkilled( einflictor, eattacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime )
{
    ...
    if ( isdefined( level.overrideammodropteam3 ) && level.overrideammodropteam3 && ( isdefined( level.overrideammodropallies ) && level.overrideammodropallies && self.team == "allies" || self.team == "team3" ) || isplayer( eattacker ) && self.team == "axis" )
    {
