...
{
    curmapname = doa_arena::function_d2d75f5d();
    
    if ( isdefined( level.doa.var_602737ab ) && ( curmapname == "boss" && level.doa.arena_round_number == 3 || level.doa.var_602737ab ) )
    {
    ...
    if ( isdefined( level.doa.var_bae65231 ) && ( curmapname == "cave" && level.doa.arena_round_number == 0 || level.doa.var_bae65231 ) )
    {
...
function function_1de9db1b( name )
{
    switch ( name )
    {
        case "margwa":
            ...
            {
                player notify( #"bossEventComplete" );
            }
