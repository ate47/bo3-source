...
function main()
{
    ...
    doa_sound::init();
    doa_score::init();
    doa_camera::function_d22ceb57( ( 75, 0, 0 ), 600 );
    doa_pickups::init();
    ...
    clientfield::register( "world", "killweather", 1, 1, "counter", &doa_arena::killweather, 0, 0 );
    clientfield::register( "world", "killfog", 1, 1, "counter", &doa_arena::killfog, 0, 0 );
    ...
    clientfield::register( "world", "arenaRound", 1, 3, "int", &doa_arena::arenaRound, 0, 0 );
    ...
    clientfield::register( "actor", "burnType", 1, 2, "int", &doa_fx::burnType, 0, 0 );
    clientfield::register( "actor", "burnZombie", 1, 1, "counter", &doa_fx::burnZombie, 0, 0 );
...
function function_cd844947( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    if ( low & 1 )
    {
        level.doa.arenas[ level.doa.current_arena ].var_7526f3f5 += ( 0, 0, 10 );
    }
    ...
    if ( low & 2 )
    {
        level.doa.arenas[ level.doa.current_arena ].var_7526f3f5 += vectorscale( forward, 10 );
    }
    ...
    if ( low & 4 )
    {
        level.doa.arenas[ level.doa.current_arena ].var_7526f3f5 += vectorscale( right, 10 );
    }
...
function function_12c2fbcb()
{
    ...
    if ( !isdefined( self.doa ) )
    {
        ...
        if ( self islocalplayer() )
        {
            self.cameramode = doa_arena::function_9f1a0b26( 0 );
        }
