...
function function_e68e3c0d( localclientnum, name, off, tag, kill )
{
    ...
    {
        /#
            doa_core::debugmsg( "<dev string:x87>" + ( isdefined( self.name ) ? self.name : "<dev string:x90>" ) + "<dev string:x94>" + name + "<dev string:x9f>" + ( isdefined( tag ) ? tag : "<dev string:xa6>" ) + "<dev string:xb1>" + ( off ? "<dev string:xb6>" : "<dev string:xbc>" ) + "<dev string:xc1>" + localclientnum );
        #/
    }
