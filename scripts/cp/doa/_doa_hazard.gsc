...
function function_1cb931df( def, var_3d19d2b1 )
{
    ...
    while ( isdefined( spot ) && var_3d19d2b1 )
    {
        ...
        for ( angle = randomint( 180 ); var_3d19d2b1 ; angle = randomint( 180 ) )
        {
            if ( var_485dfece == 0 )
            {
                origin = baseorigin;
...
function function_d8d20160()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        while ( isdefined( self ) )
        {
            ...
            /#
                doa_utility::debugmsg( "<dev string:x4a>" + damage + "<dev string:x5e>" + meansofdeath + "<dev string:x68>" + self.health );
            #/
