...
function function_5e04bf78()
{
    ...
    silverback thread doa_fx::function_285a2999( "boss_takeoff" );
    silverback thread doa_fx::function_285a2999( "crater_dust" );
    ...
    org.origin = point3.origin + ( 0, 0, 2000 );
    ...
    while ( rounds )
    {
        ...
        if ( rounds % 10 == 0 )
        {
            ...
            faketarget = spawn( "script_model", target.origin + ( 0, 0, 32 ) );
    ...
    org thread doa_fx::function_285a2999( "def_explode" );
    org moveto( point3.origin + ( 0, 0, 2500 ), 2 );
...
function function_d834fdd0()
{
    level endon( #"podiumalldone" );
    level waittill( #"hash_71c0bde9" );
    level.doa.var_e102b46 thread doa_fx::function_285a2999( "bomb" );
...
{
    self endon( #"death" );
    self thread doa_fx::function_285a2999( "bomb" );
...
function function_2b20420b( podium )
{
    ...
    switch ( podium.position )
    {
        case 0:
            ...
            dropspot = level.doa.var_e102b46.origin + ( 0, 0, 600 );
...
function function_1aaa038( droporigin )
{
    ...
    while ( qty )
    {
        if ( mayspawnentity() )
        {
            ...
            gem thread doa_sound::function_90118d8c( "zmb_gem_quieter" );
            qty--;
            util::wait_network_frame();
            continue;
        }
...
function function_d040f4a6( podium )
{
    ...
    wait 1;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_1stplace_2" );
    function_46882430( &"DOA_WOOO", offset );
    function_46882430( &"DOA_WELL_HELLO", offset, 2 );
    wait 1;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_1stplace_3" );
    ...
    wait 1;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_1stplace_4" );
...
function function_1b6034b2( podium )
{
    ...
    wait 1;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_2ndplace_2" );
    function_46882430( &"DOA_FUN", offset );
    wait 1;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_2ndplace_3" );
...
function function_87082601( podium )
{
    ...
    wait 3;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_3rdplace_2" );
    function_46882430( &"DOA_NEXTTIME", offset );
    wait 6;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_3rdplace_3" );
...
function function_b7bde10a( podium )
{
    ...
    wait 3;
    playermodel thread doa_sound::function_90118d8c( "zmb_end_4thplace_2" );
...
function function_4d8b6e1e()
{
    ...
    {
        for ( j = i; j > 0 && int( players[ j - 1 ] doa_score::getplayerscore() ) < int( players[ j ] doa_score::getplayerscore() ) ; j-- )
        {
