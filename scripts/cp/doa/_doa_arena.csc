...
function function_61e2e743()
{
    ...
    return level.doa.arenas[ level.doa.current_arena ].camheight;
}
...
function restart()
{
    ...
    level.doa.var_1a75d02b = 1;
    level.doa.flipped = 0;
    doa_camera::function_d22ceb57( ( 75, 0, 0 ), function_61e2e743() );
...
function flipcamera( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    switch ( level.doa.var_1a75d02b )
    {
        ...
        case 1:
            level.doa.flipped = 0;
            doa_camera::function_d22ceb57( function_c530afc5( ( 75, 0, 0 ) ), function_61e2e743() );
        ...
        case 2:
            level.doa.flipped = 1;
            doa_camera::function_d22ceb57( function_c530afc5( ( 75, 180, 0 ) ), function_61e2e743() );
...
function function_9f1a0b26( var_c3479584 )
{
    ...
    cameramode = level.doa.arenas[ level.doa.current_arena ].var_ecf7ec70;
...
function arenaRound( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    /#
        doa_core::debugmsg( "<dev string:xa2>" + level.doa.var_1a3f3152 + "<dev string:xb8>" + localclientnum );
    #/
...
function setarena( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    /#
        doa_core::debugmsg( "<dev string:xcb>" + level.doa.arenas[ level.doa.current_arena ].name + "<dev string:xda>" + level.doa.arenas[ newval ].name );
    #/
    ...
    {
        doa_camera::function_d22ceb57( undefined, function_61e2e743() );
    }
...
{
    var_46caea66 = level.doa.var_1a75d02b == 1 ? ( 75, 0, 0 ) : ( 75, 180, 0 );
    doa_camera::function_d22ceb57( function_c530afc5( var_46caea66 ), function_61e2e743() );
    level function_43141563( localclientnum );
}
