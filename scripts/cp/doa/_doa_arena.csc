...
function init() {
    ...
    for (i = 0; i < arenas.size; i++) {
        ...
        if (isdefined(var_5fabae4f) && isdefined(var_5fabae4f.script_parameters)) {
            ...
            /#
                assert(isdefined(campos.size == 3), "temple" + arena.name + "<unknown string>");
            #/
        ...
        if (isdefined(var_5fabae4f) && isdefined(var_5fabae4f.script_noteworthy)) {
            ...
            /#
                assert(isdefined(var_b5091c96.size == 3), "temple" + arena.name + "<unknown string>");
            #/
...
function function_836d1e22(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
    ...
    /#
        namespace_693feb87::debugmsg("<unknown string>" + level.doa.var_1a3f3152 + "<unknown string>" + localclientnum);
    #/
...
function setarena(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump) {
    ...
    /#
        namespace_693feb87::debugmsg("<unknown string>" + level.doa.arenas[level.doa.var_90873830].name + "<unknown string>" + level.doa.arenas[newval].name);
    #/
