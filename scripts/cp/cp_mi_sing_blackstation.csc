...
{
    clientfield::register( "actor", "kill_target_keyline", 1, 4, "int", &keyline_activation, 0, 0 );
    ...
    clientfield::register( "toplayer", "player_rain", 1, 3, "int", &rain_on_player, 0, 0 );
    clientfield::register( "toplayer", "rumble_loop", 1, 1, "int", &callback_toggle_rumble_loop, 0, 0 );
    ...
    clientfield::register( "world", "water_level", 1, 3, "int", &water_level_manager, 0, 0 );
...
function function_967477f8( localclientnum, var_2d166751 )
{
    ...
    filter::init_filter_sgen_sprite_rain( localplayer );
}
...
// Size: 0x20c
function rain_on_player( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    if ( newval )
    {
        switch ( newval )
...
// Size: 0x124
function keyline_activation( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    self endon( #"entityshutdown" );
...
// Size: 0xce
function water_level_manager( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    switch ( newval )
    {
        case 1:
...
// Size: 0x8c
function callback_toggle_rumble_loop( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    if ( newval )
    {
...
function setup_skiptos()
{
    ...
    skipto::add( "objective_subway", &skipto_subway_init );
    ...
    skipto::add( "objective_blackstation_interior", &skipto_init );
    skipto::add( "objective_end_igc", &skipto_init );
}
...
// Size: 0x94
function function_a796eb5e( str_objective, b_starting )
{
...
// Size: 0x34
function function_40b9b738( str_objective, b_starting )
{
...
// Size: 0x9c
function function_39bffbde( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_42c55e18();
...
// Size: 0x64
function function_bb306d90( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_42c55e18();
...
// Size: 0x7c
function function_4c07b70a( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_42c55e18();
...
// Size: 0x9c
function function_3cf0ef2b( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_42c55e18();
...
// Size: 0xe4
function function_f5ac779c( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_42c55e18();
...
// Size: 0x234
function function_3aec2( str_objective, b_starting )
{
...
// Size: 0x9c
function function_def9d38e( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_d2829c38();
...
// Size: 0xd4
function function_68e5c597( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_d2829c38();
...
// Size: 0x234
function function_d78cf96d( str_objective, b_starting )
{
...
// Size: 0x84
function function_f3a694a6( str_objective, b_starting )
{
    if ( b_starting )
    {
        level thread function_5005007a();
...
// Size: 0x4c
function function_4fbcb062( str_objective, b_starting )
{
    if ( b_starting )
    {
        setwavewaterenabled( "frogger_water", 0 );
...
// Size: 0xcc
function function_d96d8db5( str_objective, b_starting )
{
...
// Size: 0x54
function function_4cdd3a9a( str_objective, b_starting )
{
    if ( b_starting )
    {
        setwavewaterenabled( "port_water", 0 );
...
// Size: 0x4c
function function_9ba92728( str_objective, b_starting )
{
    if ( b_starting )
    {
        setwavewaterenabled( "frogger_water", 0 );
...
// Size: 0x4c
function function_f3ba72a4( str_objective, b_starting )
{
    if ( b_starting )
    {
        setwavewaterenabled( "frogger_water", 0 );
...
// Size: 0x34
function function_4d38ae0f( str_objective, b_starting )
{
...
// Size: 0x15c
function function_112a3f23( str_objective, b_starting )
{
    if ( b_starting )
    {
        setwavewaterenabled( "frogger_water", 0 );
...
function function_1bbce270()
{
    ...
    a_s_pulse = struct::get_array( "pulse_barge", "targetname" );
    
    while ( true )
    {
        foreach ( s_pulse in a_s_pulse )
        {
...
function function_ffa95b91( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    ...
    self thread stop_boost_camera_fx( localclientnum );
}
...
function water_disturbance( localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump )
{
    if ( !isdefined( self.mdl_wave ) )
    {
        ...
        self.mdl_wave setwaterdisturbanceparams( 0.5, 500, 1500, 1, 80 );
    }
