...
function skipto_main( str_objective, b_starting )
{
    if ( b_starting )
    {
        ...
        level.ai_kane.goalradius = 16;
        level thread zurich_hq::function_2950b33d();
        ...
        level thread zurich_hq::function_6e7da34e();
    }
    ...
    level.ai_kane thread function_3769aa25( b_starting );
    ...
    level zurich_server_room::function_f62d8d36();
    level thread zurich_server_room::function_ef7b97bd();
...
function function_50aaa108()
{
    ...
    level dialog::player_say( "plyr_what_were_they_messi_0", 1 );
    level waittill( #"hash_2bcc2145" );
    level dialog::player_say( "plyr_i_swear_i_m_going_0", 2 );
}
...
// Size: 0x12c
function function_3769aa25( b_starting )
{
    if ( b_starting )
    {
    ...
    level scene::play( "cin_zur_06_02_decontamination_vign_schematic", level.ai_kane );
...
{
    util::teleport_players_igc( "sacrifice_teleport_spot" );
...
function function_f6f2b542()
{
    ...
    while ( level.var_56c8a612 < 4 )
    {
        ...
        level thread zurich_util::function_33ec653f( "hq_hallway_enemy_fake_spawn_manager", undefined, 2, &robot_spawnfunc );
        wait 14;
    }
}
...
function function_86f33bf()
{
    ...
    str_obj = &"cp_level_zurich_hack_terminal";
    str_hint = &"CP_MI_ZURICH_COALESCENCE_HACK";
    util::init_interactive_gameobject( t_use, str_obj, str_hint, &function_34d834a6 );
...
function function_34d834a6( e_player )
{
    ...
    level.ai_kane thread function_a174da35( e_player );
}
