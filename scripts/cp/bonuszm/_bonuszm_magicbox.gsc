...
class class_dafbfd8e
{
    ...
    function function_309dd42b( mdl_mobile_armory )
    {
        ...
        self.var_b8eeb0fe.angles = mdl_mobile_armory.angles + ( 0, -90, 0 );
        ...
        self.mdl_magicbox = mdl_mobile_armory;
...
function __main__()
{
    ...
    foreach ( mdl_mobile_armory in a_mdl_mobile_armory )
    {
        ...
        if ( isdefined( var_9ff80c52 ) && var_9ff80c52 )
        {
            ...
            var_381b4609 = array::get_all_closest( mdl_mobile_armory.origin, magicboxes, array( mdl_mobile_armory ), 1, 100 );
