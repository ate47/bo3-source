...
{
    if ( isdefined( params.eattacker ) && isplayer( params.eattacker ) && params.eattacker.b_using_zipline === 1 )
    {
...
// Size: 0x88
function function_17fe87c5( str_accolade )
{
    foreach ( plr in level.activeplayers )
    {
        plr notify( str_accolade );
    }
}
...
// Size: 0x16
function function_fea6ae9f( str_accolade )
{
    self notify( str_accolade );
}
