...
function private _screen_fade( n_time, n_target_alpha, n_start_alpha, v_color, b_force_close_menu, str_menu_id )
{
    ...
    /#
        ...
        printtoprightln( "<dev string:x42>" + string::rfill( "<dev string:x44>" + gettime(), 6 ) + "<dev string:x45>" + string::rfill( str_menu_id, 10 ) + "<dev string:x4e>" + string::rfill( v_color, 11 ) + "<dev string:x4e>" + string::rfill( n_start_alpha + "<dev string:x51>" + n_target_alpha, 10 ) + "<dev string:x4e>" + string::rfill( n_time, 6 ) + "<dev string:x56>", ( 1, 1, 1 ) );
    #/
