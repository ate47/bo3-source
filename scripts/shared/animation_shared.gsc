...
/#
    ...
    function debug_print( str_animation, str_msg )
    {
        ...
        if ( str_dvar != "<dev string:x3a>" )
        {
            ...
            if ( b_print )
            {
                printtoprightln( str_animation + "<dev string:x3b>" + string::rfill( str_msg, 10 ) + "<dev string:x3b>" + string::rfill( "<dev string:x3a>" + self getentitynumber(), 4 ) + "<dev string:x3f>" + string::rfill( "<dev string:x3a>" + gettime(), 6 ) + "<dev string:x42>", ( 1, 1, 0 ), -1 );
            }
        }
    }
