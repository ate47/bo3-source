...
class cscriptbundleobjectbase
{
    ...
    function error( condition, str_msg )
    {
        if ( condition )
        {
            ...
            {
                assertmsg( [[ self._o_bundle ]]->get_type() + "<dev string:x46>" + [[ self._o_bundle ]]->get_name() + "<dev string:x48>" + ( isdefined( "<dev string:x4d>" ) ? "<dev string:x4c>" + "<dev string:x4d>" : isdefined( self._s.name ) ? "<dev string:x4c>" + self._s.name : "<dev string:x4c>" ) + "<dev string:x55>" + str_msg );
            }
    ...
    {
        println( [[ self._o_bundle ]]->get_type() + "<dev string:x46>" + [[ self._o_bundle ]]->get_name() + "<dev string:x48>" + ( isdefined( "<dev string:x4d>" ) ? "<dev string:x4c>" + "<dev string:x4d>" : isdefined( self._s.name ) ? "<dev string:x4c>" + self._s.name : "<dev string:x4c>" ) + "<dev string:x55>" + str_msg );
    }
