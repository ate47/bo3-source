...
/#
    ...
    {
        level.cleanup_msgs = array( "<dev string:x28>", "<dev string:x2a>", "<dev string:x2c>" );
        wait 1;
...
function player_special_death_hint()
{
    ...
    {
        if ( attacker.classname == "script_vehicle" || isdefined( attacker ) && isdefined( attacker.create_fake_vehicle_damage ) )
        {
