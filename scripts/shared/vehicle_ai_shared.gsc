        ...
        foreach ( point in queryresult.data )
        {
            ...
            if ( isdefined( point.sight ) && point.sight )
            {
                /#
                    ...
                    point._scoredebug[ "<dev string:x78>" ] = 250;
                #/
            ...
            if ( isdefined( point.sight2 ) && point.sight2 )
            {
                /#
                    ...
                    point._scoredebug[ "<dev string:x7e>" ] = 150;
                #/
            ...
            if ( isdefined( point.sight3 ) && point.sight3 )
            {
                /#
                    ...
                    point._scoredebug[ "<dev string:x85>" ] = 150;
                #/
...
// Size: 0x4c
function updatepersonalthreatbias_attackerlockedontome( threat_bias, var_1e08b2fd, var_9c5ca2c, var_cee3c9e9 )
{
    function_c8b0c8c2( self.locked_on, threat_bias, var_1e08b2fd, var_9c5ca2c, var_cee3c9e9 );
}
...
// Size: 0x4c
function updatepersonalthreatbias_attackerlockingontome( threat_bias, var_1e08b2fd, var_9c5ca2c, var_cee3c9e9 )
{
    function_c8b0c8c2( self.locking_on, threat_bias, var_1e08b2fd, var_9c5ca2c, var_cee3c9e9 );
}
...
// Size: 0x188
function function_c8b0c8c2( client_flags, threat_bias, var_1e08b2fd, var_9c5ca2c, var_cee3c9e9 )
{
    ...
    for ( i = 0; remaining_flags_to_process && i < level.players.size ; i++ )
    {
        ...
        if ( isdefined( attacker ) )
        {
            ...
            {
                self setpersonalthreatbias( attacker, int( threat_bias ), var_1e08b2fd );
...
/#
    ...
    // Size: 0xda, Type: dev
    function updatepersonalthreatbias_bots( threat_bias, var_1e08b2fd )
    {
        foreach ( player in level.players )
        {
            if ( player util::is_bot() )
            {
                self setpersonalthreatbias( player, int( threat_bias ), var_1e08b2fd );
            }
        }
    }
