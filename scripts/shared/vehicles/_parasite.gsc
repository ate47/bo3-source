...
function parasite_damage()
{
    ...
    while ( true )
    {
        ...
        if ( isdefined( e_attacker.is_parasite ) && isdefined( e_attacker ) && e_attacker.is_parasite && !( isdefined( e_attacker.squelch_damage_overlay ) && e_attacker.squelch_damage_overlay ) )
        {
