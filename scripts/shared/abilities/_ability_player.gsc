...
/#
    ...
    function abilities_devgui_add_gadgets( add_cmd_with_root, pid, menu_index )
    {
        ...
        abilities_devgui_add_player_weapons( add_cmd_with_root, pid, a_abilities, "<dev string:x107>", menu_index );
        menu_index++;
        abilities_devgui_add_player_weapons( add_cmd_with_root, pid, a_hero, "<dev string:x116>", menu_index );
        menu_index++;
        return menu_index;
    }
