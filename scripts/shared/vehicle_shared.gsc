...
function simple_spawn( name, b_supress_assert )
{
    ...
    assert( b_supress_assert || isdefined( level.vehicle_targetname_array[ name ] ), "<dev string:x225>" + name );
    vehicles = [];
...
function aircraft_dust_kickup( model )
{
    ...
    while ( isdefined( self ) )
    {
        ...
        assert( isdefined( level._vehicle_effect[ self.vehicletype ] ), self.vehicletype + "<dev string:x29d>" );
        assert( isdefined( level._vehicle_effect[ self.vehicletype ][ trace[ "<dev string:x2c9>" ] ] ), "<dev string:x2d5>" + trace[ "<dev string:x2c9>" ] );
