...
function zombienotetrackmeleefire( entity )
{
    ...
    if ( isdefined( entity.enemy.bgb_idle_eyes_active ) && ( isdefined( entity.enemy.bgb_in_plain_sight_active ) && entity.enemy.bgb_in_plain_sight_active || isdefined( entity.enemy ) && entity.enemy.bgb_idle_eyes_active ) )
    {
        return;
    }
