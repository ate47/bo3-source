...
function shouldstealth( behaviortreeentity )
{
    if ( isdefined( behaviortreeentity.stealth ) )
    {
        ...
        if ( isdefined( behaviortreeentity.stealth_react_last ) && ( isdefined( behaviortreeentity.stealth_reacting ) && behaviortreeentity.stealth_reacting || now - behaviortreeentity.stealth_react_last < 250 ) )
        {
            return true;
        }
...
function locomotionshouldstealth( behaviortreeentity )
{
    ...
    if ( behaviortreeentity haspath() )
    {
        if ( isdefined( behaviortreeentity.arrivalfinalpos ) || isdefined( behaviortreeentity.pathgoalpos ) )
        {
            ...
            if ( isdefined( self.currentgoal ) && ( haswait || !isdefined( self.currentgoal ) || isdefined( self.currentgoal.scriptbundlename ) ) )
            {
                goalpos = undefined;
