...
function traverseactionstart( behaviortreeentity, asmstatename )
{
    ...
    /#
        ...
        assert( isdefined( animationresults[ "<dev string:x28>" ] ), behaviortreeentity.archetype + "<dev string:x32>" + behaviortreeentity.traversestartnode.animscript + "<dev string:x57>" + behaviortreeentity.traversestartnode.origin + "<dev string:x5b>" );
    #/
